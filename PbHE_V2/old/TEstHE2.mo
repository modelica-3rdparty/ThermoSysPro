...
model TEstHE2
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Rampe rampe1(
    ...
    Initialvalue=0.2,
    Finalvalue=0.001)
    annotation (Placement(transformation(extent={{474,-2},{494,18}})));
  Components.old.StaticExchangerKS_new_abs staticExchangerKS_new_abs(
    K=2500,
    S=1,
    Kc=40,
    Kf=40,
...
equation
  ...
  connect(sourceQ1.C,controlValve. C1) annotation (Line(points={{118,22},{138,
          22}},                                                                     color={0,0,0}));
  connect(staticExchangerKS_new_abs.Sf, sinkP2.C) annotation (Line(
      points={{390,-7.7},{382,-7.7},{382,-26},{352,-26},{352,-24}},
      color={0,128,255},
      thickness=0.5));
  connect(sourceColdWater1.C, staticExchangerKS_new_abs.Ef) annotation (Line(
        points={{450,-38},{450,-44},{424,-44},{424,-7.7},{418,-7.7}}, color={0,
          0,0}));
  connect(sinkP3.C, staticExchangerKS_new_abs.Sc) annotation (Line(points={{352,
          16},{392,16},{392,-2.3},{390,-2.3}}, color={0,0,0}));
  connect(sourceColdWater2.C, staticExchangerKS_new_abs.Ec) annotation (Line(
        points={{448,12},{448,0},{424,0},{424,-2.3},{418,-2.3}}, color={0,0,0}));
  connect(rampe1.y,sourceColdWater1. IMassFlow) annotation (Line(points={{495,8},
