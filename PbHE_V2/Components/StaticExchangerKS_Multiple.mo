within PbHE_V2.Components;
model StaticExchangerKS_Multiple
  ...
  parameter String TypeCalculation = "DTLM_Log" annotation (choices(choice="DTLM_Log", choice="NUT", choice="DTLM_Exp"));
...
equation
  ...
  elseif TypeCalculation == "DTLM_Log" then
      ...
      W = DTln*Kcor*K*S;
      assert(((abs(DT1) > 1e-1) and (abs(DT2) > 1e-1)), "Low DT1 or DT2, instable calculation, consider using NUT method", AssertionLevel.warning);
...
end StaticExchangerKS_Multiple;
