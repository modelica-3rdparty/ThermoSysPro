...
record Pro_FlueGases "Flue gases properties for the computation of correlations"
  ...
  Units.SI.SpecificHeatCapacity cpMF(start = 500) "Flue gases average specific heat capacity";
  Units.SI.DynamicViscosity muMF(start = 1.e-5) "Flue gases average dynamic viscosity";
  Units.SI.ThermalConductivity kMF(start = 0.10) "Flue gases average thermal conductivity";
  ...
  Real Xtot " ";
  annotation(
    Window(x = 0.11, y = 0.17, width = 0.6, height = 0.6),
