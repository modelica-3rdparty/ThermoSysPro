...
protected
  ThermoSysPro.Properties.WaterSteam.Common.PropThermoSat vsatm annotation(
    Placement(transformation(extent = {{-40, 40}, {-20, 60}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.PropThermoSat lsatm annotation(
    Placement(transformation(extent = {{0, 40}, {20, 60}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph prol annotation(
