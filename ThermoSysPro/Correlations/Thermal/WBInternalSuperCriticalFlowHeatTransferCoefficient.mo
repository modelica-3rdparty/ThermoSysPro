...
protected
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_pT protpint annotation(
    Placement(transformation(extent = {{-96, 40}, {-84, 52}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_pT protmc annotation(
    Placement(transformation(extent = {{-96, 22}, {-84, 34}}, rotation = 0)));
algorithm
  cpl := hy.cpl;
  mul := hy.mul;
  kl := hy.kl;
