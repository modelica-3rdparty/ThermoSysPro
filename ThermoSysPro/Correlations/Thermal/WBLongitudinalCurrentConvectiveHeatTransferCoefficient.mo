...
function WBLongitudinalCurrentConvectiveHeatTransferCoefficient "Convective heat transfer coefficient for co- or counter-current heat exchangers"
  ...
  input Integer option_interpolation = 1 "1: linear interpolation - 2: spline interpolation";
  output Units.SI.CoefficientOfHeatTransfer Kcfl "Convective heat transfer coefficient for longitudinal flows";
protected
  ...
  constant Real TabFpp[5, 12] = [0.152, 0.166, 0.180, 0.190, 0.198, 0.205, 0.212, 0.217, 0.221, 0.229, 0.236, 0.242; 0.158, 0.171, 0.184, 0.195, 0.204, 0.211, 0.218, 0.222, 0.228, 0.236, 0.244, 0.251; 0.163, 0.176, 0.189, 0.200, 0.209, 0.216, 0.224, 0.229, 0.234, 0.244, 0.252, 0.260; 0.170, 0.183, 0.194, 0.205, 0.214, 0.222, 0.229, 0.237, 0.240, 0.250, 0.260, 0.268; 0.178, 0.189, 0.200, 0.211, 0.220, 0.228, 0.234, 0.241, 0.247, 0.256, 0.266, 0.275];
