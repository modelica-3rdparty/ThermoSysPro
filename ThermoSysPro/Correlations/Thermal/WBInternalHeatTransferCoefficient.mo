...
function WBInternalHeatTransferCoefficient "Internal water/steam flow heat transfer coefficient"
...
protected
  ...
  Units.SI.SpecificHeatCapacity cpl "Specific heat capacity of the liquid phase";
  ...
  Units.SI.CoefficientOfHeatTransfer hc "Convective heat transfer coefficient for the compuation of hi";
  ...
  Units.SI.CoefficientOfHeatTransfer hvi "Heat transfer coefficient for the drying of the wall";
algorithm
  rhol := hy.rhol;
  rhov := hy.rhov;
  lv := hy.lv;
