...
block Hysteresis
  ...
  Connectors.InputReal u annotation(
    Placement(transformation(extent = {{-120, -10}, {-100, 10}})));
  Connectors.OutputLogical y annotation(
