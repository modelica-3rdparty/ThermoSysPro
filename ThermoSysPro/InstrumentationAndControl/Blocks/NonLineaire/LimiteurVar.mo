...
block LimiteurVar
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal limit1 annotation(
    Placement(transformation(extent = {{-120, 70}, {-100, 90}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal limit2 annotation(
    Placement(transformation(extent = {{-120, -90}, {-100, -70}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputLogical ySMax annotation(
    layer = "icon",
    Placement(transformation(extent = {{100, 70}, {120, 90}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputLogical ySMin annotation(
    layer = "icon",
