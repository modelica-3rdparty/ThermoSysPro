...
block Exp
  ...
  parameter Real riseTimeConst(min = Modelica.Constants.small) = 0.1 "Constante du front montant";
  parameter Real fallTimeConst(min = Modelica.Constants.small) = 0.1 "Constante du front descendant";
