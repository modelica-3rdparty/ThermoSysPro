...
equation
  ...
  annotation(
    ...
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{50, 0}, {100, 0}}), Line(points = {{50, 0}, {100, 0}}), Rectangle(extent = {{-100, -100}, {100, 100}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Polygon(points = {{-80, 90}, {-88, 68}, {-72, 68}, {-80, 90}}, lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Line(points = {{-80, 68}, {-80, -80}}, color = {192, 192, 192}), Line(points = {{-80, 0}, {80, 0}}, color = {0, 0, 0}), Line(points = {{-90, -70}, {82, -70}}, color = {192, 192, 192}), Text(extent = {{-150, 150}, {150, 110}}, textString = "%name"), Text(extent = {{-148, 14}, {152, 54}}, lineColor = {0, 0, 0}, textString = "%k")}),
    Window(x = 0.42, y = 0.22, width = 0.6, height = 0.6),
    Documentation(info = "
Adapted from the Modelica.Blocks.Sources librarys  
