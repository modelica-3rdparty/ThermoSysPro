...
model StaticExchangerWaterSteamFlueGases "Static heat exchanger water/steam - flue gases"
  parameter Integer exchanger_type = 1 "Exchanger type - 1: Efficiency is fixed - 2: delta power is fixed - 3: heat transfer is fixed";
  ...
  parameter Units.SI.CoefficientOfHeatTransfer K = 100 "Global heat transfer coefficient (active if exchanger_type=3)";
  parameter Units.SI.Area S = 10 "Global heat exchange surface (active if exchanger_type=3)";
  ...
  Units.SI.SpecificEnthalpy Hef(start = 6e5) "Flue gas specific enthalpy at the inlet";
  Units.SI.SpecificEnthalpy Hsf(start = 3e5) "Flue gas specific enthalpy at the outlet";
  ...
  Units.SI.SpecificEnthalpy Hse(start = 20e5) "Water specific enthalpy at the inlet";
  Units.SI.SpecificEnthalpy Hee(start = 3e5) "Water specific enthalpy at the outlet";
  ...
  Units.SI.SpecificHeatCapacity Cpf(start = 1000) "Flue gas specific heat capacity";
