...
model ExchangerWaterC3H3F5W "Static water - C3H3F5 heat exchanger with fixed delta power"
  parameter Units.SI.Power DW = 0 "Power exchanged between the hot and the cold fluids";
  parameter ThermoSysPro.Units.SI.PressureDifference DPc "Total pressure loss for the hot fluid (% of the fluid pressure at the inlet)";
  parameter ThermoSysPro.Units.SI.PressureDifference DPf "Total pressure loss for the cold fluid (% of the fluid pressure at the inlet)";
  ...
  WaterSteam.Connectors.FluidInlet Ec annotation(
    Placement(transformation(extent = {{-68, -70}, {-48, -50}}, rotation = 0)));
  WaterSteam.Connectors.FluidInlet Ef annotation(
    Placement(transformation(extent = {{-110, -10}, {-90, 10}}, rotation = 0)));
  WaterSteam.Connectors.FluidOutlet Sf annotation(
    Placement(transformation(extent = {{88, -9}, {108, 11}}, rotation = 0)));
  WaterSteam.Connectors.FluidOutlet Sc annotation(
...
/* Fluid thermodynamic properties for the cold fluid */
  ...
  Tsf = profs.T;
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 60}, {100, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.CrossDiag), Line(points = {{-56, -50}, {-56, 4}, {0, -28}, {60, 6}, {60, -50}}, color = {0, 0, 255}, thickness = 0.5)}),
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 60}, {100, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.CrossDiag), Line(points = {{-58, -50}, {-58, 2}, {-2, -34}, {58, 2}, {58, -50}}, color = {0, 0, 255}, thickness = 0.5)}),
