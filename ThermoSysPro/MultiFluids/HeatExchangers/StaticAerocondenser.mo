...
model StaticAerocondenser "Static aerocondenser"
  ...
  parameter Integer mode_e = 0 "Région IAPWS en entrée. 1:liquide - 2:vapeur - 4:saturation - 0:calcul automatique";
  parameter Integer mode_s = 0 "Région IAPWS en entrée. 1:liquide - 2:vapeur - 4:saturation - 0:calcul automatique";
  Units.SI.SpecificEnthalpy hv(start = 2500000) "Fluid specific enthalpy at the inlet of the condenser";
  Units.SI.SpecificEnthalpy he(start = 370000) "Fluid specific enthalpy at the outlet of the condenser";
  ...
  Units.SI.AbsolutePressure Pv(start = 30000) "Fluid pressure at the inlet of the condenser";
  Units.SI.AbsolutePressure Pe(start = 30000) "Fluid pressure at the outlet of the condenser";
  ...
  Units.SI.Density rho_v(start = 500) "Fluid density at the inlet of the condenser";
  Units.SI.Density rho_e(start = 998) "Fluid density at the outlet of the condenser";
  Units.SI.Density rho_a(start = 1) "Air density";
  WaterSteam.Connectors.FluidInlet Cws1 annotation(
    Placement(transformation(extent = {{-110, -50}, {-90, -30}}, rotation = 0)));
  WaterSteam.Connectors.FluidOutlet Cws2 annotation(
    Placement(transformation(extent = {{90, -50}, {110, -30}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet Cair1 annotation(
    Placement(transformation(extent = {{-10, -110}, {10, -90}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesOutlet Cair2 annotation(
    Placement(transformation(extent = {{-10, 88}, {10, 108}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph prov "Steam properties" annotation(
    Placement(transformation(extent = {{-100, 80}, {-80, 100}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph proe "Water properties" annotation(
