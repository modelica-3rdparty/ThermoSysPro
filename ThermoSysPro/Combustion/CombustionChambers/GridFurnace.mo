...
model GridFurnace "Combustion furnace"
  ...
  Units.SI.MassFlowRate Q5ost(start = 10) "Stoechiométrique O mass flow rate for zone 5";
  ...
  Units.SI.Density rhonorm(start = 1000) "Density of the outgoing flue gases Masse at 0 deg C and 1 atm";
  Real FVN0(start = 0.1) "Ashes normal volume fraction for the computation of FVN";
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet Ca2 annotation(
    Placement(transformation(extent = {{-60, 50}, {-40, 70}}, rotation = 0)));
  ThermoSysPro.Combustion.Connectors.FuelInlet Com annotation(
    Placement(transformation(extent = {{-100, -20}, {-80, 0}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Connectors.FluidInlet port_eau_refroid annotation(
  ...
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet Ca1 annotation(
...
/* Normal voulme fraction of the volatile ashes */
  ...
  annotation(
    ...
    Icon(graphics = {Polygon(points = {{-80, 20}, {-80, -80}, {100, -80}, {100, 20}, {62, 20}, {20, 40}, {20, 80}, {-40, 80}, {-40, 40}, {-80, 20}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-80, 0}, {60, -40}, {80, -80}, {-80, -80}, {-80, 0}}, lineColor = {0, 0, 255}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid)}),
    DymolaStoredErrors,
