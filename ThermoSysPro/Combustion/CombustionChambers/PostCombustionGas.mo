...
model PostCombustionGas "Post-combustion"
  ...
  Units.SI.MassFlowRate Qmel(start = 10) "Mass flow rate of the air/flue gases mixture";
  ...
  Units.SI.SpecificEnthalpy Hmel(start = 1e3) "Specific enthalpy of the air/flue gases mixture";
  Units.SI.Temperature Tmel(start = 500) "Temperature of the air/flue gases mixture";
  ...
  ThermoSysPro.FlueGases.Connectors.FlueGasesOutlet Cfg2 "Flue gases outlet" annotation(
    Placement(transformation(extent = {{80, 0}, {100, 20}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet Cfg1 "Flue gases inlet" annotation(
...
protected
  ...
  Units.SI.MassFlowRate Qmelc(start = 10) "Intermediate variable for the computation of Qmel";
...
// Changed from FlueGases_T to FlueGases_h to provide a differentiable function
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(extent = {{-80, 80}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = {120, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-20, 62}, {46, 46}, {2, 30}, {58, 18}, {6, 0}, {48, -16}, {2, -32}, {54, -44}, {-20, -60}, {-20, 62}}, lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.CrossDiag), Line(points = {{-20, 80}, {-20, -80}}, color = {0, 0, 255})}),
