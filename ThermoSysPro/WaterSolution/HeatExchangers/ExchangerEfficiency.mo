...
model ExchangerEfficiency "H2O/LiBr solution heat exchanger with prescribed efficiency"
  ...
  parameter Units.SI.AbsolutePressure DPc = 0 "Pressure loss in the hot fluid as a percent of the pressure at the inlet";
  parameter Units.SI.AbsolutePressure DPf = 0 "Pressure loss in the cold fluid as a percent of the pressure at the inlet";
  ...
  Units.SI.SpecificEnthalpy Hec(start = 5e5) "Hot fluid specific enthalpy at the inlet";
  Units.SI.SpecificEnthalpy Hsc(start = 2e5) "Hot fluid specific enthalpy at the outlet";
  Units.SI.SpecificEnthalpy Hef(start = 1e5) "Cold fluid specific enthalpy at the inlet";
  Units.SI.SpecificEnthalpy Hsf(start = 4e5) "Cold fluid specific enthalpy at the outlet";
  ...
  Units.SI.SpecificEnthalpy Hmaxf(start = 1e5) "Maximum specific enthalpy reachable by the cold fluid";
  Units.SI.SpecificEnthalpy Hminc(start = 1e5) "Minimum specific enthalpy reachable by the hot fluid";
  ...
  Units.SI.SpecificEnthalpy Hliq(start = 4e5) "Liquid water specific enthalpy at the cold inlet";
  ThermoSysPro.Units.SI.TemperatureDifference DTc_ec(start = 10) "Difference with the cristallisation temperature at the hot inlet";
  ThermoSysPro.Units.SI.TemperatureDifference DTc_sc(start = 10) "Difference with the cristallisation temperature at the hot outlet";
  ThermoSysPro.Units.SI.TemperatureDifference DTc_ef(start = 10) "Difference with the cristallisation temperature at the cold inlet";
  ThermoSysPro.Units.SI.TemperatureDifference DTc_sf(start = 10) "Difference with the cristallisation temperature at the cold outlet";
  ThermoSysPro.WaterSolution.Connectors.WaterSolutionInlet Ef annotation(
    Placement(transformation(extent = {{-110, -8}, {-90, 12}}, rotation = 0)));
  ThermoSysPro.WaterSolution.Connectors.WaterSolutionInlet Ec annotation(
    Placement(transformation(extent = {{-68, -70}, {-48, -50}}, rotation = 0)));
  ThermoSysPro.WaterSolution.Connectors.WaterSolutionOutlet Sc annotation(
    Placement(transformation(extent = {{48, -70}, {68, -50}}, rotation = 0)));
  ThermoSysPro.WaterSolution.Connectors.WaterSolutionOutlet Sf annotation(
...
/* Power exchanged */
  ...
  W = Eff*Wmax;
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 60}, {100, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 170, 170}, fillPattern = FillPattern.Solid), Line(points = {{-56, -50}, {-56, 2}, {2, 2}, {60, 2}, {60, -50}}, color = {0, 0, 255}, thickness = 0.5), Text(extent = {{-50, 66}, {46, -2}}, lineColor = {0, 0, 255}, textString = "E"), Line(points = {{-100, 60}, {100, -60}}, color = {0, 0, 255})}),
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 60}, {100, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 170, 170}, fillPattern = FillPattern.Solid), Line(points = {{-58, -50}, {-58, 0}, {0, 0}, {58, 0}, {58, -50}}, color = {0, 0, 255}, thickness = 0.5), Text(extent = {{-50, 66}, {46, -2}}, lineColor = {0, 0, 255}, textString = "E"), Line(points = {{-100, 60}, {100, -60}}, color = {0, 0, 255})}),
