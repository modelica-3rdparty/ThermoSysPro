...
function TableLinearInterpolation_i "Table linear interpolation (internal function)"
...
algorithm
  ...
  (Y1, DeltaYX1) := ThermoSysPro.Functions.Utilities.LinearInterpolation_i(TabX, TabY[IndP - 1, :], X);
  (Y2, DeltaYX2) := ThermoSysPro.Functions.Utilities.LinearInterpolation_i(TabX, TabY[IndP, :], X);
