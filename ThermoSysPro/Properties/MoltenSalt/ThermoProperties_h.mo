...
record ThermoProperties_h
  ...
  annotation(
    Icon(graphics = {Rectangle(extent = {{-100, 60}, {100, -90}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 127}, fillPattern = FillPattern.Solid), Text(extent = {{-127, 125}, {127, 65}}, textString = "%name"), Line(points = {{-100, -40}, {100, -40}}, color = {0, 0, 0}), Line(points = {{-100, 10}, {100, 10}}, color = {0, 0, 0}), Line(points = {{0, 60}, {0, -90}}, color = {0, 0, 0})}),
