...
protected
  ...
  Units.SI.SpecificEnthalpy H1 "Liquid LiBr specific enthalpy on the saturation line";
  Units.SI.SpecificEnthalpy Hliq "Liquid H2O specific enthalpy on the saturation line";
  Units.SI.SpecificEnthalpy Dh "Difference in specific enthalpy wrt. ideal mixing";
algorithm
...
/* LiBr specific entahlpy */
  H1 := 0.5086682481e3 - 0.1862407335e2*Tc + 0.9859458321e-1*Tc*Tc - 0.2509791095e-4*Tc*Tc*Tc + 0.4158007710e-7*Tc*Tc*Tc*Tc;
