...
equation
  ...
  mu_polynomial = ThermoSysPro.Properties.WaterSteamSimple.SimpleWater.DynamicViscosity_rhoT(d, T);
  lambda_polynomial = ThermoSysPro.Properties.WaterSteamSimple.SimpleWater.ThermalConductivity_rhoT(d, T);
