...
model Test2_polynomial
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.SinkP puitsP(P0 = 600000, mode = 0) annotation(
    Placement(transformation(extent = {{80, -10}, {100, 10}}, rotation = 0)));
  ThermoSysPro.WaterSteam.BoundaryConditions.SourceP sourceP(mode = 0, option_temperature = 2, P0 = 1000000) annotation(
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Rampe rampe(Duration = 10000, Initialvalue = 1e5, Finalvalue = 4e6) annotation(
    Placement(transformation(extent = {{-118, -40}, {-98, -20}}, rotation = 0)));
equation
  ...
  connect(rampe.y, sourceP.ISpecificEnthalpy) annotation(
    Line(points = {{-97, -30}, {-90, -30}, {-90, -5}}));
  connect(volumeD.Cs3, perteDP1.C1) annotation(
