...
protected
  ...
  Units.SI.DerDensityByPressure dd1satp "Derivate of density at liquid saturation wrt. pressure";
  Units.SI.DerDensityByPressure dd2satp "Derivative of density at vapor saturation wrt. pressure";
  Real du1satp(unit = "m3/kg") "Derivative of specific inner energy at liquid saturation wrt. pressure";
  Real du2satp(unit = "m3/kg") "Derivative of specific inner energy at vapor saturation wrt. pressure";
  Real dxp(unit = "1/Pa") "Derivative of quality wrt. pressure";
  Real dxs "Derivative of quality wrt. entropy";
  Real dh1satp(unit = "m3/kg") "Derivative of specific enthalpy at liquid saturation wrt. pressure";
  Real dh2satp(unit = "m3/kg") "Derivative of specific enthalpy at vapor saturation wrt. pressure";
