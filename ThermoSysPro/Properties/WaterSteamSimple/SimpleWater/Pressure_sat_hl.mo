...
algorithm
  assert(hl > ThermoSysPro.Properties.WaterSteamSimple.Enthalpy.h1sat_P(ThermoSysPro.Properties.WaterSteamSimple.triple.ptriple), "Pressure_sat_hl called with too low specific enthalpy (below triple point)");
  assert(hl < ThermoSysPro.Properties.WaterSteamSimple.critical.HCRIT, "Pressure_sat_hl called with too high specific enthalpy (above critical point)");
