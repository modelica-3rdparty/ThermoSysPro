...
function Water_sat_P_der
  ...
  output ThermoSysPro.Properties.WaterSteamSimple.PropThermoSat dlsat annotation(
    Placement(transformation(extent = {{-85, 15}, {-15, 85}}, rotation = 0)));
  output ThermoSysPro.Properties.WaterSteamSimple.PropThermoSat dvsat annotation(
