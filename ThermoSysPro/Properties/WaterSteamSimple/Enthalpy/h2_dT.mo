...
function h2_dT "Specific enthalpy in vapor region for given density and temperature"
...
algorithm
  h := ThermoSysPro.Properties.WaterSteamSimple.Utilities.polynomial_xy_order3(coef, d, T);
  annotation(
