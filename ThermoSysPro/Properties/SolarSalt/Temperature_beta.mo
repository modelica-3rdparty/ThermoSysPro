...
function Temperature_beta "inverse function of IsobaricExpansionCoefficient_t"
  input Units.SI.CubicExpansionCoefficient beta "isobaric expansion coefficient (1/K)";
...
algorithm
  ...
  annotation(
    inverse(beta = IsobaricExpansionCoefficient_T(temp)),
    derivative = Temperature_derbeta,
