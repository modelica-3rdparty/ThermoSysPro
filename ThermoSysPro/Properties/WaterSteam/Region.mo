...
package Region
  ...
  protected
    ...
    Units.SI.Pressure plim = min(p, ThermoSysPro.Properties.WaterSteam.BaseIF97.data.PCRIT - 1e-7) "pressure limited to critical pressure - epsilon";
...
## ThermoSysPro Version 4.2
  ...
  function dhl_dp "derivative of liquid specific enthalpy on the boundary between regions 4 and 3 or 1 w.r.t pressure"
    extends Modelica.Icons.Function;
    input Units.SI.Pressure p "pressure";
    output Units.SI.DerEnthalpyByPressure dh_dp "specific enthalpy derivative w.r.t. pressure";
  algorithm
...
## ThermoSysPro Version 4.2
  ...
  function drhol_dp "derivative of density of saturated water w.r.t. pressure"
    extends Modelica.Icons.Function;
    input Units.SI.Pressure p "saturation pressure";
    output Units.SI.DerDensityByPressure dd_dp "derivative of density of water at the boiling point";
  algorithm
