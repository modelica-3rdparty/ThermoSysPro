...
## ThermoSysPro Version 4.2
  ...
  record data "constant IF97 data and region limits"
    extends Modelica.Icons.Record;
    constant Units.SI.SpecificHeatCapacity RH2O = 461.526 "specific gas constant of water vapour";
    constant Units.SI.MolarMass MH2O = 0.01801528 "molar weight of water";
    constant Units.SI.Temperature TSTAR1 = 1386.0 "normalization temperature for region 1 IF97";
    constant Units.SI.Pressure PSTAR1 = 16.53e6 "normalization pressure for region 1 IF97";
    constant Units.SI.Temperature TSTAR2 = 540.0 "normalization temperature for region 2 IF97";
    constant Units.SI.Pressure PSTAR2 = 1.0e6 "normalization pressure for region 2 IF97";
    constant Units.SI.Temperature TSTAR5 = 1000.0 "normalization temperature for region 5 IF97";
    constant Units.SI.Pressure PSTAR5 = 1.0e6 "normalization pressure for region 5 IF97";
    constant Units.SI.SpecificEnthalpy HSTAR1 = 2.5e6 "normalization specific enthalpy for region 1 IF97";
    ...
    constant Units.SI.Temperature TLIMIT1 = 623.15 "temperature limit between regions 1 and 3";
    constant Units.SI.Temperature TLIMIT2 = 1073.15 "temperature limit between regions 2 and 5";
    constant Units.SI.Temperature TLIMIT5 = 2273.15 "upper temperature limit of 5";
    constant Units.SI.Pressure PLIMIT1 = 100.0e6 "upper pressure limit for regions 1, 2 and 3";
    constant Units.SI.Pressure PLIMIT4A = 16.5292e6 "pressure limit between regions 1 and 2, important for for two-phase (region 4)";
    constant Units.SI.Pressure PLIMIT5 = 10.0e6 "upper limit of valid pressure in region 5";
...
## ThermoSysPro Version 4.2
    ...
    protected
      ...
      Units.SI.Pressure plim = min(p, data.PCRIT - 1e-7) "pressure limited to critical pressure - epsilon";
...
## ThermoSysPro Version 4.2
    ...
    function g5 "base function for region 5: g(p,T)"
      ...
      input Units.SI.Pressure p "pressure";
      input Units.SI.Temperature T "temperature (K)";
      output ThermoSysPro.Properties.Common.GibbsDerivs g "dimensionless Gibbs funcion and dervatives wrt pi and tau";
    protected
...
## ThermoSysPro Version 4.2
    ...
    protected
      ThermoSysPro.Properties.Common.GibbsDerivs gibbs "dimensionless Gibbs funcion and dervatives wrt pi and tau";
    algorithm
...
## ThermoSysPro Version 4.2
    ...
    protected
      Real pi "dimensionless pressure";
      constant Units.SI.SpecificEntropy SLIMIT = 5.85e3 "subregion boundary specific entropy between regions 2a and 2b";
    algorithm
      if p < 4.0e6 then
        T := tps2a(p, s);
...
## ThermoSysPro Version 4.2
    ...
    protected
      ...
      constant Units.SI.ThermalConductivity lamstar = 0.4945 "scaling conductivity";
      constant Units.SI.Density rhostar = 317.763 "scaling density";
      constant Units.SI.Temperature tstar = 647.226 "scaling temperature";
      ...
      Real d2 "auxiliary variable";
      ThermoSysPro.Properties.Common.GibbsDerivs g "dimensionless Gibbs funcion and dervatives wrt pi and tau";
      ThermoSysPro.Properties.Common.HelmholtzDerivs f "dimensionless Helmholtz function and dervatives wrt delta and tau";
      Real Tc = T - 273.15 "Celsius temperature for region check";
      ...
      constant Units.SI.ThermalConductivity lambdastar = 1 "Reference thermal conductivity";
...
## ThermoSysPro Version 4.2
    ...
    function hofpsdt3 "isentropic specific enthalpy in region 3 h(p,s) with given good guess in d and T"
      ...
      input Units.SI.SpecificEntropy dels = IterationData.DELS "relative error in s";
      output Units.SI.SpecificEnthalpy h "specific enthalpy";
    protected
      Units.SI.Density d "density";
      Units.SI.Temperature T "temperature (K)";
...
## ThermoSysPro Version 4.2
    ...
    function water_hisentropic "isentropic specific enthalpy from p,s (preferably use water_hisentropic_dyn in dynamic simulation!)"
      ...
      output Units.SI.SpecificEnthalpy h "specific enthalpy";
    protected
      ThermoSysPro.Properties.Common.GibbsDerivs g "derivatives of dimensionless Gibbs-function w.r.t dimensionless pi and tau";
      ThermoSysPro.Properties.Common.HelmholtzDerivs f "derivatives of dimensionless Helmholtz-function w.r.t dimensionless delta and tau";
...
## ThermoSysPro Version 4.2
    ...
    protected
      ...
      ThermoSysPro.Properties.Common.HelmholtzDerivs f "dimensionless Helmholtz function and dervatives wrt delta and tau";
      ThermoSysPro.Properties.Common.NewtonDerivatives_pT nDerivs "derivatives needed in Newton iteration";
...
## ThermoSysPro Version 4.2
    ...
    protected
      ...
      ThermoSysPro.Properties.Common.HelmholtzDerivs f "dimensionless Helmholtz function and dervatives wrt delta and tau";
      ThermoSysPro.Properties.Common.NewtonDerivatives_ph nDerivs "derivatives needed in Newton iteration";
      Boolean found = false "flag for iteration success";
...
## ThermoSysPro Version 4.2
    ...
    protected
      ...
      Real delt "Newton-step in T-direction";
      ThermoSysPro.Properties.Common.HelmholtzDerivs f "dimensionless Helmholtz function and dervatives wrt delta and tau";
      ThermoSysPro.Properties.Common.NewtonDerivatives_ps nDerivs "derivatives needed in Newton iteration";
...
## ThermoSysPro Version 4.2
    ...
    protected
      ...
      constant Units.SI.Pressure pguess5 = 0.5e6 "initial pressure guess in region 5";
    algorithm
      i := 0;
      error := 0;
      pguess2 := 42800*d;
...
## ThermoSysPro Version 4.2
  ...
  package TwoPhase "steam properties in the two-phase rgion and on the phase boundaries"
    function waterLiq_p "properties on the liquid phase boundary of region 4"
      ...
      extends Modelica.Icons.Function;
      input Units.SI.Pressure p "pressure";
      output ThermoSysPro.Properties.Common.PhaseBoundaryProperties liq "liquid thermodynamic property collection";
    protected
      Units.SI.Temperature Tsat "saturation temperature";
...
## ThermoSysPro Version 4.2
    ...
    function waterVap_p "properties on the vapour phase boundary of region 4"
      ...
      extends Modelica.Icons.Function;
      input Units.SI.Pressure p "pressure";
      output ThermoSysPro.Properties.Common.PhaseBoundaryProperties vap "vapour thermodynamic property collection";
    protected
      Units.SI.Temperature Tsat "saturation temperature";
      Real dpT "derivative of saturation pressure wrt temperature";
...
## ThermoSysPro Version 4.2
    ...
    algorithm
      ...
      pro.cv := ThermoSysPro.Properties.Common.cv2Phase(pro.liq, pro.vap, pro.x, pro.T, p);
