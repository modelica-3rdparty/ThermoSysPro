...
## ThermoSysPro Version 4.2  
    ...
    protected
      ...
      Units.SI.SpecificHeatCapacity cp "Chaleur spécifique à pression constante";
      Units.SI.SpecificHeatCapacity cv "specific heat capacity";
...
of 1-dim. tables is provided.## Copyright © EDF 2002 - 2025
...
## ThermoSysPro Version 4.2
    ...
    annotation(Window(x = 0.05, y = 0.51, width = 0.25, height = 0.26, library = 1, autolayout = 1),
      Documentation(info = "
Version 1.2  
