...
algorithm
  mu := Viscosity_cm2*temp^(-2) + Viscosity_cm1*temp^(-1) + Viscosity_c0 + Viscosity_c1*temp + Viscosity_c2*temp^2 + Viscosity_c3*temp^3 + Viscosity_c4*temp^4;
  annotation(
    derivative = DynamicViscosity_derT,
