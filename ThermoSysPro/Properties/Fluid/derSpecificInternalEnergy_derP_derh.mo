...
function derSpecificInternalEnergy_derP_derh "der(Specific Internal Energy) computation for all fluids (inputs: P, h, der(P), der(h), fluid)"
...
// Water/Steam, C3H3F5, FlueGas, MoltenSalt, Oil, DryAirIdealGas
  der_u := (ThermoSysPro.Properties.Fluid.SpecificInternalEnergy_Ph_DO_NOT_USE(P = P + delta_P, h = h + delta_h, fluid = fluid, mode = mode, Xco2 = Xco2, Xh2o = Xh2o, Xo2 = Xo2, Xso2 = Xso2) - ThermoSysPro.Properties.Fluid.SpecificInternalEnergy_Ph_DO_NOT_USE(P = P - delta_P, h = h - delta_h, fluid = fluid, mode = mode, Xco2 = Xco2, Xh2o = Xh2o, Xo2 = Xo2, Xso2 = Xso2))/dt;
