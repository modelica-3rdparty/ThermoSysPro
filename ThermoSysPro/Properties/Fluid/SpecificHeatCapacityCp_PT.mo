...
function SpecificHeatCapacityCp_PT "Specific Heat Capacity at constant P computation for all fluids (inputs: P, T, fluid)"
  ...
  output Units.SI.SpecificHeatCapacity cp "Specific Heat Capacity at constant P (J/kg/K)";
  // fluid==1 - Water/Steam
protected
...
/// Commentaire ajouté (si fluid==2, vérifie que les fractions massiques sont bien fournies en Input)
    cp := ThermoSysPro.Properties.FlueGases.FlueGases_cp(PMF = P, TMF = T, Xco2 = Xco2, Xh2o = Xh2o, Xo2 = Xo2, Xso2 = Xso2);
// MoltenSalt
  elseif fluid == 4 then
