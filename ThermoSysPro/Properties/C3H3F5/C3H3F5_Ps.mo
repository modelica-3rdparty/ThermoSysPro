...
function C3H3F5_Ps "11133-C3H3F5 physical properties as a function of P and s"
  ...
  output ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ps props annotation(
...
protected
  ...
  Units.SI.SpecificEntropy scalc "Variable for the computation of the specific entropy";
