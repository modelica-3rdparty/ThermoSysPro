...
<pre>
  ...
  partial package ThermoSysProIcon "Icon for ThermoSysPro library"
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true)), Icon(coordinateSystem(preserveAspectRatio=true), graphics={
          Polygon(
            points={{-274,-6},{-274,-6}},
            lineColor={0,0,0},
            smooth=Smooth.Bezier,
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-298,-20},{-300,-24},{-302,-24},{-302,-26},{-300,-26},{-298,-26},{-282,-2},{-268,-12},{-262,-8},{-336,-16},{-354,-30},{-350,-18},{-348,-14},{-298,-20}},
            lineColor={0,0,0},
            pattern=LinePattern.None,
            smooth=Smooth.Bezier),
          Polygon(
            points={{-300,-20},{-300,-20}},
            lineColor={0,0,0},
            smooth=Smooth.Bezier),
          Rectangle(
            extent={{-96,100},{96,-96}},
          ...
          Text(
            ...
            textString="SYSPRO"),
          Polygon(
            points={{100,0},{100,0},{100,70},{100,92},{92,100},{70,100},{0,100},{-70,100},{-92,100},{-100,92},{-100,70},{-100,0},{-100,0},{-96,0},{-96,0},{-96,70},{-96,90},{-90,96},{-70,96},{0,96},{70,96},{90,96},{96,90},{96,70},{96,0},{96,0},{100,0}},
            lineColor={162,220,16},
            lineThickness=1,
            smooth=Smooth.Bezier,
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid),
          ...
          Polygon(
            ...
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-68,-4},{-68,-4},{-66,0},{-64,8},{-62,22},{-60,40},{-62,54},{-64,58},{-62,60},{-50,62},{-40,62},{-36,60},{-38,56},{-38,38},{-34,12},{-31.731,9.73},{-30,8},{-32.138,7.572},{-64,-2},{-68,-4}},
            lineColor={0,0,0},
            smooth=Smooth.Bezier,
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid,
          ...
          Polygon(
            ...
            smooth=Smooth.Bezier),
          Polygon(
            points={{-38,28},{-30,28},{-30,30},{-22,30},{-22,28},{-18,28},{-18,12},{-12,12},{-12,36},{-8,36},{-8,12},{-4,12},{-4,38},{0,38},{0,24},{12,24},{12,28},{18,28},{18,30},{20,30},{20,28},{24,28},{24,30},{26,30},{26,28},{28,28},{28,12},{28,10},{56,4},{56,50},{54,52},{54,54},{52,56},{52,58},{54,58},{54,62},{62,62},{62,-2},{30,8},{22,8},{0,10},{-24,8},{-38,4},{-38,28}},
            lineColor={0,0,0},
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid,
            pattern=LinePattern.None),
          Line(
            points={{34,8},{34,14},{34,16},{36,14},{32,18}},
            color={162,220,16},
            thickness=1),
          Line(
            points={{40,8},{40,14},{40,16},{42,14},{38,18}},
            color={162,220,16},
            thickness=1),
          Line(
            points={{46,6},{46,14},{46,16},{48,14},{44,18}},
            color={162,220,16},
            thickness=1),
          Polygon(
            points={{-80,-10},{-60,0},{-38,6},{-12,10},{8,10},{32,8},{56,2},{82,-10},{54,0},{32,4},{8,6},{-12,6},{-36,4},{-60,-2},{-80,-10}},
            lineColor={162,220,16},
            smooth=Smooth.Bezier,
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid),
          ...
          Line(
            ...
            pattern=LinePattern.None,
            smooth=Smooth.Bezier),
          Line(points={{-90,70}}, color={128,128,128}),
          Polygon(
            points={{108,-2},{108,-2}},
            lineColor={16,87,200},
            pattern=LinePattern.None,
          ...
          Polygon(
            ...
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-76,-12},{-60,-2},{-38,4},{-12,8},{8,8},{32,6},{56,0},{76,-10},{54,-2},{32,2},{8,4},{-12,4},{-36,2},{-60,-4},{-76,-12}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid)}));
  end ThermoSysProIcon;

  partial package TSPIcon1 "Icon for ThermoSysPro library"
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true)), Icon(coordinateSystem(preserveAspectRatio=true), graphics={
          Polygon(
            points={{-274,-6},{-274,-6}},
            lineColor={0,0,0},
          ...
          Polygon(
            ...
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-52.232,33.0221},{-52.232,41.2776},{-52.232,41.2776},{-45.768,41.2776},{-45.768,41.2776},{-46,24},{-46,24},{-36,24},{-36,24},{-38,18},{-38,18},{-46,18},{-46,18},{-46,-34},{-40,-34},{-40,-34},{-40,-40},{-40,-40},{-48,-40},{-52.232,-28.8963},{-52,18},{-52,18},{-60,18},{-60,18},{-60,24},{-60,24},{-52,24},{-52,24},{-52.232,33.0221}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{33.089,-42},{38.9375,-42},{38.9375,38},{33.089,38},{33.089,-42}},
            lineColor={16,87,200},
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{65.5122,38.0028},{72.3223,31.3344},{75.7265,17.9972},{75.7265,17.9972},{68.9181,17.9972},{68.9181,17.9972},{65.5122,31.3344},{38.2735,31.3344},{38.2735,31.3344},{38.2735,38.0028},{38.2735,38.0028},{65.5122,38.0028}},
            lineColor={16,87,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{65.512,-2.0028},{72.322,4.6656},{75.727,18.0028},{75.727,18.0028},{68.918,18.0028},{68.918,18.0028},{65.512,4.6656},{38.2735,4.6656},{38.2735,4.6656},{38.2735,-2.0028},{38.2735,-2.0028},{65.512,-2.0028}},
            lineColor={16,87,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          ...
          Ellipse(
            ...
            fillPattern=FillPattern.Solid,
            fillColor={192,228,16}),
          Line(points={{-90,-72}},color={128,128,128}),
          Ellipse(
            extent={{-36,-56},{-6,-86}},
            lineColor={0,0,0},
            pattern=LinePattern.None,
          ...
          Ellipse(
            ...
            fillColor={192,228,16}),
          Polygon(
            points={{240.322,-13.5157},{240.342,-13.5157},{247.132,-13.5157},{247.132,-13.5157},{244,6},{226,10},{209.678,7.0898},{202.868,-13.5157},{212,-30},{226.702,-34.1214},{240.322,-38.2425},{243.727,-50.6058},{236.917,-62.9688},{223.298,-62.9688},{209.678,-58.8478},{206.389,-46.5975},{206.273,-46.4843},{199.463,-46.4843},{199.463,-46.4843},{202.868,-62.9688},{216.488,-71.2142},{240.322,-71.2142},{250.537,-50.6058},{246,-32},{226,-28},{213.083,-21.7575},{209.678,-9.3942},{214,2},{226,4},{238,2},{240.322,-13.5157},{240.322,-13.5157}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{294.322,-13.5157},{294.342,-13.5157},{301.132,-13.5157},{301.132,-13.5157},{298,6},{280,10},{263.678,7.0898},{256.868,-13.5157},{266,-30},{280,-34},{280,-34},{280,-28},{280,-28},{267.082,-21.7575},{263.678,-9.3942},{268,2},{280,4},{292,2},{294.322,-13.5157},{294.322,-13.5157}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{336,-42},{336,-42},{350.322,-46.2425},{353.727,-58.606},{346.917,-70.969},{333.298,-70.969},{320,-68},{316.389,-54.597},{316.273,-54.484},{309.463,-54.484},{309.463,-54.484},{312.868,-70.969},{326.488,-79.214},{350.322,-79.214},{360.537,-58.606},{356,-40},{336,-36},{336,-36},{336,-42}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{336,-134},{336,-134},{350.322,-138.243},{353.727,-150.606},{346.917,-162.969},{333.298,-162.969},{320,-160},{316.389,-146.597},{316.273,-146.484},{309.463,-146.484},{309.463,-146.484},{312.868,-162.969},{326.488,-171.214},{350.322,-171.214},{360.537,-150.606},{356,-132},{336,-128},{336,-128},{336,-134}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{336,-127.214},{336,-127.214},{321.678,-122.971},{318.273,-110.608},{325.083,-98.245},{338.702,-98.245},{352,-101.214},{355.611,-114.617},{355.727,-114.73},{362.537,-114.73},{362.537,-114.73},{359.132,-98.245},{345.512,-90},{321.678,-90},{311.463,-110.608},{316,-129.214},{336,-133.214},{336,-133.214},{336,-127.214}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{292.322,-85.5157},{292.342,-85.5157},{299.132,-85.5157},{299.132,-85.5157},{296,-66},{278,-62},{261.678,-64.9102},{254.868,-85.5157},{264,-102},{278,-106},{278,-106},{278,-100},{278,-100},{265.082,-93.7575},{261.678,-81.3942},{266,-70},{278,-68},{290,-70},{292.322,-85.5157},{292.322,-85.5157}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{263.678,-120.484},{263.658,-120.484},{256.868,-120.484},{256.868,-120.484},{260,-140},{278,-144},{294.322,-141.09},{301.132,-120.484},{292,-104},{278,-100},{278,-100},{278,-106},{278,-106},{290.918,-112.243},{294.322,-124.606},{290,-136},{278,-138},{266,-136},{263.678,-120.484},{263.678,-120.484}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{12.322,16.4843},{12.342,16.4843},{19.132,16.4843},{19.132,16.4843},{16,36},{-2,40},{-18.322,37.0898},{-25.132,16.4843},{-16,0},{-2,-4},{-2,-4},{-2,2},{-2,2},{-14.918,8.2425},{-18.322,20.6058},{-14,32},{-2,34},{10,32},{12.322,16.4843},{12.322,16.4843}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-16.322,-18.484},{-16.342,-18.484},{-23.132,-18.484},{-23.132,-18.484},{-20,-38},{-2,-42},{14.322,-39.09},{21.132,-18.484},{12,-2},{-2,2},{-2,2},{-2,-4},{-2,-4},{10.918,-10.243},{14.322,-22.606},{10,-34},{-2,-36},{-14,-34},{-16.322,-18.484},{-16.322,-18.484}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid)}));
  ...
  partial package TSPIcon2 "Icon for ThermoSysPro library"
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true)), Icon(coordinateSystem(preserveAspectRatio=true), graphics={
          Polygon(
            points={{-274,-6},{-274,-6}},
            lineColor={0,0,0},
          ...
          Line(points={{-90,-72}},color={128,128,128}),
          Polygon(
            points={{-77.981,-54.067},{-77.981,-54.067},{-73.4589,-46.1799},{-68.937,-30.4057},{-64.416,-2.80444},{-59.894,32.6891},{-64.416,60.2928},{-68.937,68.1799},{-64.416,72.1195},{-37.282,76.067},{-14.6315,76.067},{-5.5834,72.1195},{-10.106,64.2324},{-10.106,28.7451},{-1.0624,-22.5186},{4.0615,-26.9901},{7.9801,-30.4057},{3.1344,-31.253},{-68.937,-50.1195},{-77.981,-54.067}},
            lineColor={0,0,0},
            smooth=Smooth.Bezier,
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid,
            pattern=LinePattern.None),
          Polygon(
            points={{-1.2221,6.339},{10.8305,6.339},{10.8305,9.5788},{22.8827,9.5788},{22.8827,6.339},{28.9084,6.339},{28.9084,-19.5793},{37.9477,-19.5793},{37.9477,19.2989},{43.9737,19.2989},{43.9737,-19.5793},{50.0009,-19.5793},{50.0009,22.5379},{56.0264,22.5379},{56.0264,-0.14},{74.105,-0.14},{74.105,6.339},{83.1442,6.339},{83.1442,9.5788},{86.156,9.5788},{86.156,6.339},{92.1841,6.339},{92.1841,9.5788},{95.1964,9.5788},{95.1964,6.339},{98.208,6.339},{98.208,-19.5793},{98.208,-22.8201},{101.22,-26.0564},{89.1701,-26.0564},{56.0264,-22.8201},{19.8699,-26.0564},{-1.2221,-32.5377},{-1.2221,6.339}},
            lineColor={0,0,0},
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid,
            pattern=LinePattern.None),
          Polygon(
            points={{-98.563,-63.9299},{-57.18,-42},{-11.6796,-28.8422},{42.1041,-20.0701},{83.482,-20.0701},{100,-20},{100.667,-20.2145},{100.667,-30.1657},{100,-30},{83.482,-28.8422},{42.1041,-28.8422},{-7.5358,-33.2279},{-57.18,-46.3857},{-98.563,-63.9299}},
            lineColor={162,220,16},
            smooth=Smooth.Bezier,
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid),
          Polygon(
            ...
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-96.563,-67.93},{-55.18,-46},{-9.68,-32.8422},{44.104,-24.0701},{96,-24},{96,-24},{96,-34},{96,-34},{44.104,-32.8422},{-5.536,-37.2279},{-55.18,-50.3857},{-96.563,-67.93}},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid,
            pattern=LinePattern.None)}));
  ...
  partial package TSPIcon3 "Icon for ThermoSysPro library"
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true)), Icon(coordinateSystem(preserveAspectRatio=true), graphics={
          Polygon(
            points={{-274,-6},{-274,-6}},
            lineColor={0,0,0},
          ...
          Polygon(
            ...
            pattern=LinePattern.None),
          Polygon(
            points={{-82.563,-93.93},{-41.18,-72},{4.32,-58.8422},{58.104,-50.0701},{99.482,-50.0701},{100.306,-50.1429},{100.549,-58.748},{99.482,-58.8422},{58.104,-58.8422},{8.464,-63.2279},{-41.18,-76.3857},{-82.563,-93.93}},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid,
            pattern=LinePattern.None),
          Polygon(
            ...
            smooth=Smooth.Bezier),
          Polygon(
            points={{63.512,20.003},{70.322,13.334},{73.726,-0.003},{73.726,-0.003},{66.918,-0.003},{66.918,-0.003},{63.512,13.334},{36.273,13.334},{36.273,13.334},{36.273,20.003},{36.273,20.003},{63.512,20.003}},
            lineColor={16,87,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{63.512,-20.003},{70.322,-13.334},{73.727,0.003},{73.727,0.003},{66.918,0.003},{66.918,0.003},{63.512,-13.334},{36.273,-13.334},{36.273,-13.334},{36.273,-20.003},{36.273,-20.003},{63.512,-20.003}},
            lineColor={16,87,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{18.322,-1.516},{18.342,-1.516},{25.132,-1.516},{25.132,-1.516},{22,18},{4,22},{-12.322,19.09},{-19.132,-1.516},{-10,-18},{4,-22},{4,-22},{4,-16},{4,-16},{-8.918,-9.757},{-12.322,2.606},{-8,14},{4,16},{16,14},{18.322,-1.516},{18.322,-1.516}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-96.563,-63.93},{-55.18,-42},{-9.6796,-28.8422},{44.1041,-20.0701},{85.482,-20.0701},{102,-20},{102.667,-20.2145},{102.667,-30.1657},{102,-30},{85.482,-28.8422},{44.1041,-28.8422},{-5.5358,-33.2279},{-55.18,-46.3857},{-96.563,-63.93}},
            lineColor={162,220,16},
            smooth=Smooth.Bezier,
            fillColor={162,220,16},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-10.322,-36.484},{-10.342,-36.484},{-17.132,-36.484},{-17.132,-36.484},{-14,-56},{4,-60},{20.322,-57.09},{27.132,-36.484},{18,-20},{4,-16},{4,-16},{4,-22},{4,-22},{16.918,-28.243},{20.322,-40.606},{16,-52},{4,-54},{-8,-52},{-10.322,-36.484},{-10.322,-36.484}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{31.089,-60},{36.938,-60},{36.938,20},{31.089,20},{31.089,-60}},
            lineColor={16,87,200},
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
          Polygon(
            points={{-40.232,13.022},{-40.232,21.278},{-40.232,21.278},{-33.768,21.278},{-33.768,21.278},{-34,4},{-34,4},{-24,4},{-24,4},{-26,-2},{-26,-2},{-34,-2},{-34,-2},{-34,-54},{-28,-54},{-28,-54},{-28,-60},{-28,-60},{-36,-60},{-40.232,-48.896},{-40,-2},{-40,-2},{-48,-2},{-48,-2},{-48,4},{-48,4},{-40,4},{-40,4},{-40.232,13.022}},
            lineColor={28,108,200},
            smooth=Smooth.Bezier,
            fillColor={16,87,200},
            fillPattern=FillPattern.Solid),
  ...
  partial package TSPIcon4 "Icon for ThermoSysPro library"
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true)), Icon(
        ...
        graphics={
          ...
          Polygon(
            ...
            lineColor={0,0,0},
            smooth=Smooth.Bezier),
          Bitmap(extent={{-98,-100},{98,100}}, fileName="modelica://ThermoSysPro/logo_tsp.png"),
          Polygon(
            points={{100,0},{100,0},{100,70},{100,92},{92,100},{70,100},{0,100},{-70,100},{-92,100},{-100,92},{-100,70},{-100,0},{-100,0},{-96,0},{-96,0},{-96,70},{-96,90},{-90,96},{-70,96},{0,96},{70,96},{90,96},{96,90},{96,70},{96,0},{96,0},{100,0}},
            lineColor={162,220,16},
            lineThickness=1,
