...
## ThermoSysPro Version 4.2
    ...
    "));
  type MolarReactionRate = Real(final quantity = "MolarReactionRate", final unit = "mol/(m3.s)") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025
...
## ThermoSysPro Version 4.2
    ...
    "));
  type DerEnergyByMoles = Real(final quantity = "DerEnergyByMoles", final unit = "J/mol") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025
...
## ThermoSysPro Version 4.2
    ...
    "));
  type DerEntropyByMoles = Real(final quantity = "DerEntropyByMoles", final unit = "J/(mol.K)") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025
...
## ThermoSysPro Version 4.2
    ...
    "));
  type DerVolumeByMoles = Real(final quantity = "DerVolumeByMoles", final unit = "m3/mol") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025

## ThermoSysPro Version 4.2

    "));
  type IsenthalpicExponent = Real(final quantity = "IsenthalpicExponent", unit = "1") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025
...
## ThermoSysPro Version 4.2
    ...
    "));
  type IsobaricVolumeExpansionCoefficient = Real(final quantity = "IsobaricVolumeExpansionCoefficient", unit = "1/K") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025

## ThermoSysPro Version 4.2

    "));
  type IsochoricPressureCoefficient = Real(final quantity = "IsochoricPressureCoefficient", unit = "1/K") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025

## ThermoSysPro Version 4.2

    "));
  type IsothermalCompressibility = Real(final quantity = "IsothermalCompressibility", unit = "1/Pa") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025

## ThermoSysPro Version 4.2

    "));
  type JouleThomsonCoefficient = Real(final quantity = "JouleThomsonCoefficient", unit = "K/Pa") annotation(
    Documentation(info = "## Copyright © EDF 2002 - 2025
...
## ThermoSysPro Version 4.2
  ...
  constant Units.SI.AmountOfSubstance MOLMIN = -1.0*MINPOS "Minimal Mole Number";
  constant Units.SI.AmountOfSubstance MOLMAX = 1.0e8 "Maximal Mole Number";
  ...
  constant Units.SI.ThermalConductivity LAMMIN = MINPOS "Minimal thermal conductivity";
  constant Units.SI.ThermalConductivity LAMNOM = 1.0 "Nominal thermal conductivity";
  constant Units.SI.ThermalConductivity LAMMAX = 1000.0 "Maximal thermal conductivity";
  constant Units.SI.DynamicViscosity ETAMIN = MINPOS "Minimal init dynamic viscosity";
  constant Units.SI.DynamicViscosity ETAMAX = 1.0e8 "Maximal init dynamic viscosity";
  constant Units.SI.DynamicViscosity ETANOM = 100.0 "Nominal init dynamic viscosity";
  ...
  constant Units.SI.MassFlowRate MDOTMIN = -1.0e5 "Minimal init mass flow rate";
  constant Units.SI.MassFlowRate MDOTMAX = 1.0e5 "Maximal init mass flow rate";
  constant Units.SI.MassFlowRate MDOTNOM = 1.0 "Nominal init mass flow rate";
  constant Units.SI.MassFraction MASSXMIN = -1.0*MINPOS "Minimal init mass fraction";
  constant Units.SI.MassFraction MASSXMAX = 1.0 "Maximal init mass fraction";
  constant Units.SI.MassFraction MASSXNOM = 0.1 "Nominal init mass fraction";
  ...
  constant Units.SI.MoleFraction MOLEYMIN = -1.0*MINPOS "Minimal init mole fraction";
  constant Units.SI.MoleFraction MOLEYMAX = 1.0 "Maximal init mole fraction";
  constant Units.SI.MoleFraction MOLEYNOM = 0.1 "Nominal init mole fraction";
  constant Units.SI.MomentumFlux GMIN = -1.0e8 "Minimal init momentum flux";
  constant Units.SI.MomentumFlux GMAX = 1.0e8 "Maximal init momentum flux";
  ...
  constant Units.SI.Pressure COMPPMIN = -1.0*MINPOS "Minimal init pressure";
  ...
  constant Units.SI.RatioOfSpecificHeatCapacities KAPPAMIN = 1.0 "Minimal init isentropic exponent";
  constant Units.SI.RatioOfSpecificHeatCapacities KAPPAMAX = 1.7 "Maximal init isentropic exponent";
  constant Units.SI.RatioOfSpecificHeatCapacities KAPPANOM = 1.2 "Nominal init isentropic exponent";
  constant Units.SI.SpecificEnergy SEMIN = -1.0e8 "Minimal init specific energy";
  constant Units.SI.SpecificEnergy SEMAX = 1.0e8 "Maximal init specific energy";
  constant Units.SI.SpecificEnergy SENOM = 1.0e6 "Nominal init specific energy";
  constant Units.SI.SpecificEnthalpy SHMIN = -1.0e8 "Minimal init specific enthalpy";
  constant Units.SI.SpecificEnthalpy SHMAX = 1.0e8 "Maximal init specific enthalpy";
  constant Units.SI.SpecificEnthalpy SHNOM = 1.0e6 "Nominal init specific enthalpy";
  constant Units.SI.SpecificEntropy SSMIN = -1.0e6 "Minimal init specific entropy";
  constant Units.SI.SpecificEntropy SSMAX = 1.0e6 "Maximal init specific entropy";
  constant Units.SI.SpecificEntropy SSNOM = 1.0e3 "Nominal init specific entropy";
  constant Units.SI.SpecificHeatCapacity CPMIN = MINPOS "Minimal init specific heat capacity";
  constant Units.SI.SpecificHeatCapacity CPMAX = 1.0e6 "Maximal init specific heat capacity";
  constant Units.SI.SpecificHeatCapacity CPNOM = 1.0e3 "Nominal init specific heat capacity";
  ...
  constant Units.SI.ThermalConductivity LMIN = MINPOS "Minimal init thermal conductivity";
  constant Units.SI.ThermalConductivity LMAX = 500.0 "Maximal init thermal conductivity";
  constant Units.SI.ThermalConductivity LNOM = 1.0 "Nominal init thermal conductivity";
  ...
  package ThermoFluidSpecial "Property records used by the ThermoFluid library"
    record FixedIGProperties "Constant properties for ideal gases"
      ...
      Units.SI.SpecificEnthalpy[nspecies] Hf "Enthalpy of formation at 298.15K";
...
## ThermoSysPro Version 4.2
    ...
    record ThermoBaseVars
      ...
      Units.SI.Pressure[n] p(min = PMIN, max = PMAX, nominal = PNOM, start = fill(1.0e5, n)) "Pressure";
      Units.SI.Temperature[n] T(min = TMIN, max = TMAX, nominal = TNOM) "Temperature";
      Units.SI.Density[n] d(min = DMIN, max = DMAX, nominal = DNOM) "Density";
      Units.SI.SpecificEnthalpy[n] h(min = SHMIN, max = SHMAX, nominal = SHNOM) "Specific enthalpy";
      Units.SI.SpecificEntropy[n] s(min = SSMIN, max = SSMAX, nominal = SSNOM) "Specific entropy";
      Units.SI.RatioOfSpecificHeatCapacities[n] kappa "Ratio of cp/cv";
      Units.SI.Mass[n] M(min = MMIN, max = MMAX, nominal = MNOM) "Total mass";
      Units.SI.Energy[n] U(min = EMIN, max = EMAX, nominal = ENOM) "Inner energy";
      Units.SI.MassFlowRate[n] dM(min = MDOTMIN, max = MDOTMAX, nominal = MDOTNOM) "Change in total mass";
      Units.SI.Power[n] dU(min = POWMIN, max = POWMAX, nominal = POWNOM) "Change in inner energy";
      Units.SI.Volume[n] V(min = VMIN, max = VMAX, nominal = VNOM) "Volume";
      Units.SI.MassFraction[n, nspecies] mass_x(min = MASSXMIN, max = MASSXMAX, nominal = MASSXNOM) "Mass fraction";
      Units.SI.MoleFraction[n, nspecies] mole_y(min = MOLEYMIN, max = MOLEYMAX, nominal = MOLEYNOM) "Mole fraction";
      Units.SI.Mass[n, nspecies] M_x(min = MMIN, max = MMAX, nominal = MNOM) "Component mass";
      Units.SI.MassFlowRate[n, nspecies] dM_x(min = MDOTMIN, max = MDOTMAX, nominal = MDOTNOM) "Rate of change in component mass";
      ...
      Units.SI.MolarMass[n] MM(min = MMMIN, max = MMMAX, nominal = MMNOM) "Molar mass of mixture";
      Units.SI.AmountOfSubstance[n] Moles(min = MOLMIN, max = MOLMAX, nominal = MOLNOM) "Total moles";
      Units.SI.AmountOfSubstance[n, nspecies] Moles_z(min = MOLMIN, max = MOLMAX, nominal = MOLNOM) "Mole vector";
      annotation(
        Documentation(info = "
Model description  
...
## ThermoSysPro Version 4.2
    ...
    record ThermoProperties "Thermodynamic base property data for all state models"
      extends Modelica.Icons.Record;
      parameter Integer nspecies(min = 1) "Number of species";
      Units.SI.Temperature T(min = TMIN, max = TMAX, nominal = TNOM) "Temperature";
      Units.SI.Density d(min = DMIN, max = DMAX, nominal = DNOM) "Density";
      Units.SI.Pressure p(min = PMIN, max = PMAX, nominal = PNOM) "Pressure";
      Units.SI.Volume V(min = VMIN, max = VMAX, nominal = VNOM) "Volume";
      Units.SI.SpecificEnthalpy h(min = SHMIN, max = SHMAX, nominal = SHNOM) "Specific enthalpy";
      Units.SI.SpecificEnergy u(min = SEMIN, max = SEMAX, nominal = SENOM) "Specific inner energy";
      Units.SI.SpecificEntropy s(min = SSMIN, max = SSMAX, nominal = SSNOM) "Specific entropy";
      Units.SI.SpecificGibbsFreeEnergy g(min = SHMIN, max = SHMAX, nominal = SHNOM) "Specific Gibbs free energy";
      Units.SI.SpecificHeatCapacity cp(min = CPMIN, max = CPMAX, nominal = CPNOM) "Heat capacity at constant pressure";
      Units.SI.SpecificHeatCapacity cv(min = CPMIN, max = CPMAX, nominal = CPNOM) "Heat capacity at constant volume";
      Units.SI.SpecificHeatCapacity R(min = CPMIN, max = CPMAX, nominal = CPNOM) "Gas constant";
      Units.SI.MolarMass MM(min = MMMIN, max = MMMAX, nominal = MMNOM) "Molar mass of mixture";
      Units.SI.MassFraction[nspecies] mass_x(min = MASSXMIN, max = MASSXMAX, nominal = MASSXNOM) "Mass fraction";
      Units.SI.MoleFraction[nspecies] mole_y(min = MOLEYMIN, max = MOLEYMAX, nominal = MOLEYNOM) "Mole fraction";
      Units.SI.RatioOfSpecificHeatCapacities kappa "Ratio of cp/cv";
      Units.SI.DerDensityByTemperature ddTp "Derivative of density by temperature at constant pressure";
      Units.SI.DerDensityByPressure ddpT "Derivative of density by pressure at constant temperature";
      ...
      Units.SI.SpecificHeatCapacity duTp "Derivative of inner energy by temperature at constant p";
      Units.SI.SpecificEnergy ddx[nspecies] "Derivative vector of density by change in mass composition";
      Units.SI.SpecificEnergy[nspecies] compu(min = SEMIN, max = SEMAX, nominal = SENOM) "Inner energy of the components";
      Units.SI.Pressure[nspecies] compp(min = COMPPMIN, max = COMPPMAX, nominal = COMPPNOM) "partial pressures of the components";
      Units.SI.Velocity a(min = VELMIN, max = VELMAX, nominal = VELNOM) "Speed of sound";
      Units.SI.HeatCapacity dUTZ "Derivative of inner energy by temperature at constant moles";
      Units.SI.MolarInternalEnergy[nspecies] dUZT "Derivative of inner energy by moles at constant temperature";
      Units.SI.SpecificEnthalpy[nspecies] dHMxT(min = SEMIN, max = SEMAX, nominal = SENOM) "Derivative of total enthalpy w.r.t. component mass at constant T";
...
## ThermoSysPro Version 4.2
    ...
    record ThermoProperties_ph "Thermodynamic property data for pressure p and specific enthalpy h as dynamic states"
      extends Modelica.Icons.Record;
      Units.SI.Temperature T(min = 1.0e-9, max = 10000.0, nominal = 298.15) "Temperature";
      Units.SI.Density d(min = 1.0e-9, max = 10000.0, nominal = 10.0) "Density";
      Units.SI.SpecificEnergy u(min = -1.0e8, max = 1.0e8, nominal = 1.0e6) "Specific inner energy";
      Units.SI.SpecificEntropy s(min = -1.0e6, max = 1.0e6, nominal = 1.0e3) "Specific entropy";
      Units.SI.SpecificHeatCapacity cp(min = 1.0, max = 1.0e6, nominal = 1000.0) "Heat capacity at constant pressure";
      Units.SI.SpecificHeatCapacity cv(min = 1.0, max = 1.0e6, nominal = 1000.0) "Heat capacity at constant volume";
      Units.SI.SpecificHeatCapacity R(min = 1.0, max = 1.0e6, nominal = 1000.0) "Gas constant";
      Units.SI.RatioOfSpecificHeatCapacities kappa "Ratio of cp/cv";
      Units.SI.Velocity a(min = 1.0, max = 10000.0, nominal = 300.0) "Speed of sound";
      Units.SI.DerDensityByEnthalpy ddhp "Derivative of density by enthalpy at constant pressure";
      Units.SI.DerDensityByPressure ddph "Derivative of density by pressure at constant enthalpy";
...
## ThermoSysPro Version 4.2
    ...
    record ThermoProperties_pT "Thermodynamic property data for pressure p and temperature T as dynamic states"
      extends Modelica.Icons.Record;
      Units.SI.Density d(min = 1.0e-9, max = 10000.0, nominal = 10.0) "Density";
      Units.SI.SpecificEnthalpy h(min = -1.0e8, max = 1.0e8, nominal = 1.0e6) "Specific enthalpy";
      Units.SI.SpecificEnergy u(min = -1.0e8, max = 1.0e8, nominal = 1.0e6) "Specific inner energy";
      Units.SI.SpecificEntropy s(min = -1.0e6, max = 1.0e6, nominal = 1.0e3) "Specific entropy";
      Units.SI.SpecificHeatCapacity cp(min = 1.0, max = 1.0e6, nominal = 1000.0) "Heat capacity at constant pressure";
      Units.SI.SpecificHeatCapacity cv(min = 1.0, max = 1.0e6, nominal = 1000.0) "Heat capacity at constant volume";
...
## ThermoSysPro Version 4.2
    ...
    record ThermoProperties_dT "Thermodynamic property data for density d and temperature T as dynamic states"
      extends Modelica.Icons.Record;
      Units.SI.Pressure p(min = 1.0, max = 1.0e9, nominal = 1.0e5) "Pressure";
      Units.SI.SpecificEnthalpy h(min = -1.0e8, max = 1.0e8, nominal = 1.0e6) "Specific enthalpy";
      Units.SI.SpecificEnergy u(min = -1.0e8, max = 1.0e8, nominal = 1.0e6) "Specific inner energy";
      Units.SI.SpecificEntropy s(min = -1.0e6, max = 1.0e6, nominal = 1.0e3) "Specific entropy";
      Units.SI.SpecificHeatCapacity cp(min = 1.0, max = 1.0e6, nominal = 1000.0) "Heat capacity at constant pressure";
...
## ThermoSysPro Version 4.2
  ...
  record SaturationProperties "Properties in the two phase region"
    ...
    Units.SI.RatioOfSpecificHeatCapacities kappa "Isentropic expansion coefficient";
...
## ThermoSysPro Version 4.2
  ...
  record TwoPhaseTransportProps "Defines properties on both phase boundaries, needed in the two phase region"
    ...
    Units.SI.DynamicViscosity eta_vap "Dynamic viscosity on the dew line";
    Units.SI.DynamicViscosity eta_liq "Dynamic viscosity on the bubble line";
    Units.SI.ThermalConductivity lam_vap "Thermal conductivity on the dew line";
    Units.SI.ThermalConductivity lam_liq "Thermal conductivity on the bubble line";
...
## ThermoSysPro Version 4.2
  ...
  record AuxiliaryProperties "Intermediate property data record"
    ...
    Units.SI.Density rho "Density";
    Units.SI.SpecificEntropy s "Specific entropy";
    Units.SI.DerPressureByTemperature pt "Derivative of pressure w.r.t. temperature";
    Units.SI.DerPressureByDensity pd "Derivative of pressure w.r.t. density";
    Real vt "Derivative of specific volume w.r.t. temperature";
    Real vp "Derivative of specific volume w.r.t. pressure";
    annotation(
      Documentation(info = "## Copyright © EDF 2002 - 2025
...
## ThermoSysPro Version 4.2
  ...
  function gibbsToBridgmansTables "Calculates base coefficients for Bridgman's tables from gibbs enthalpy"
    ...
    output Units.SI.SpecificHeatCapacity cp "Heat capacity at constant pressure";
...
## ThermoSysPro Version 4.2
  ...
  function Gibbs2_ph "Function to calculate analytic derivatives for computing T given p and h"
    ...
    output ThermoSysPro.Properties.Common.NewtonDerivatives_ph nderivs "Derivatives for Newton iteration to calculate d and t from p and h";
  algorithm
...
## ThermoSysPro Version 4.2
  ...
  function Gibbs2_dT "Function to calculate analytic derivatives for computing p given d and T"
    extends Modelica.Icons.Function;
    input ThermoSysPro.Properties.Common.GibbsDerivs2 g "Dimensionless derivatives of Gibbs function";
    output ThermoSysPro.Properties.Common.NewtonDerivatives_dT nderivs "Derivatives for Newton iteration to compute p from d and T";
  algorithm
    nderivs.v := g.gp;
...
Author: Hubertus Tummescheit,   
    ...
    "),
    Icon(graphics = {Rectangle(lineColor = {200, 200, 200}, fillColor = {248, 248, 248}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100.0, -100.0}, {100.0, 100.0}}, radius = 25.0), Rectangle(lineColor = {128, 128, 128}, extent = {{-100.0, -100.0}, {100.0, 100.0}}, radius = 25.0), Rectangle(lineColor = {200, 200, 200}, fillColor = {248, 248, 248}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100.0, -100.0}, {100.0, 100.0}}, radius = 25.0), Rectangle(lineColor = {128, 128, 128}, extent = {{-100.0, -100.0}, {100.0, 100.0}}, radius = 25.0), Ellipse(lineColor = {102, 102, 102}, fillColor = {204, 204, 204}, pattern = LinePattern.None, fillPattern = FillPattern.Sphere, extent = {{-60.0, -60.0}, {60.0, 60.0}})}));
end Common;