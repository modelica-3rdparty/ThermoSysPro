...
model SynchronousMotor "Synchronous electrical motor"
  parameter ThermoSysPro.Units.nonSI.AngularVelocity_rpm Vrot = 1400. "Nominal rotational speed";
  parameter ThermoSysPro.Units.nonSI.AngularVelocity_rpm Vrot0 = 0 "Initial rotational speed (active if steady_state_mech=true)";
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputLogical marche annotation(
    Placement(transformation(origin = {0, 44}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  ThermoSysPro.ElectroMechanics.Connectors.MechanichalTorque C annotation(
