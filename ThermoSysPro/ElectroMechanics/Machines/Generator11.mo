...
model Generator11 "Electrical generator with eleven inputs"
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec2 annotation(
    Placement(transformation(extent = {{-116, 78}, {-84, 106}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec1 annotation(
    Placement(transformation(extent = {{-116, 116}, {-84, 144}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec3 annotation(
    Placement(transformation(extent = {{-116, 40}, {-84, 68}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec4 annotation(
    Placement(transformation(extent = {{-116, 3}, {-84, 31}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec5 annotation(
    Placement(transformation(extent = {{-116, -34}, {-84, -6}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec6 annotation(
    Placement(transformation(extent = {{-116, -71}, {-84, -43}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec7 annotation(
    Placement(transformation(extent = {{-116, -108}, {-84, -80}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec8 annotation(
    Placement(transformation(extent = {{-116, -144}, {-84, -116}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputReal MechPower annotation(
    Placement(transformation(origin = {88, 134}, extent = {{-10, 10}, {10, -10}}, rotation = 90)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec9 annotation(
    Placement(transformation(origin = {-20, -142}, extent = {{-14, -16}, {14, 16}}, rotation = 90)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec10 annotation(
    Placement(transformation(origin = {34, -142}, extent = {{-14, -16}, {14, 16}}, rotation = 90)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal Wmec11 annotation(
    Placement(transformation(origin = {98, -144}, extent = {{-14, -16}, {14, 16}}, rotation = 90)));
equation
