...
model Shaft "Mechanical coupling"
  ...
  Units.SI.AngularVelocity w_rel "Relative angular speed between the two extremities of the shaft";
  Units.SI.Torque Ctr "Transmitted torque";
  ThermoSysPro.ElectroMechanics.Connectors.MechanichalTorque C2 annotation(
    Placement(transformation(extent = {{100, -10}, {120, 10}}, rotation = 0)));
  ThermoSysPro.ElectroMechanics.Connectors.MechanichalTorque C1 annotation(
...
equation
  ...
  annotation(
    ...
    Window(x = 0.06, y = 0.13, width = 0.6, height = 0.6),
    Documentation(info = "
