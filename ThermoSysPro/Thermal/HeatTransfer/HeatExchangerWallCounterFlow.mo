...
model HeatExchangerWallCounterFlow "Heat exchanger wall counter flow "
  ...
  parameter Units.SI.SpecificHeatCapacity cpw = 1000 "Wall specific heat capacity";
