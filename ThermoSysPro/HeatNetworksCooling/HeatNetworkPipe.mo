...
model HeatNetworkPipe "Static pipe with thermal losses and singular pressure losses"
  ...
  parameter Units.SI.CoefficientOfHeatTransfer K = 0.1 "Heat exchange coefficient with ambient";
  parameter ThermoSysPro.Units.xSI.PressureLossCoefficient Ks = 1000 "Singular pressure losses coefficient";
  ...
  ThermoSysPro.Units.SI.PressureDifference deltaPs "Singular pressure losses";
  ...
  ThermoSysPro.WaterSteam.Connectors.FluidInlet C1 annotation(
    Placement(transformation(extent = {{-90, 80}, {-70, 100}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet C2 annotation(
    Placement(transformation(extent = {{70, 80}, {90, 100}}, rotation = 0)));
...
/* Fluid thermodynamic properties */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{60, 80}, {100, 80}, {100, -100}, {-100, -100}, {-100, 80}, {-60, 80}, {-60, -60}, {60, -60}, {60, 80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid)}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{60, 80}, {100, 80}, {100, -100}, {-100, -100}, {-100, 80}, {-60, 80}, {-60, -60}, {60, -60}, {60, 80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid)}),
