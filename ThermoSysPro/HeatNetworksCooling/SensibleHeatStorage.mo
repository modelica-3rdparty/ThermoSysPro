...
model SensibleHeatStorage "Sensible heat storage"
  parameter Units.SI.Area S = 1 "Exchange surface between the water and the surface";
  ...
  parameter Units.SI.ThermalConductivity LambdaC = 0.04 "Insulation thermal conductivity";
  ...
  parameter Units.SI.Temperature Tss0 "Initial storage temperature (active if steady_state=false)";
...
/* PCM mass */
  m = rhom*V*Fremp;
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-80, 50}, {-40, 100}, {40, 100}, {80, 52}, {80, -50}, {40, -100}, {-40, -100}, {-80, -48}, {-80, 50}}, lineColor = {0, 0, 0}, fillColor = {120, 255, 0}, fillPattern = FillPattern.Solid), Text(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, textString = "S")}),
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-80, 50}, {-40, 100}, {40, 100}, {80, 52}, {80, -50}, {40, -100}, {-40, -100}, {-80, -48}, {-80, 50}}, lineColor = {0, 0, 0}, fillColor = {120, 255, 0}, fillPattern = FillPattern.Solid), Text(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, textString = "S")}),
