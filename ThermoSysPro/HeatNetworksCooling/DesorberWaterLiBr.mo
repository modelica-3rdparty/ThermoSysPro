...
model DesorberWaterLiBr "Water LiBr solution desorber with water heating"
  ...
  parameter ThermoSysPro.Units.SI.PressureDifference DPc = 0 "Pressure losses in the hot fluid a a percent of the pressure at the inlet";
  ...
  Units.SI.Temperature Tsatc(start = 400) "Hot water saturation temperature at the outlet";
  Units.SI.SpecificEnthalpy Hminc(start = 1e5) "Minimum specific enthalpy reachable by the hot water";
  Real Xmin "Minimum mass fraction reachable by the solution";
  Units.SI.MassFlowRate Qs_min(start = 100) "Minimum solution mass flow rate at the outlet";
  Units.SI.MassFlowRate Qv_max(start = 100) "Maximum steam mass flow rate at the outlet";
  Units.SI.Power Wmax(start = 1e6) "Maximum power exchangeable";
  ThermoSysPro.Units.SI.TemperatureDifference DTm(start = 40) "Differences of the average temperatures between the hot and cold sides";
  ThermoSysPro.WaterSteam.Connectors.FluidInlet Ec annotation(
    Placement(transformation(extent = {{-84, -72}, {-64, -52}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Svap annotation(
    Placement(transformation(extent = {{-10, 80}, {10, 101}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Connectors.FluidOutlet Sc annotation(
  ...
  ThermoSysPro.WaterSolution.Connectors.WaterSolutionInlet Ef annotation(
    Placement(transformation(extent = {{64, 50}, {84, 70}}, rotation = 0)));
  ...
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph provap annotation(
