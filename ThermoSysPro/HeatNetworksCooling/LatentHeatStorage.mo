...
model LatentHeatStorage "Latent heat storage"
  ...
  parameter Units.SI.SpecificHeatCapacity CpL = 4.18 "Fluid specific heat capacity";
  parameter Units.SI.SpecificHeatCapacity CpS = 4.18 "Storage specific heat capacity";
  parameter Units.SI.ThermalConductivity Lambda = 0.585 "PCM (phase change material) thermal conductivity";
  parameter Units.SI.ThermalConductivity LambdaC = 0.585 "Insulation thermal conductivity";
  ...
  parameter Units.SI.CoefficientOfHeatTransfer h = 20 "Convective heat exchange coefficient with the water";
  parameter Units.SI.CoefficientOfHeatTransfer ha = 20 "Convective heat exchange coefficient with the ambient air";
  parameter Units.SI.Temperature Tamb "Ambient air temperature";
  parameter Units.SI.Temperature Tsl0 "Initial storage temperature (active if steady_state=false)";
  ...
  Units.SI.SpecificEnthalpy HsatL "Storage specific enthalpy at the liquid saturation temperature";
  Units.SI.SpecificEnthalpy HsatS "Storage specific enthalpy at the solid saturation temperature";
  ...
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph pros "Propriétés de l'eau" annotation(
...
/* PCM mass */
  m = rhom*V*Fremp;
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-80, 50}, {-40, 100}, {40, 100}, {80, 52}, {80, -50}, {40, -100}, {-40, -100}, {-80, -48}, {-80, 50}}, lineColor = {0, 0, 0}, fillColor = {120, 255, 0}, fillPattern = FillPattern.Solid), Text(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, fillColor = {120, 255, 0}, fillPattern = FillPattern.Solid, textString = "L")}),
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-80, 50}, {-40, 100}, {40, 100}, {80, 52}, {80, -50}, {40, -100}, {-40, -100}, {-80, -48}, {-80, 50}}, lineColor = {0, 0, 0}, fillColor = {120, 255, 0}, fillPattern = FillPattern.Solid), Text(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, textString = "L")}),
