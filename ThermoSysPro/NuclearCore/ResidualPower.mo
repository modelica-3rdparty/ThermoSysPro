...
model ResidualPower "Calculation of the residual power given by the decay of the fission
  ...
  parameter Real Kris[:] = {0.0251, 0.01654, 0.02586} "Fraction of the power associated to group i";
  parameter Real Tris[:] = {15, 137, 2910} "Time constant associated to group i (s)";
  ...
  ThermoSysPro.Units.SI.Power Pres[N](start = {89.35e6, 58.88e6, 92.05e6}) "Residual power associated to the groups of radio-isotopes (W)";
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal EntreePneut annotation(
    extent = [-120, -10; -100, 10],
    Placement(transformation(extent = {{-120, -10}, {-100, 10}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputReal SortiePresTot annotation(
