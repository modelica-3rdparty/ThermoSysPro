...
block MassBalance_HeterogeneousPhases
  ...
  output MixtureConnector mix_out_liq[n_out_liq](redeclare package Species =
        Species) annotation (Placement(transformation(extent={{30,-52},{50,-32}}),
        iconTransformation(extent={{30,-52},{50,-32}})));
  output MixtureConnector mix_out_gas[n_out_gas](redeclare package Species =
        Species) annotation (Placement(transformation(extent={{30,32},
            {50,52}}), iconTransformation(extent={{30,32},{50,52}})));
