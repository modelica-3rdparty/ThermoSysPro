...
model ConcentratedSolarPowerPlant_PTSC "Model of a concentrated solar power plant with PTSC"
  ...
  WaterSteam.HeatExchangers.DynamicOnePhaseFlowPipe TubeEcran_2(option_temperature = 2, L = L2, Ns = Ns2, T0 = {659.137, 684.387, 693.983, 697.543, 698.861}, h0 = fill(650e3, Ns2), D = 0.04, hcCorr = 2, ntubes = 3, inertia = false, advection = false, P(start = {100000.0, 8120050.0, 8098500.0, 8074750.0, 8050150.0, 8025170.0, 8000000.0}), h(start = {2756570.0, 3040300.0, 3147840.0, 3187560.0, 3202330.0, 3208020.0, 3208020.0}), mu2(start = {1.94524E-005, 0.0002, 0.0002, 0.0002, 0.0002, 0.0002}), pro2(d(start = {43.2944, 998.0, 998.0, 998.0, 998.0, 998.0}))) annotation(
    Placement(transformation(extent = {{-31, 34}, {25, 78}}, rotation = 0)));
  Thermal.HeatTransfer.HeatExchangerWallCounterFlow Paroi2(cpw = 1000, steady_state = true, lambda = 26, L = L2, Ns = Ns2, D = 0.04, ntubes = 3, e = 0.003, Tp2(start = {699.6, 697.841, 694.783, 686.553, 664.851}), Tp(start = {662.094, 685.508, 694.397, 697.697, 698.921})) annotation(
  ...
  Solar.HeatExchangers.DynamicOnePhaseFlowPipe_Oil TubeEcran_22(option_temperature = 2, Ns = Ns2, T0 = {698.976, 700.0, 700.0, 700.0, 700.0}, h0 = fill(800e3, Ns2), L = L2, D = 0.04, advection = false, hcCorr = 2, dpfCorr = 0.4, ntubes = 3, h(start = {871999.6875, 870017.0, 867699.0, 861464.0, 844586.0, 800057.0, 800057.0})) annotation(
    Placement(transformation(extent = {{24, 122}, {-33, 78}}, rotation = 0)));
  Thermal.HeatTransfer.HeatExchangerWallCounterFlow Paroi1(cpw = 1000, steady_state = true, lambda = 26, L = L1, Ns = Ns1, D = 0.04, ntubes = 3, e = 0.003, Tp1(start = {532.912, 533.493, 534.161, 534.93, 535.816, 536.836, 538.01, 539.364, 540.926, 542.728, 544.809, 547.216, 550.002, 553.232, 556.986, 561.36, 566.473, 572.131, 573.043, 574.577}), Tp2(start = {589.9, 577.664, 573.793, 567.743, 562.426, 557.888, 553.999, 550.657, 547.777, 545.292, 543.143, 541.284, 539.674, 538.278, 537.068, 536.017, 535.105, 534.312, 533.624, 533.026}), Tp(start = {532.971, 533.561, 534.239, 535.021, 535.92, 536.956, 538.149, 539.525, 541.111, 542.943, 545.059, 547.506, 550.341, 553.629, 557.453, 561.912, 567.13, 572.991, 575.434, 581.427})) annotation(
    Placement(transformation(extent = {{-174, 54}, {-114, 102}}, rotation = 0)));
  WaterSteam.HeatExchangers.DynamicTwoPhaseFlowPipe TubeEcran_1(option_temperature = 2, L = L1, Ns = Ns1, T0 = fill(300, Ns1), h0 = fill(650e3, Ns1), D = 0.04, ntubes = 3, inertia = false, advection = false, P(start = {8716030.0, 8695070.0, 8674080.0, 8653070.0, 8632030.0, 8610950.0, 8589840.0, 8568690.0, 8547480.0, 8526210.0, 8504870.0, 8483450.0, 8461930.0, 8440290.0, 8418510.0, 8396570.0, 8374420.0, 8352020.0, 8329300.0, 8305110.0, 8256160.0, 8135653.0}), h(start = {1130270.0, 1132680.0, 1135470.0, 1138670.0, 1142370.0, 1146630.0, 1151550.0, 1157240.0, 1163810.0, 1171420.0, 1180240.0, 1190480.0, 1202400.0, 1216300.0, 1232580.0, 1251720.0, 1274350.0, 1301310.0, 1336580.0, 1434650.0, 1715580.0, 2756578.25})) annotation(
    Placement(transformation(extent = {{-171, 34}, {-115, 78}}, rotation = 0)));
  Solar.HeatExchangers.DynamicOnePhaseFlowPipe_Oil TubeEcran_11(option_temperature = 2, L = L1, Ns = Ns1, T0 = {587.815, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0, 550.0}, h0 = fill(650e3, Ns1), D = 0.04, advection = false, hcCorr = 2, dpfCorr = 0.4, ntubes = 3, h(start = {801122.25, 638880.0, 582613.0, 562383.0, 546913.0, 533929.0, 522949.0, 513609.0, 505631.0, 498794.0, 492917.0, 487857.0, 483492.0, 479721.0, 476460.0, 473637.0, 471191.0, 469070.0, 467231.0, 465634.0, 464248.0, 464248.0})) annotation(
  ...
  WaterSteam.Machines.StaticCentrifugalPump Pompe(Pm(fixed = false, start = 3502560.0), a1(fixed = false) = -4.9345734425e8, hn(start = 716.167), a3 = 2000, b1 = -3500, b2 = 510, Q(fixed = true, start = 1.13), C2(h_vol(start = 150161.0)), Qv(start = 0.00113454), h(start = 143963.0)) annotation(
  ...
  WaterSteam.BoundaryConditions.SourceP sourcePCaloporteur(option_temperature = 2, h0 = 63.03e3, P0(fixed = false) = 500000, Q(fixed = true, start = 14.9263)) annotation(
  ...
  WaterSteam.Machines.StaticCentrifugalPump Pompe1(Pm(fixed = false), hn(start = 466.292), a3 = 2000, b2 = 510, b1 = -3500, a1(fixed = false) = -9.5e8, Q(fixed = false, start = 0.65), C2(P(fixed = false, start = 75e5)), C1(P(fixed = true, start = 70e5), h_vol(start = 1125640.0)), Qv(start = 0.00521975), h(start = 1126540.0)) annotation(
    Placement(transformation(extent = {{-158, -91}, {-178, -71}}, rotation = 0)));
  WaterSteam.PressureLosses.SingularPressureLoss PerteChargeCondPompe3(K = 1e-6) annotation(
    Placement(transformation(origin = {-120, -81}, extent = {{-6, -10}, {6, 10}}, rotation = 180)));
  WaterSteam.Machines.StodolaTurbine Turbine(W_fric = 1, Cst(fixed = false, start = 68143000000.0) = 6.19323e6, Qmax = 0.001, eta_is_min = 0.80, rhos(start = 10), eta_is_nom = 0.92, Pe(fixed = true, start = 8000000), Ps(fixed = false, start = 1800000), pros(d(start = 8.36949))) annotation(
  ...
  WaterSteam.Machines.StaticCentrifugalPump Pompe2(Pm(fixed = false), b2 = 510, b1 = -3500, hn(start = 350), adiabatic_compression = true, C1(P(fixed = false, start = 17e5), h_vol(start = 462620.0)), a3(fixed = true) = 500, C2(P(fixed = false, start = 24.5146e5)), p_rho = 900, Q(fixed = true, start = 7.2), a1(fixed = false) = -1e8) annotation(
    Placement(transformation(extent = {{-184, 129}, {-164, 149}}, rotation = 0)));
  WaterSteam.PressureLosses.SingularPressureLoss PerteCharge_Huile_2(K = 1e-6, p_rho = 900) annotation(
  ...
  WaterSteam.Machines.StodolaTurbine TurbineMp(W_fric = 1, Cst(fixed = false, start = 8378550000.0) = 6.19323e6, Qmax = 0.001, eta_is_min = 0.80, rhos(start = 10), eta_is_nom = 0.94, Pe(fixed = true, start = 1800000), Ps(fixed = false, start = 5000), pros(d(start = 0.0434309)), xm(start = 0.908482)) annotation(
  ...
  WaterSteam.HeatExchangers.NTUWaterHeating Re_1(KPurge = 10, SPurge = 0.3, Se(h(fixed = true, start = 600e3)), SCondDes(fixed = false, start = 9.57697) = 3, HDesF(start = 583561.0), HeiF(start = 150619.0), Hep(start = 884611.0), SDes(start = 0.932441), h(start = 882589.0), lambdaE = 1, KCond = 500) annotation(
  ...
  WaterSteam.Junctions.MassFlowMultiplier massFlowMultiplier2(alpha = 1/3, P(start = 2400000)) annotation(
