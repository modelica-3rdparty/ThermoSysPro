...
model ZeroFlow
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Tables.Table1DTemps Debit_eauA(Table = [0, 624.97; 300, 624.97; 2000, 0; 3000, 0]) annotation(
...
This model is documented in Sect. 7.2.5 of the ThermoSysPro book.  
