...
model TestSimpleDynamicCondenser
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.SourceP SourceRechauffeurEau(option_temperature = 2, h0 = 2401e3, P0 = 15050) annotation(
    Placement(transformation(extent = {{-207, 148}, {-183, 170}}, rotation = 0)));
  ThermoSysPro.WaterSteam.BoundaryConditions.SinkQ PuitsRechauffeurEau(h0 = 191812, Q0 = 192) annotation(
    Placement(transformation(extent = {{-184, -52}, {-208, -24}}, rotation = 0)));
  WaterSteam.BoundaryConditions.SourceQ sourcePCaloporteur(Q0 = 29804.5, h0 = 113e3) annotation(
    Placement(transformation(extent = {{-212, 30}, {-172, 68}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.SingularPressureLoss PerteChargeCondPompe1(K = 1e-6) annotation(
