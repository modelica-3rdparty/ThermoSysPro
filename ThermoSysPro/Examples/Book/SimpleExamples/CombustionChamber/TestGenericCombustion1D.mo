...
model TestGenericCombustion1D "TestGenericCombustion1D"
  ...
  parameter Units.SI.AbsolutePressure sinkWaterSteamP0(fixed = false, start = 19621600)
    "Outlet pressure computed by initialization";
  ...
  FlueGases.BoundaryConditions.SourcePQ sourceAir(Xso2 = 0, Q0 = 609.29, Xh2o = 0.01, Xo2 = 0.230, Xco2 = 0, P0 = 191000, T0 = 524.89) annotation(
...
equation
  ...
  connect(genericCombustionCCS.Cfg, sink.C) annotation(
    Line(points = {{0, 65.6}, {0, 91}, {0.44, 91}}, color = {0, 0, 0}, thickness = 1));
