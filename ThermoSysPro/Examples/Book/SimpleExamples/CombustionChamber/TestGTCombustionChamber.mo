...
model TestGTCombustionChamber
  ...
  ThermoSysPro.FlueGases.BoundaryConditions.SourcePQ Source_Fumees2(Xso2 = 0, Xco2 = 0.0, Xo2 = 0.23, Xh2o = 0.01, P0 = 15e5, Q0 = 415, T0 = 680) annotation(
    Placement(transformation(extent = {{-174, -26}, {-128, 22}}, rotation = 0)));
equation
  connect(GTCombustionChamber2.Cws, sourcePQ2.C) annotation(
    Line(points = {{-40.2, 57.4}, {-40.2, 68}, {-72, 68}}));
  connect(GTCombustionChamber2.Cfuel, sourceCombustible2.C) annotation(
    Line(points = {{0, -61.4}, {0, -75}, {-71, -75}}, color = {0, 0, 0}));
  connect(GTCombustionChamber2.Cfg, Puits_Fumees2.C) annotation(
    Line(points = {{60.3, -2}, {126.46, -2}}, color = {0, 0, 0}, thickness = 1));
  connect(Source_Fumees2.C, GTCombustionChamber2.Ca) annotation(
    Line(points = {{-128, -2}, {-60.3, -2}}, color = {0, 0, 0}, thickness = 1));
  annotation(
    Diagram(graphics, coordinateSystem(preserveAspectRatio = false, extent = {{-200, -200}, {200, 200}}, initialScale = 0.1)),
...
This model is documented in Sect. 8.1.5 of the ThermoSysPro book.  
