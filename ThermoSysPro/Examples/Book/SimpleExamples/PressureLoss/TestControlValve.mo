...
model TestControlValve
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve ControlValve(mode_caract = 1, caract = [0, 0; 0.5, 3000; 0.75, 7000; 1, 8000]) annotation(
...
equation
  connect(ControlValve.C2, PuitsP1.C) annotation(
    Line(points = {{10, 0}, {44, 0}}, color = {0, 0, 255}));
  connect(Constante1.y, ControlValve.Ouv) annotation(
    Line(points = {{-9, 40}, {0, 40}, {0, 17}}, color = {0, 0, 255}));
  connect(SourceP1.C, ControlValve.C1) annotation(
    Line(points = {{-44, 0}, {-44, 0}, {-10, 0}}, color = {0, 0, 255}));
  annotation(
...
This model is documented in Sect. 13.8.5 of the ThermoSysPro book.  
