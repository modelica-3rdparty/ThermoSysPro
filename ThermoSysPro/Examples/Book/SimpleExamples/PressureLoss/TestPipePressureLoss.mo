...
model TestPipePressureLoss
  ThermoSysPro.WaterSteam.BoundaryConditions.SourceP SourceP1 annotation(
    Placement(transformation(extent = {{-85, -10}, {-65, 10}}, rotation = 0)));
  ...
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss pipePressureLoss annotation(
    Placement(transformation(extent = {{-40, -53}, {38, 53}}, rotation = 0)));
equation
  connect(pipePressureLoss.C2, PuitsP1.C) annotation(
    Line(points = {{38, 0}, {49, 0}, {64, 0}}, color = {0, 0, 255}));
  connect(SourceP1.C, pipePressureLoss.C1) annotation(
    Line(points = {{-65, 0}, {-65, 0}, {-40, 0}}, color = {0, 0, 255}));
  annotation(
...
This model is documented in Sect. 13.4.4 of the ThermoSysPro book.  
