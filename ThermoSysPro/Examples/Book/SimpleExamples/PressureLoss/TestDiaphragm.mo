...
model TestDiaphragm
  ...
  ThermoSysPro.WaterSteam.PressureLosses.Diaphragm Diaphragm annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(Diaphragm.C2, PuitsP1.C) annotation(
    Line(points = {{10, 0}, {44, 0}}, color = {0, 0, 255}));
  connect(SourceP1.C, Diaphragm.C1) annotation(
    Line(points = {{-44, 0}, {-10, 0}}, color = {0, 0, 255}));
  annotation(
...
This model is documented in Sect. 13.7.5 of the ThermoSysPro book.  
