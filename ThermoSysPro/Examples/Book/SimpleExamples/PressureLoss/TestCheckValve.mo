...
equation
  connect(sourceP1.C, checkValve3.C1) annotation(
    Line(points = {{-20, 0}, {-1, 0}}, color = {0, 0, 255}));
  connect(checkValve3.C2, puitsP1.C) annotation(
    Line(points = {{21, 0}, {40, 0}}, color = {0, 0, 255}));
  connect(pulse.y, sourceP1.IPressure) annotation(
    Line(points = {{-59, 0}, {-35, 0}}));
  annotation(
...
This model is documented in Sect. 13.11.4 of the ThermoSysPro book.  
