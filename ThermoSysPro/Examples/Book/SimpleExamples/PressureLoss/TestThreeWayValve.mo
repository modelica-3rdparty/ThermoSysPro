...
model TestThreeWayValve
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ThreeWayValve threeWayValve(C2(Q(start = -7.902947109890763E-33)), C3(Q(start = 2716.4138702433384)), Valve1(Pm(start = 200000.0)), VolumeA1(h(start = 71016.12237181117))) annotation(
...
equation
  connect(SourceP1.C, threeWayValve.C1) annotation(
    Line(points = {{-70, 0}, {-10, 0}}, color = {0, 0, 255}));
  connect(threeWayValve.C2, PuitsP1.C) annotation(
    Line(points = {{10, 0}, {70, 0}}, color = {255, 0, 0}));
  connect(threeWayValve.C3, PuitsP2.C) annotation(
    Line(points = {{0, -6}, {0, -40}, {70, -40}}, color = {255, 0, 0}));
  connect(rampe.y, threeWayValve.Ouv) annotation(
    Line(points = {{-29, 40}, {0, 40}, {0, 15}}));
  annotation(
...
This model is documented in Sect. 13.9.2 of the ThermoSysPro book.  
