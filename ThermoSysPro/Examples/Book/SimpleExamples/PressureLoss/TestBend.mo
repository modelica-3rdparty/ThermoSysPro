...
model TestBend
  ...
  ThermoSysPro.WaterSteam.PressureLosses.Bend Bend annotation(
    Placement(transformation(extent = {{-8, -6}, {12, 14}}, rotation = 0)));
equation
  connect(Bend.C2, SinkP1.C) annotation(
    Line(points = {{2, -6}, {2, -24}, {41, -24}}, color = {0, 0, 255}));
  connect(SourceP1.C, Bend.C1) annotation(
    Line(points = {{-42, 4}, {-8, 4}}, color = {0, 0, 255}));
  annotation(
...
This model is documented in Sect. 13.6.5 of the ThermoSysPro book.  
