...
equation
  ...
  connect(dynamicTwoPhaseFlowPipe.C2, sinkP.C) annotation(
    Line(points = {{36, -43.5}, {47, -43.5}, {47, -44}, {48, -44}}, color = {0, 0, 255}));
  connect(champThermosolaireLFR_N.SunDNI, DNI.y) annotation(
    Line(points = {{44, 45.6}, {51, 45.6}, {51, 46}, {57.3, 46}}));
  connect(champThermosolaireLFR_N.SunG, Angles.y) annotation(
    Line(points = {{27.2, 58.8}, {27.2, 65.5}, {4.7, 65.5}}));
  connect(champThermosolaireLFR_N.SunA, Angles.y) annotation(
    Line(points = {{36.8, 58.8}, {36.8, 70}, {6, 70}, {6, 65.5}, {4.7, 65.5}}));
  connect(Q.y, sourceP.IMassFlow) annotation(
    Line(points = {{-50.3, -25.5}, {-50, -25.5}, {-50, -38}, {-59, -38}}));
  connect(sourceP.C, dynamicTwoPhaseFlowPipe.C1) annotation(
    Line(points = {{-49, -43}, {-47.5, -43}, {-47.5, -43.5}, {-36, -43.5}}, color = {0, 0, 255}));
  annotation(
    Diagram(graphics),
