...
model TestCombustionTurbine
  ...
  FlueGases.Machines.CombustionTurbine CombustionTurbine(tau_n = 0.065, is_eff_n = is_eff_n1, Qred = Qred1, Pe(fixed = true, start = 1500000), Ts(fixed = true, start = 830)) annotation(
    Placement(transformation(extent = {{-42, -42}, {36, 42}}, rotation = 0)));
  FlueGases.BoundaryConditions.SourceQ SourceQ1(Xso2 = 0, Q0 = 430, Xco2 = 0.06, Xh2o = 0.06, Xo2 = 0.14, T0 = 1500) annotation(
    Placement(transformation(extent = {{-106, -10}, {-86, 10}}, rotation = 0)));
  FlueGases.BoundaryConditions.SinkP SinkP1(P0 = 1e5) annotation(
    Placement(transformation(origin = {94, 0}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  InstrumentationAndControl.Blocks.Sources.Constante Wc1(k = -1.8e8) annotation(
    Placement(transformation(extent = {{-100, -42}, {-80, -22}}, rotation = 0)));
equation
  connect(SourceQ1.C, CombustionTurbine.Ce) annotation(
    Line(points = {{-86, 0}, {-42, 0}}, color = {0, 0, 0}, thickness = 1));
  connect(CombustionTurbine.Cs, SinkP1.C) annotation(
    Line(points = {{36, 0}, {84.2, 0}}, color = {0, 0, 0}, thickness = 1));
  connect(Wc1.y, CombustionTurbine.CompressorPower) annotation(
    Line(points = {{-79, -32}, {-45.9, -32}, {-45.9, -16.8}}));
  annotation(
    Diagram(graphics),
...
This model is documented in Sect. 11.4.5 of the ThermoSysPro book.  
