...
model TestStaticDrum3
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.SinkQ sinkQ(Q0 = 10) annotation(
    Placement(transformation(extent = {{74, 7}, {94, 27}}, rotation = 0)));
  ThermoSysPro.WaterSteam.BoundaryConditions.SourcePQ sourcePQ(Q0 = 100, h0 = 1400e3, P0 = 10000000) annotation(
  ...
  WaterSteam.HeatExchangers.DynamicTwoPhaseFlowPipe dynamicTwoPhaseFlowPipe(z1 = 0, rugosrel = 0.0001, D = 0.05, ntubes = 10, L = 10, z2 = 10) annotation(
    Placement(transformation(origin = {-28.5, -45.5}, extent = {{13.5, 11.5}, {-13.5, -11.5}}, rotation = 270)));
  WaterSteam.PressureLosses.LumpedStraightPipe lumpedStraightPipe(lambda(fixed = false) = 0.03, D = 0.05, ntubes = 10, L = 10, z1 = 10, Q(fixed = true, start = 30)) annotation(
    Placement(transformation(origin = {20, -45}, extent = {{-14, -12}, {14, 12}}, rotation = 270)));
  WaterSteam.Volumes.VolumeA volumeA annotation(
    Placement(transformation(extent = {{1, -72}, {-9, -62}}, rotation = 0)));
  Thermal.BoundaryConditions.HeatSource heatSource1(option_temperature = 2, W0 = {2e6, 2e6, 2e6, 2e6, 2e6, 2e6, 2e6, 2e6, 2e6, 2e6}, T0 = {300, 300, 300, 300, 300, 300, 300, 300, 300, 300}) annotation(
