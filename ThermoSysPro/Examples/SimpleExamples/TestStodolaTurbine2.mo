...
model TestStodolaTurbine2
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.SinkP puitsP(mode = 0, P0 = 5000) annotation(
    Placement(transformation(extent = {{-20, 60}, {0, 80}}, rotation = 0)));
  ThermoSysPro.WaterSteam.BoundaryConditions.SourceP sourceP(h0 = 3.e6, option_temperature = 2, mode = 2, P0 = 3e5) annotation(
