...
model TestFan
  ...
  ThermoSysPro.FlueGases.Machines.StaticFan staticFan(VRotn = 2700, rm = 1, a2 = 0, b1 = -1.315, b2 = 2.4593, VRot = 2700, a1 = -263.145, a3 = 500, Q(start = 2), Qv(start = 1.4), rho(start = 1.4), p_rho = 1.5) annotation(
  ...
  ThermoSysPro.FlueGases.Machines.StaticFan staticFan1(VRotn = 2700, rm = 1, b2 = 2.4593, b1 = -1.315, VRot = 2700, a1 = -263.145, a2 = 0, a3 = 500, Q(start = 2), Qv(start = 1.4), rho(start = 1.4), p_rho = 1.5) annotation(
  ...
  ThermoSysPro.FlueGases.Volumes.VolumeDTh volume2S(dynamic_mass_balance = false, dynamic_composition_balance = false) annotation(
