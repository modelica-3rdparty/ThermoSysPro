...
model TestDynamicTwoPhaseFlowPipe
  ...
  ThermoSysPro.Thermal.BoundaryConditions.HeatSource heatSource(T0 = {1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900}, option_temperature = 2, W0 = {7e6, 7e6, 7e6, 7e6, 7e6, 7e6, 7e6, 7e6, 7e6, 7e6}) annotation(
  ...
  WaterSteam.BoundaryConditions.SinkP sinkP1(option_temperature = 2, h0 = 2000e3, mode = 0, P0 = 19.9e5) annotation(
    Placement(transformation(extent = {{70, -74}, {90, -54}}, rotation = 0)));
  Thermal.BoundaryConditions.HeatSource heatSource1(option_temperature = 2, T0 = {1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900}, W0 = {2e4, 2e4, 2e4, 2e4, 2e4, 2e4, 2e4, 2e4, 2e4, 2e4}) annotation(
    Placement(transformation(extent = {{-10, -15}, {10, 5}}, rotation = 0)));
  Thermal.HeatTransfer.HeatExchangerWall heatExchangerWall1(Ns = 10, L = 10, lambda = 10, cpw = 460, rhow = 7900, e = 0.005, D = 0.03) annotation(
    Placement(transformation(extent = {{-40, -74}, {40, 6}}, rotation = 0)));
  InstrumentationAndControl.Blocks.Sources.Rampe rampe(Initialvalue = 20e5, Starttime = 300, Duration = 600, Finalvalue = 19.8e5) annotation(
    Placement(transformation(extent = {{-74, -50}, {-86, -39}}, rotation = 0)));
equation
  connect(sourceP.C, dynamicTwoPhaseFlowPipe.C1) annotation(
    Line(points = {{-30, 30}, {-10, 30}}, color = {0, 0, 255}));
