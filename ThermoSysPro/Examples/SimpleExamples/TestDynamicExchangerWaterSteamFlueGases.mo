...
model TestDynamicExchangerWaterSteamFlueGases
  ...
  WaterSteam.BoundaryConditions.SourceP Source_WSteam(option_temperature = 2, mode = 0, h0 = 1.46e6, C(Q(fixed = true, start = 150)), P0(fixed = false) = 13000000, T0 = 610) annotation(
