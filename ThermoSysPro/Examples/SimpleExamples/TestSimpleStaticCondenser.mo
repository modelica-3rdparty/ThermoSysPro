...
model TestSimpleStaticCondenser
  ThermoSysPro.WaterSteam.HeatExchangers.SimpleStaticCondenser simpleStaticCondenser(Ec(h(start = 532983.7176868258)), Ef(h(start = 71016.12237181116)), Qc(start = 1049.6385508765125), Qf(start = 4469.84281279143), Sf(h(start = 64330.208038325145))) annotation(
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.SourceP sourceP1(T0 = 400) annotation(
...
equation
  connect(sourceP.C, simpleStaticCondenser.Ef) annotation(
    Line(points = {{-40, 30}, {-20, 30}}, color = {0, 0, 255}));
  connect(sourceP1.C, simpleStaticCondenser.Ec) annotation(
    Line(points = {{-40, -10}, {-16, -10}, {-16, 20}}, color = {0, 0, 255}));
  connect(simpleStaticCondenser.Sf, sinkP.C) annotation(
    Line(points = {{0, 29.9}, {10, 29.9}, {10, 30}, {20, 30}}, color = {0, 0, 255}));
  connect(simpleStaticCondenser.Sc, sinkP1.C) annotation(
    Line(points = {{-4, 20}, {-4, -10}, {20, -10}}, color = {0, 0, 255}));
  annotation(
