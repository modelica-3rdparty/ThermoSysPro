...
model TestFlueGasesVolumes1
  ...
  ThermoSysPro.FlueGases.BoundaryConditions.SinkP sinkFlueGasesP(T(start = 400.00000000000006), Xco2(start = 0.1), Xo2(start = 0.22), Xso2(start = 1.8148213653042705E-33)) annotation(
...
equation
  ...
  connect(singularPressureLossFlueGases1.C2, volumeFlueGasesATh.Ce1) annotation(
  ...
  connect(singularPressureLossFlueGases4.C2, sinkFlueGasesP1.C) annotation(
    Line(points = {{40, -90}, {60.2, -90}}, color = {0, 0, 0}, thickness = 1));
  connect(volumeFlueGasesATh.Cs1, singularPressureLossFlueGases2.C1) annotation(
    Line(points = {{0, -50}, {20, -50}}, color = {0, 0, 0}, thickness = 1));
  connect(volumeFlueGasesATh.Cs2, singularPressureLossFlueGases4.C1) annotation(
    Line(points = {{-10, -60}, {-10, -90}, {20, -90}}, color = {0, 0, 0}, thickness = 1));
  connect(volumeFlueGasesCTh.Cs, singularPressureLossFlueGases3.C1) annotation(
    Line(points = {{-10, 20}, {-10, 0}}, color = {0, 0, 0}, thickness = 1));
  connect(singularPressureLossFlueGases3.C2, volumeFlueGasesATh.Ce2) annotation(
    Line(points = {{-10, -20}, {-10, -40}}, color = {0, 0, 0}, thickness = 1));
  connect(sourceFlueGasesP1.C, singularPressureLossFlueGases5.C1) annotation(
    Line(points = {{-80, 30}, {-60, 30}}, color = {0, 0, 0}, thickness = 1));
  connect(singularPressureLossFlueGases5.C2, volumeFlueGasesCTh.Ce3) annotation(
    Line(points = {{-40, 30}, {-20, 30}}, color = {0, 0, 0}, thickness = 1));
  connect(sourceFlueGasesP2.C, singularPressureLossFlueGases6.C1) annotation(
    Line(points = {{-80, 70}, {-60, 70}}, color = {0, 0, 0}, thickness = 1));
  connect(singularPressureLossFlueGases6.C2, volumeFlueGasesCTh.Ce1) annotation(
    Line(points = {{-40, 70}, {-10, 70}, {-10, 40}}, color = {0, 0, 0}, thickness = 1));
  annotation(
