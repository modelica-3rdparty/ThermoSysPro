...
model TestDynamicCentrifugalPump1
  ThermoSysPro.WaterSteam.Machines.DynamicCentrifugalPump DynamicCentrifugalPump1(C2(P(start = 3.e5)), Ch(start = 300)) annotation(
    Placement(transformation(extent = {{0, -40}, {-20, -20}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Volumes.Tank Tank(ze2 = 10, zs2 = 10, steady_state = false) annotation(
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Pulse pulse(width = 200, period = 500, amplitude = 150000) annotation(
...
equation
  connect(DynamicCentrifugalPump1.C2, Tank.Ce2) annotation(
    Line(points = {{-20, -30.2}, {-60, -30.2}, {-60, 24}, {-20, 24}}, color = {0, 0, 255}));
  connect(Tank.Cs2, Valve.C1) annotation(
    Line(points = {{0, 24}, {40, 24}}, color = {0, 0, 255}));
  connect(Valve.C2, DynamicCentrifugalPump1.C1) annotation(
  ...
  connect(pulse.y, sourceTorque.IPower) annotation(
    Line(points = {{-79, -70}, {-65, -70}}));
  connect(Shaft1.C2, DynamicCentrifugalPump1.M) annotation(
    Line(points = {{-19, -70}, {-10, -70}, {-10, -41}}));
  connect(sourceTorque.M, Shaft1.C1) annotation(
    Line(points = {{-49, -70}, {-41, -70}}));
  annotation(
