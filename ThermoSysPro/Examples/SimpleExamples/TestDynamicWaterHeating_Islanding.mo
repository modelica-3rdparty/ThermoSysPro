...
model TestDynamicWaterHeating_Islanding
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve ControlValve_eau(Q(fixed = false, start = 56), Cvmax(fixed = false) = 354.534, mode_caract = 0, Cv(start = 70, fixed = false), C1(h_vol(start = 800e3), h(start = 800e3))) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.SingularPressureLoss singularPressureLossWaterIn(Q(fixed = false, start = 650), K = 35) annotation(
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.RefQ refQ(Q0 = 53) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.SingularPressureLoss singularPressureLossPurge(Q(fixed = false, start = 56), K = 1e-3, T(fixed = true, start = 461.56), Pm(start = 2220000)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.LumpedStraightPipe PressureLoss_Steam(Q(fixed = false, start = 650), lambda(fixed = false) = 0.03, L = 48.72, D = 0.387) annotation(
