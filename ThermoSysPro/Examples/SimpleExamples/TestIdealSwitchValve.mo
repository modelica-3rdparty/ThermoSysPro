...
model TestIdealSwitchValve
  ...
  ThermoSysPro.WaterSteam.PressureLosses.IdealSwitchValve SwitchValve annotation(
...
equation
  ...
  connect(perteDP2.C2, SwitchValve.C1) annotation(
    Line(points = {{-40, 30}, {-30, 30}, {-30, 29.8}, {-20, 29.8}}, color = {0, 0, 255}));
