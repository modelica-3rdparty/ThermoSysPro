...
equation
  ...
  connect(Source_Fumees.C, volume2S.Ce) annotation(
    Line(points = {{-164, 0}, {-149, 0}}, color = {0, 0, 0}, thickness = 1));
  connect(volume2S.Cs1, singularPressureLossFlueGases1.C1) annotation(
    Line(points = {{-139, 10}, {-140, 10}, {-140, 60}, {-108, 60}}, color = {0, 0, 0}, thickness = 1));
  connect(volume2S.Cs2, singularPressureLossFlueGases4.C1) annotation(
    Line(points = {{-139, -10}, {-140, -10}, {-140, -58}, {-140, -60}, {-108, -60}}, color = {0, 0, 0}, thickness = 1));
