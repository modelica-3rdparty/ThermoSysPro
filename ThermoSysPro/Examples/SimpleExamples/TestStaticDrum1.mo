...
model TestStaticDrum1
  ...
  ThermoSysPro.WaterSteam.BoundaryConditions.RefP refP(P0 = 3e5) annotation(
...
equation
  ...
  connect(sensorT.C2, singularPressureLossVALI2.C1) annotation(
    Line(points = {{30.2, -80}, {40, -80}, {40, -60}, {-80, -60}, {-80, -40}}, color = {0, 0, 255}));
  ...
  connect(refP.C2, sensorT.C1) annotation(
    Line(points = {{-6, -80}, {10, -80}}, color = {0, 0, 255}));
