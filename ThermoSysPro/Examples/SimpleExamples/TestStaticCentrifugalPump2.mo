...
model TestStaticCentrifugalPump2
  ThermoSysPro.WaterSteam.Machines.StaticCentrifugalPump StaticCentrifugalPump1(fixed_rot_or_power = 2) annotation(
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Pulse pulse(width = 200, period = 500, amplitude = 0.5e5, startTime = 0, offset = 1000) annotation(
...
equation
  ...
  connect(pulse.y, StaticCentrifugalPump1.rpm_or_mpower) annotation(
    Line(points = {{-59, -60}, {-10, -60}, {-10, -41}}, smooth = Smooth.None));
  annotation(
