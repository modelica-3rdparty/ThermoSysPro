...
model CombinedCycle_TripTAC "CCPP model to simulate a load variation from 100% to 50%"
  ...
  ThermoSysPro.WaterSteam.Volumes.DynamicDrum BallonHP(L = 16.27, Vertical = false, hl(fixed = false, start = 1460508.128907675), hv(fixed = false, start = 2664791.3052738607), Vv(fixed = false), R = 1.05, xmv(fixed = false), zl(start = 1.05, fixed = true), Mp = 5000, Kpa = 5, Kvl = 1000, P(fixed = false, start = 12726424.235625941), Pfond(start = 12733333.038455429), Tp(start = 589.5151351323206)) annotation(
    Placement(transformation(extent = {{5, 10}, {-35, 50}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_alimentationHP(Cvmax = CvmaxValveAHP, C1(P(start = 13394232.807871036), h_vol(start = 1399087.0448386343)), h(start = 1398000), Cv(start = 178), Pm(start = 13050700)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_vapeurHP(Cvmax = 47829.4, mode = 0, C2(h_vol(start = 2664791.3052738607)), h(start = 2674000), Cv(start = 23914.7), Pm(start = 12724920.902023433)) annotation(
    Placement(transformation(extent = {{-55, 46}, {-75, 66}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss GainChargeHP(z2 = 0, mode = 1, Q(start = 150, fixed = true), z1 = 10.83, K = KgainChargeHP, C2(P(start = 12757776.366696326)), h(start = 1474422.14552527), Pm(start = 12704000)) annotation(
    Placement(transformation(origin = {-5, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeEvapHP(mode = 1, V = 5, h(start = 1460508.128907675), P(start = 12704000)) annotation(
  ...
  ThermoSysPro.WaterSteam.Volumes.DynamicDrum BallonMP(L = 16.27, Vertical = false, P0 = 27.29e5, hl(fixed = false, start = 980960.1562978515), hv(fixed = false, start = 2798761.3254371085), Vv(fixed = false), R = 1.05, P(fixed = false, start = 2733918.2848144253), zl(start = 1.05, fixed = true), Kpa = 5, Mp = 5000, Kvl = 1000, Pfond(start = 2742462.980913138), Tp(start = 497.4249792990277)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_alimentationMP(Cvmax = CvmaxValveAMP, C1(P(start = 3253417.522956237), h_vol(start = 947830.5281155076)), h(start = 944000), Cv(start = 28), Pm(start = 2975000)) annotation(
    Placement(transformation(extent = {{365, 46}, {345, 66}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_vapeurMP(Cvmax = 47829.4, mode = 0, C2(h_vol(start = 2798761.3254371085)), h(fixed = false, start = 2798000), Cv(start = 23914.7), Pm(fixed = false, start = 2732653.9482791456)) annotation(
  ...
  ThermoSysPro.WaterSteam.Volumes.VolumeB MelangeurHPMP(Ce1(h(start = 3046003.380872726)), h(start = 3040245.422545259), P(start = 2726000)) annotation(
  ...
  ThermoSysPro.WaterSteam.Volumes.DynamicDrum BallonBP(Vertical = false, P0 = 5e5, Vv(fixed = false), L = 8, hl(fixed = false, start = 561432.6820300646), hv(fixed = false, start = 2682927.2097681486), R = 2, P(fixed = false, start = 536006.6647383622), zl(start = 1.75, fixed = true), Kpa = 5, Mp = 5000, Kvl = 1000, Pfond(start = 552000.8087452435), Tp(start = 409.09918124890646)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_vapeurBP(p_rho = 3, Cvmax = CvmaxValveVBP, C2(P(start = 509651.8053666252), h_vol(start = 2682927.2097681486)), h(start = 2685000), Cv(start = 1), Pm(start = 498000)) annotation(
    Placement(transformation(extent = {{525, 46}, {505, 66}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_alimentationBP(Cvmax = 285, C1(h_vol(start = 517521.1338868904)), h(fixed = false, start = 509000), Cv(start = 142.5), Pm(fixed = false, start = 1001940.4305634197)) annotation(
    Placement(transformation(extent = {{617, 44}, {597, 64}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss GainChargeBP(z2 = 0, z1 = 10.767, Q(start = 50, fixed = false), K = 32766, mode = 1, pro(d(start = 931.9744461081724)), Pm(start = 564000), h(start = 549249.519022482)) annotation(
    Placement(transformation(origin = {577, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeEvapBP(h(start = 561432.682030064), mode = 1, V = 5, P(start = 564000)) annotation(
  ...
  ThermoSysPro.WaterSteam.Machines.StodolaTurbine TurbineHP(W_fric = 1, eta_stato = 1, eta_is(start = 0.88057), Qmax = 140, eta_is_nom = 0.88057, eta_is_min = 0.75, Cst(start = 8182844.56002535) = CstHP, pros(d(start = 10.66670150764929)), Hrs(start = 3046003.380872726), Pe(fixed = true, start = 12431000), Ps(fixed = false, start = 2726700)) annotation(
    Placement(transformation(extent = {{-35, -250}, {5, -210}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Machines.StodolaTurbine TurbineMP(W_fric = 1, eta_stato = 1, eta_is(start = 0.9625), Qmax = 150, eta_is_nom = 0.9625, eta_is_min = 0.75, Cst(start = 256335.364995961) = CstMP, pros(d(start = 1.883484197675123)), Hrs(start = 3029367.6706168973), Pe(fixed = true, start = 2548500), Ps(fixed = false, start = 476800)) annotation(
    Placement(transformation(extent = {{285, -250}, {325, -210}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC MelangeurPostTMP1(h(start = 3018320.043117248), P(start = 476799.99999954), Ce1(h(start = 3029780))) annotation(
    Placement(transformation(origin = {385, -230}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.Machines.StodolaTurbine TurbineBP(W_fric = 1, eta_stato = 1, eta_is(start = 0.9538), Qmax = 150, eta_is_nom = 0.9538, eta_is_min = 0.75, Cst(start = 11944.9445735985) = CstBP, Cs(h(start = 2401478.8015108025)), Hrs(start = 2401030), Pe(fixed = true, start = 476799.99999954), Ps(start = 10053)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK1(K = 1e-4, h(start = 2400000), C1(h_vol(start = 2400000), h(start = 2400000)), Pm(start = 10026.138683139128)) annotation(
    Placement(transformation(extent = {{607, -240}, {627, -220}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeCond1(mode = 1, Ce3(h(start = 194669.37425631672)), h(start = 194669.37425632242), P(start = 1540500)) annotation(
    Placement(transformation(origin = {869, -318}, extent = {{10, -10}, {-10, 10}}, rotation = 270)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeKCond1(K = 1e-4, mode = 1, pro(d(start = 990.3699122081223)), Pm(start = 1540000)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK(K = 1e-4, mode = 1, C1(h_vol(start = 191812.29519356362)), C2(h_vol(start = 191812.29519356362)), pro(d(start = 989.8383588386666)), Pm(start = 6200)) annotation(
    Placement(transformation(extent = {{669, -446}, {689, -426}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Machines.StaticCentrifugalPump PompeAlimBP(Qv(start = 0.19861699733512259), mode = 1, a3 = 400, a1(fixed = true) = -6000, Q(start = 194.502, fixed = false), C2(h_vol(start = 194669.37425631672)), Pm(start = 802830.7060548771)) annotation(
    Placement(transformation(extent = {{709, -446}, {729, -426}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK2(K = 1e-4, mode = 1, pro(d(start = 990.3699122094005)), C1(h_vol(start = 194669.37425631672), h(start = 194585)), Pm(start = 1546000)) annotation(
    Placement(transformation(extent = {{807, -446}, {827, -426}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_extraction(mode = 1, Cvmax = 2000, h(start = 194500), Cv(start = 2000), Pm(start = 1587120.4167526974)) annotation(
  ...
  Control.Drum_LevelControl regulation_Niveau_BP(add(k1 = -1, k2 = +1), pIsat(Ti = 500, Limiteur1(u(signal(start = 0.8)))), Ti = 10, minval = 0.006) annotation(
  ...
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeECO_HP1_2(mode = 1, V = 1, h0 = 988332, h(start = 860655.3510813401), dynamic_mass_balance = true, P0 = 7010000, P(start = 13149153.870557636)) annotation(
  ...
  ThermoSysPro.WaterSteam.Volumes.VolumeD VolumePreTHP(h0 = 3e6, h(start = 3432930.9918569606), dynamic_mass_balance = true, P0 = 12700000, P(start = 12700000)) annotation(
    Placement(transformation(origin = {-85, -230}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC MelangeurPreTMP(h0 = 3523910, h(start = 3517381.1285518324), dynamic_mass_balance = true, P0 = 2400000, P(start = 2400000)) annotation(
  ...
  FlueGases.BoundaryConditions.SourceQ SourceFumees(Xco2 = 0.0613, Xso2 = 0, Xh2o = 0.0706, T0 = 893.75, Xo2 = 0.1380, Q0 = 606.94) annotation(
...
equation
  ...
  connect(EvaporateurHP.Cfg2, EconomiseurHP4.Cfg1) annotation(
    Line(points = {{-37, -50}, {63, -50}}, color = {0, 0, 0}, thickness = 1));
  connect(EconomiseurHP4.Cfg2, SurchauffeurMP1.Cfg1) annotation(
    Line(points = {{43, -50}, {103, -50}}, color = {0, 0, 0}, thickness = 1));
  ...
  connect(EconomiseurBP.Cfg2, PuitsFumees.C) annotation(
    Line(points = {{657, -50}, {679.2, -50}}, color = {0, 0, 0}, thickness = 1));
  ...
  connect(MelangeurPostTMP1.Ce2, PerteChargeZero2.C2) annotation(
    Line(points = {{385, -239}, {385, -278}, {321, -278}}, color = {255, 0, 0}));
  ...
  connect(lumpedStraightPipeK2.C1, MelangeurHPMP.Cs2) annotation(
    Line(points = {{81, -110}, {105.2, -110}}, color = {255, 0, 0}));
  ...
  connect(Temperature.y, SourceFumees.ITemperature) annotation(
    Line(points = {{-453.5, -120}, {-422, -120}, {-422, -70}}));
  connect(Debit.y, SourceFumees.IMassFlow) annotation(
    Line(points = {{-453.5, 18}, {-422, 18}, {-422, -28}}));
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-560, -460}, {950, 150}}, initialScale = 0.1), graphics),
