...
model CombinedCycle_Load_100_50 "CCPP model to simulate a load variation from 100% to 50%"
  parameter Real CstHP(fixed = false, start = 7872243.329137064) "Stodola's ellipse coefficient HP";
  parameter Real CstMP(fixed = false, start = 250346.99234192327) "Stodola's ellipse coefficient MP";
  parameter Real CstBP(fixed = false, start = 10510.769959447052) "Stodola's ellipse coefficient BP";
  ...
  ThermoSysPro.WaterSteam.Volumes.DynamicDrum BallonHP(L = 16.27, Vertical = false, hl(fixed = false, start = 1459929.6557225615), hv(fixed = false, start = 2664756.9335524077), Vv(fixed = false), R = 1.05, xmv(fixed = false), P(fixed = false, start = 12726786.684064418), zl(start = 1.05, fixed = true), Mp = 5000, Kpa = 5, Kvl = 1000, Pfond(start = 12733698.15963666), Tp(start = 589.4448369021196)) annotation(
    Placement(transformation(extent = {{38, 10}, {-2, 50}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_alimentationHP(Cvmax = CvmaxValveAHP, C1(P(start = 13374652.64958711), h_vol(start = 1398250.7267619045)), h(start = 1398000), Cv(start = 178), Pm(start = 13050700)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_vapeurBP(p_rho = 3, Cvmax = CvmaxValveVBP, C2(P(start = 510622.8582477031), h_vol(start = 2684673.580149807)), h(start = 2685000), Cv(start = 1), Pm(start = 498000)) annotation(
    Placement(transformation(extent = {{558, 46}, {538, 66}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_alimentationBP(Cvmax = 285, C1(h_vol(start = 509236.1596958067)), h(fixed = false, start = 509000), Cv(start = 142.5), Pm(fixed = false, start = 957583.6711025466)) annotation(
    Placement(transformation(extent = {{650, 44}, {630, 64}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss GainChargeBP(z2 = 0, z1 = 10.767, Q(start = 50, fixed = false), K = 32766, mode = 1, pro(d(start = 934.2358753989836)), Pm(start = 564000), h(start = 549249.519022482)) annotation(
    Placement(transformation(origin = {610, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeEvapBP(h(start = 550072.7232069891), mode = 1, V = 5, P(start = 564000)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve Vanne_alimentationMPHP(mode = 1, Cvmax = 308.931, C1(h_vol(start = 550072.7232069891)), h(start = 550000), Cv(start = 308.931), Pm(start = 404001.70325999695)) annotation(
  ...
  ThermoSysPro.WaterSteam.Machines.StodolaTurbine TurbineHP(W_fric = 1, eta_stato = 1, eta_is(start = 0.88057), Qmax = 140, eta_is_nom = 0.88057, eta_is_min = 0.75, Cst(start = 8182844.56002535) = CstHP, pros(d(start = 10.66426189633104)), Hrs(start = 3046256.0341363903), Pe(fixed = true, start = 12431000), Ps(fixed = false, start = 2726700)) annotation(
    Placement(transformation(extent = {{-2, -250}, {38, -210}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Machines.StodolaTurbine TurbineMP(W_fric = 1, eta_stato = 1, eta_is(start = 0.9625), Qmax = 150, eta_is_nom = 0.9625, eta_is_min = 0.75, Cst(start = 256335.364995961) = CstMP, pros(d(start = 1.8827680646065352)), Hrs(start = 3029781.976396904), Pe(fixed = true, start = 2548500), Ps(fixed = false, start = 476800)) annotation(
    Placement(transformation(extent = {{318, -250}, {358, -210}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC MelangeurPostTMP1(h(start = 3017480.4191624634), P(start = 476799.99999954), Ce1(h(start = 3029780))) annotation(
    Placement(transformation(origin = {418, -230}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.Machines.StodolaTurbine TurbineBP(W_fric = 1, eta_stato = 1, eta_is(start = 0.9538), Qmax = 150, eta_is_nom = 0.9538, eta_is_min = 0.75, Cst(start = 11944.9445735985) = CstBP, Cs(h(start = 2401033.111118852)), Hrs(start = 2401030), Pe(fixed = true, start = 476799.99999954), Ps(start = 10053)) annotation(
  ...
  ThermoSysPro.WaterSteam.HeatExchangers.SimpleDynamicCondenser Condenseur(D = 0.018, V = 1000, A = 100, lambda = 0.01, ntubes = 28700, continuous_flow_reversal = true, Vf0 = 0.15, steady_state = false, yNiveau(signal(start = 1.5)), Cse(h(start = 128076)), P(fixed = false, start = 6136), Pfond(start = 10000.0), Cl(h(start = 191812.29519356362)), proe(d(start = 996.0186965963143))) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK1(K = 1e-4, h(start = 2400000), C1(h_vol(start = 2400000), h(start = 2400000)), Pm(start = 10026.561030835077)) annotation(
    Placement(transformation(extent = {{640, -240}, {660, -220}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeCond1(mode = 1, Ce3(h(start = 194584.50261452305)), h(start = 194584.50261459063), P(start = 1540500)) annotation(
    Placement(transformation(origin = {902, -318}, extent = {{10, -10}, {-10, 10}}, rotation = 270)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeKCond1(K = 1e-4, mode = 1, pro(d(start = 990.3586687482405)), Pm(start = 1540000)) annotation(
    Placement(transformation(origin = {902, -270}, extent = {{12, -12}, {-12, 12}}, rotation = 270)));
  ThermoSysPro.WaterSteam.Volumes.VolumeA VolumeAlimMPHP(mode = 1, h(start = 550072.7232069891), P(start = 322430)) annotation(
    Placement(transformation(extent = {{742, -20}, {762, 0}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Machines.StaticCentrifugalPump PompeAlimMP(a3 = 350, b1(fixed = true) = -3.7751, a1 = -244551, Q(fixed = false), mode = 1, C1(h_vol(start = 550072.7232069891)), C2(h_vol(start = 565106.2802015315)), Qv(start = 0.01332183238847357), pro(d(start = 933.5252816181976)), Pm(start = 1725850)) annotation(
    Placement(transformation(extent = {{804, -20}, {824, 0}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Machines.StaticCentrifugalPump PompeAlimHP(a3 = 1600, a1 = -28056.2, b1 = -12.7952660447433, Q(fixed = false), mode = 1, C1(h_vol(start = 550072.7232069891)), C2(h_vol(start = 618649.6677733721)), Qv(start = 0.08171817156952406), pro(d(start = 931.4140647908531)), Pm(start = 6774000)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK3(K = 1e-4, mode = 1, Pm(start = 322424.2818830876)) annotation(
    Placement(transformation(origin = {780, -50}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK8(K = 1e-4, mode = 1, Pm(start = 322424.28218490275)) annotation(
  ...
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK(K = 1e-4, mode = 1, C1(h_vol(start = 191812.29519356362)), C2(h_vol(start = 191812.29519356362)), pro(d(start = 989.8383588386498)), Pm(start = 6200)) annotation(
    Placement(transformation(extent = {{702, -446}, {722, -426}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Machines.StaticCentrifugalPump PompeAlimBP(Qv(start = 0.2002405532484127), mode = 1, a3 = 400, a1(fixed = true) = -6000, Q(start = 194.502, fixed = false), C2(h_vol(start = 194584.50261452305)), Pm(start = 783963.3809799375)) annotation(
    Placement(transformation(extent = {{742, -446}, {762, -426}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.PipePressureLoss perteChargeK2(K = 1e-4, mode = 1, pro(d(start = 990.3586687495459)), C1(h_vol(start = 194584.50261452305), h(start = 194585)), Pm(start = 1546000)) annotation(
    Placement(transformation(extent = {{840, -446}, {860, -426}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve vanne_extraction(mode = 1, Cvmax = 2000, h(start = 194500), Cv(start = 2000), Pm(start = 1549245.4644062065)) annotation(
  ...
  Control.Drum_LevelControl regulation_Niveau_BP(add(k1 = -1, k2 = +1), pIsat(Ti = 500, Limiteur1(u(signal(start = 0.8)))), Ti = 10) annotation(
  ...
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeECO_HP1_2(mode = 1, V = 1, h0 = 988332, h(start = 854493.2404741034), dynamic_mass_balance = true, P0 = 7010000, P(start = 13129347.20636851)) annotation(
    Placement(transformation(extent = {{456, -98}, {436, -78}}, rotation = 0)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC VolumeECO_HP2_3(mode = 1, V = 1, h0 = 983786, h(start = 986348.0919441726), dynamic_mass_balance = true, P0 = 7000000, P(start = 13219328.239579093)) annotation(
    Placement(transformation(extent = {{252, -20}, {232, 0}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve Vanne_alimentationMPHP1(mode = 1, Cvmax = 308.931, h(start = 618600), Cv(start = 308.931), Pm(start = 13130272.672059398)) annotation(
    Placement(transformation(extent = {{754, -98}, {730, -122}}, rotation = 0)));
  ThermoSysPro.WaterSteam.PressureLosses.ControlValve Vanne_alimentationMPHP2(mode = 1, Cvmax = 308.931, h(start = 565000), Cv(start = 308.931), Pm(start = 3126744.5275077047)) annotation(
  ...
  ThermoSysPro.WaterSteam.Volumes.VolumeD VolumePreTHP(h0 = 3e6, h(start = 3433271.775819776), dynamic_mass_balance = true, P0 = 12700000, P(start = 12700000)) annotation(
    Placement(transformation(origin = {-52, -230}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.WaterSteam.Volumes.VolumeC MelangeurPreTMP(h0 = 3523910, h(start = 3517975.7051812997), dynamic_mass_balance = true, P0 = 2400000, P(start = 2400000)) annotation(
  ...
  Combustion.BoundaryConditions.FuelSourcePQ sourceCombustible(Hum = 0, Xo = 0, Xn = 0, Xs = 0, rho = 0.838, Q0 = 13.4368286133, T0 = 185 + 273.16, Xc = 0.755, Xh = 0.245, Cp = 2255, LHV = 46989e3) annotation(
  ...
  InstrumentationAndControl.Blocks.Sources.Constante Humidite(k = 0.93) annotation(
    Placement(transformation(extent = {{-539, 23}, {-518, 43}}, rotation = 0)));
  FlueGases.BoundaryConditions.SourcePQ SourceFumees(Xso2 = 0, Xco2 = 0, Xh2o = 0, Xo2 = 0.20994, Q0 = 600, T0 = 29.4 + 273.16, P0 = 1.013e5) annotation(
    Placement(transformation(extent = {{-539, -74}, {-495, -28}}, rotation = 0)));
  FlueGases.TAC.GasTurbine GasTurbine(comp_tau_n = 14.0178, comp_eff_n = 0.87004, exp_tau_n = 0.06458, exp_eff_n = 0.89045, TurbQred = 0.0175634, Kcham = 2.02088, chambreCombustionTAC(Pea(fixed = false, start = 14.0e5), Psf(start = 1333898.05061735), Tsf(start = 1493.5527523474145)), Wpth = 1e6, Compresseur(is_eff(fixed = false, start = 0.88), Xtau(fixed = false, start = 1.00), Ps(start = 1419889.7074729432), Ts(start = 678.0795840911329), Tis(start = 630.7876402069812)), TurbineAgaz(Ps(fixed = false), is_eff(fixed = false, start = 0.87), Pe(fixed = false, start = 1333900), Te(start = 1493.59), Ts(fixed = false, start = 893.16), Tis(start = 814.7448743706253)), xAIR(rho_air(start = 1.099457970518182))) annotation(
...
equation
  ...
  connect(lumpedStraightPipeK2.C1, MelangeurHPMP.Cs2) annotation(
    Line(points = {{114, -110}, {138.2, -110}}, color = {255, 0, 0}));
