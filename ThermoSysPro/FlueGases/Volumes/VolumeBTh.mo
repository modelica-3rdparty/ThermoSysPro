...
model VolumeBTh "Mixing flue gases volume with 2 inlets and 2 outlets and thermal input"
  ...
  parameter Units.SI.Temperature T0 = 400 "Initial fluid temperature (active if steady_state=false)";
  ...
  parameter Units.SI.SpecificEnthalpy hr = 2501569 "Water/steam reference specific enthalpy at 0.01°C";
  ...
  Units.SI.SpecificEnthalpy he1(start = 100000) "Fluid specific enthalpy at inlet #1";
  Units.SI.SpecificEnthalpy he2(start = 100000) "Fluid specific enthalpy at inlet #2";
  Units.SI.SpecificEnthalpy hs1(start = 100000) "Fluid specific enthalpy at outlet #1";
  Units.SI.SpecificEnthalpy hs2(start = 100000) "Fluid specific enthalpy at outlet #2";
  Connectors.FlueGasesInlet Ce1 annotation(
    Placement(transformation(extent = {{-110, -10}, {-90, 10}}, rotation = 0)));
  Connectors.FlueGasesOutlet Cs2 annotation(
    Placement(transformation(extent = {{-10, -110}, {10, -90}}, rotation = 0)));
  Connectors.FlueGasesOutlet Cs1 annotation(
  ...
  Connectors.FlueGasesInlet Ce2 annotation(
...
/* Mass balance equation */
  ...
  if dynamic_mass_balance then
    V*(ThermoSysPro.Properties.FlueGases.FlueGases_drhodp(P, T, Xco2, Xh2o, Xo2, Xso2)*der(P) + ThermoSysPro.Properties.FlueGases.FlueGases_drhodh(P, T, Xco2, Xh2o, Xo2, Xso2)*der(h - Xh2o*hr)) = BQ;
  else
    0 = BQ;
  end if;
  P = Ce1.P;
...
/* Energy balance equation */
  ...
  if dynamic_mass_balance then
    V*(((h - Xh2o*hr)*ThermoSysPro.Properties.FlueGases.FlueGases_drhodp(P, T, Xco2, Xh2o, Xo2, Xso2) - 1)*der(P) + ((h - Xh2o*hr)*ThermoSysPro.Properties.FlueGases.FlueGases_drhodh(P, T, Xco2, Xh2o, Xo2, Xso2) + rho)*der(h - Xh2o*hr)) = BH;
  else
