...
model VolumeCTh "Mixing flue gases volume with 3 inlets and 1 outlet and thermal input"
  ...
  Units.SI.SpecificEnthalpy he3(start = 100000) "Fluid specific enthalpy at inlet #3";
  Units.SI.SpecificEnthalpy hs(start = 100000) "Fluid specific enthalpy at the outlet";
  Connectors.FlueGasesInlet Ce1 annotation(
    Placement(transformation(extent = {{-110, -10}, {-90, 10}}, rotation = 0)));
  Connectors.FlueGasesOutlet Cs annotation(
  ...
  Connectors.FlueGasesInlet Ce3 annotation(
