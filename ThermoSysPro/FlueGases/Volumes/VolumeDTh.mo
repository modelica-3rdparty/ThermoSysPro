...
model VolumeDTh "Mixing flue gases volume with 1 inlets and 3 outlets and thermal input"
  ...
  Units.SI.SpecificEnthalpy hs3(start = 100000) "Fluid specific enthalpy at outlet #3";
  Connectors.FlueGasesInlet Ce annotation(
  ...
  Connectors.FlueGasesOutlet Cs3 annotation(
