...
model FlueGasesChamberEvaporator "Flue gases chamber  for water evaporation"
  ...
  parameter Units.SI.ThermalConductivity condm = 10 "Membrane thermal conductivity";
  parameter Units.SI.ThermalConductivity condb = 10 "Concret thermal conductivity";
  parameter Real emimur = 0.1 "Walls emissitivity";
  parameter Units.SI.CoefficientOfHeatTransfer hi = 10000 "Coolant heat exchange coefficient";
  ...
  Units.SI.Temperature Ts(start = 600) "Average surface temperature on the flue gases side";
  ...
  Units.SI.Angle anglb(start = 1.5) "Angle of the junction between the pipe and the membrane";
  ...
  Units.SI.ThermalConductivity condf(start = 100) "Flue gases thermal conductivity";
  Units.SI.SpecificHeatCapacity cpf(start = 1000) "Flue gases specific heat capacity";
  ...
  Units.SI.CoefficientOfHeatTransfer hc(start = 1) "Convection heat exchange coefficient";
  Units.SI.CoefficientOfHeatTransfer hr(start = 50) "Radiation heat exchange coefficient";
  Units.SI.CoefficientOfHeatTransfer hf(start = 50) "Global heat exchange coefficient";
  ...
  ThermoSysPro.Units.SI.PressureDifference dpd(start = 1000) "Dynamical pressure losses";
  ThermoSysPro.Units.SI.PressureDifference dps(start = 1000) "Static pressure losses";
  ThermoSysPro.Units.SI.PressureDifference Pdf(start = 1000) "Total pressure losses";
  ...
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet C1 annotation(
    Placement(transformation(extent = {{-100, -10}, {-80, 10}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesOutlet C2 annotation(
    Placement(transformation(extent = {{80, -10}, {100, 10}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal IPressure "Water/steam pressure" annotation(
...
protected
  Units.SI.ThermalConductivity c1(start = 0.1) "Variable for the computation of the flue gases thermal conductivity";
  Units.SI.ThermalConductivity c2(start = 0.1) "Variable for the computation of the flue gases thermal conductivity";
  Real bb(start = 0.1e-5) "Variable for the computation of the friction coefficient";
equation
/* Flue gases inlet */
  Qf = C1.Q;
  Pef = C1.P;
...
/* Pressure */
  Psf + Pdf = Pef;
  annotation(
    Diagram(graphics = {Rectangle(extent = {{-80, 100}, {80, -100}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward), Rectangle(extent = {{-80, 100}, {-74, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-44, 100}, {-36, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{36, 100}, {44, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-4, 100}, {4, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{74, 100}, {80, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid)}),
    Icon(graphics = {Rectangle(extent = {{-80, 100}, {80, -100}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward), Rectangle(extent = {{-80, 100}, {-74, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-44, 100}, {-36, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{36, 100}, {44, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-4, 100}, {4, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{74, 100}, {80, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 255}, fillPattern = FillPattern.Solid), Text(extent = {{-2, 118}, {34, 94}}, lineColor = {0, 0, 255}, textString = "P")}),
