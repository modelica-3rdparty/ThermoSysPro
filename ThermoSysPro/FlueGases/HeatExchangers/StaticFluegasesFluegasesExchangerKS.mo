...
model StaticFluegasesFluegasesExchangerKS "Static flue gases/flue gases heat exchanger with fixed K and S"
  ...
  parameter Real DPc = 0.1 "Pressure losses in the hot fluid as a percent of the pressure at the inlet";
  parameter Real DPf = 0.1 "Pressure losses in the cold fluid as a percent of the pressure at the inlet";
  ...
  ThermoSysPro.FlueGases.Connectors.FlueGasesOutlet Sc annotation(
    Placement(transformation(extent = {{50, -70}, {70, -50}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet Ec annotation(
    Placement(transformation(extent = {{-70, -70}, {-50, -50}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet Ef annotation(
    Placement(transformation(extent = {{-110, -10}, {-90, 10}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesOutlet Sf annotation(
...
/* Average specific heat capacities */
  ...
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 60}, {100, -60}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward)}),
    Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 60}, {100, -60}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward)}),
