...
model SinkPQ "Flue gas sink with fixed pressure and mass flow rate"
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal IPressure annotation(
    Placement(transformation(extent = {{60, -9}, {40, 9}}, rotation = 0)));
