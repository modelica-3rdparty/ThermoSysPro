...
model SourceQX "Flue gas source with fixed mass flow rate"
  ...
  ThermoSysPro.FlueGases.Connectors.FlueGasesOutlet C annotation(
    Placement(transformation(extent = {{90, -10}, {110, 10}}, rotation = 0)));
  InstrumentationAndControl.Connectors.InputReal IMassFlow annotation(
    Placement(transformation(origin = {39, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  InstrumentationAndControl.Connectors.InputReal ITemperature annotation(
    Placement(transformation(origin = {40, -90}, extent = {{10, -10}, {-10, 10}}, rotation = 270)));
  InstrumentationAndControl.Connectors.InputReal ICO2 annotation(
    Placement(transformation(origin = {-90, -90}, extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(extent = {{-10, -10}, {10, 10}}, origin = {-70, -90})));
  InstrumentationAndControl.Connectors.InputReal IH2O annotation(
    Placement(transformation(origin = {-90, -30}, extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(extent = {{-10, -10}, {10, 10}}, origin = {-70, -30})));
  InstrumentationAndControl.Connectors.InputReal IO2 annotation(
    Placement(transformation(origin = {-90, 30}, extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(extent = {{-11, -10}, {11, 10}}, origin = {-69, 30})));
  InstrumentationAndControl.Connectors.InputReal ISO2 annotation(
    Placement(transformation(origin = {-90, 90}, extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(extent = {{-10, -10}, {10, 10}}, origin = {-70, 90})));
equation
  C.P = P;
  C.Q = Q;
