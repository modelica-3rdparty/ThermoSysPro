...
package Connectors "Connectors"
  connector FlueGasesOutlet "Flue gases outlet fluid connector"
    ...
    Units.SI.MassFlowRate Q(start = 100) "Mass flow of the fluid crossing the boundary of the control volume";
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, -100}, {102, 100}}, lineColor = {0, 0, 0}, lineThickness = 1, fillPattern = FillPattern.Sphere, fillColor = {191, 0, 0})}),
...
Baligh El Hefni   
  ...
  connector FlueGasesInlet "Flue gases inlet fluid connector"
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, -100}, {100, 100}}, lineColor = {0, 0, 0}, lineThickness = 1, fillPattern = FillPattern.Sphere, fillColor = {127, 127, 255})}),
      Window(x = 0.31, y = 0.13, width = 0.6, height = 0.6),
      Documentation(info = "
## Copyright © EDF 2002 - 2026  
...
Baligh El Hefni   
  ...
  connector FlueGasesInletI "Internal flue gases inlet fluid connector"
    ...
    output Boolean b "Pseudo-variable for the verification of the connection orientation";
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, -100}, {100, 100}}, lineColor = {0, 0, 0}, lineThickness = 1, fillColor = {127, 127, 255}, fillPattern = FillPattern.Forward)}),
      Window(x = 0.31, y = 0.13, width = 0.6, height = 0.6),
      Documentation(info = "
## Copyright © EDF 2002 - 2026  
...
Baligh El Hefni   
  ...
  connector FlueGasesOutletI "Internal flue gases outlet fluid connector"
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, -100}, {100, 100}}, lineColor = {0, 0, 0}, lineThickness = 1, fillColor = {255, 0, 0}, fillPattern = FillPattern.Forward)}),
      Window(x = 0.31, y = 0.13, width = 0.6, height = 0.6),
      Documentation(info = "
## Copyright © EDF 2002 - 2026  
