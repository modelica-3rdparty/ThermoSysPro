...
model Splitter2 "Flue gases splitter with two outlets"
  ...
  Units.SI.SpecificEnthalpy he(start = 100000) "Fluid specific enthalpy at the inlet";
...
/* Fluid thermodynamic properties */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{60, 100}, {60, -100}, {20, -100}, {20, -20}, {-100, -20}, {-100, 20}, {20, 20}, {20, 100}, {60, 100}}, lineColor = {0, 0, 0}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward), Text(extent = {{20, 80}, {60, 40}}, textString = "1"), Text(extent = {{20, -40}, {60, -80}}, textString = "2")}),
