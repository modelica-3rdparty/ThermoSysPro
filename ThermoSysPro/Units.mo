...
package Units "Additional SI and non-SI units"
  ...
  package SI "Library of type and unit definitions based on SI units according to ISO 31-1992"
    ...
    operator record ComplexCurrentSlope = Complex(redeclare ThermoSysPro.Units.SI.CurrentSlope re, redeclare ThermoSysPro.Units.SI.CurrentSlope im) "Complex current slope";
    operator record ComplexCurrentDensity = Complex(redeclare ThermoSysPro.Units.SI.CurrentDensity re, redeclare ThermoSysPro.Units.SI.CurrentDensity im) "Complex electrical current density";
    operator record ComplexElectricPotential = Complex(redeclare ThermoSysPro.Units.SI.ElectricPotential re, redeclare ThermoSysPro.Units.SI.ElectricPotential im) "Complex electric potential";
    operator record ComplexPotentialDifference = Complex(redeclare ThermoSysPro.Units.SI.PotentialDifference re, redeclare ThermoSysPro.Units.SI.PotentialDifference im) "Complex electric potential difference";
    operator record ComplexVoltage = Complex(redeclare ThermoSysPro.Units.SI.Voltage re, redeclare ThermoSysPro.Units.SI.Voltage im) "Complex electrical voltage";
    operator record ComplexVoltageSlope = Complex(redeclare ThermoSysPro.Units.SI.VoltageSlope re, redeclare ThermoSysPro.Units.SI.VoltageSlope im) "Complex voltage slope";
    operator record ComplexElectricFieldStrength = Complex(redeclare ThermoSysPro.Units.SI.ElectricFieldStrength re, redeclare ThermoSysPro.Units.SI.ElectricFieldStrength im) "Complex electric field strength";
    operator record ComplexElectricFluxDensity = Complex(redeclare ThermoSysPro.Units.SI.ElectricFluxDensity re, redeclare ThermoSysPro.Units.SI.ElectricFluxDensity im) "Complex electric flux density";
    operator record ComplexElectricFlux = Complex(redeclare ThermoSysPro.Units.SI.ElectricFlux re, redeclare ThermoSysPro.Units.SI.ElectricFlux im) "Complex electric flux";
    operator record ComplexMagneticFieldStrength = Complex(redeclare ThermoSysPro.Units.SI.MagneticFieldStrength re, redeclare ThermoSysPro.Units.SI.MagneticFieldStrength im) "Complex magnetic field strength";
    operator record ComplexMagneticPotential = Complex(redeclare ThermoSysPro.Units.SI.MagneticPotential re, redeclare ThermoSysPro.Units.SI.MagneticPotential im) "Complex magnetic potential";
    operator record ComplexMagneticPotentialDifference = Complex(redeclare ThermoSysPro.Units.SI.MagneticPotentialDifference re, redeclare ThermoSysPro.Units.SI.MagneticPotentialDifference im) "Complex magnetic potential difference";
    operator record ComplexMagnetomotiveForce = Complex(redeclare ThermoSysPro.Units.SI.MagnetomotiveForce re, redeclare ThermoSysPro.Units.SI.MagnetomotiveForce im) "Complex magneto motive force";
    operator record ComplexMagneticFluxDensity = Complex(redeclare ThermoSysPro.Units.SI.MagneticFluxDensity re, redeclare ThermoSysPro.Units.SI.MagneticFluxDensity im) "Complex magnetic flux density";
    operator record ComplexMagneticFlux = Complex(redeclare ThermoSysPro.Units.SI.MagneticFlux re, redeclare ThermoSysPro.Units.SI.MagneticFlux im) "Complex magnetic flux";
