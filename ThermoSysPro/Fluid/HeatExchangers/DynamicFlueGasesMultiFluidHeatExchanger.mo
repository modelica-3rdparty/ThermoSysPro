...
model DynamicFlueGasesMultiFluidHeatExchanger "Dynamic flue gases - water/steam heat exchanger"
  ...
  StaticWallFlueGasesExchanger ExchangerFlueGasesMetal(Dext = 0.022, Ns = Ns, NbTub = Ntubes, L = L, continuous_flow_reversal = continuous_flow_reversal, diffusion = diffusion) annotation(
    Placement(transformation(extent = {{-10, 30}, {10, 10}}, rotation = 0)));
  ThermoSysPro.Thermal.HeatTransfer.HeatExchangerWall ExchangerWall(L = L, D = Dint, Ns = Ns, ntubes = Ntubes, dynamic_energy_balance = dynamic_energy_balance, cpw = cpw, rhow = rhow, steady_state = steady_state, e = e, lambda = lambda, T0 = T0[1]) annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Fluid.HeatExchangers.DynamicTwoPhaseFlowPipe TwoPhaseFlowPipe(L = L, D = Dint, ntubes = Ntubes, Ns = Ns, z1 = z1, z2 = z2, inertia = inertia, advection = advection, dynamic_energy_balance = dynamic_energy_balance, dynamic_mass_balance = dynamic_mass_balance, simplified_dynamic_energy_balance = simplified_dynamic_energy_balance, steady_state = steady_state, option_temperature = option_temperature, continuous_flow_reversal = continuous_flow_reversal, diffusion = diffusion, T0 = T0, h0 = h0) annotation(
    Placement(transformation(extent = {{-10, -30}, {10, -10}}, rotation = 0)));
