...
model DynamicTwoPhaseFlowPipe "Dynamic two-phase flow pipe"
  ...
  replaceable package Medium_CoolProp = Modelica.Media.Interfaces.PartialTwoPhaseMedium "CoolProp Medium" annotation(Evaluate=true, Dialog(tab="Fluid", group="CoolProp properties (enable if FluidType.CoolPropMedium)",enable=(use_ModelicaMedia)));
