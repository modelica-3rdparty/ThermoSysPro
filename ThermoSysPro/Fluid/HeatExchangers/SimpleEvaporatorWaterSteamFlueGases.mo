...
model SimpleEvaporatorWaterSteamFlueGases "Simple water/steam - flue gases evaporator"
  ...
  parameter Units.SI.MassFlowRate gamma_diff_ws = 1e-4 "Diffusion conductance for the water/steam side (active if diffusion=true in neighbouring volumes)";
  parameter Units.SI.MassFlowRate gamma_diff_fg = 1e-4 "Diffusion conductance for the flue gases side (active if diffusion=true in neighbouring volumes)";
  parameter IF97Region region = IF97Region.All_regions "IF97 region for the water/steam side (active for IF97 water/steam only)" annotation(
    Evaluate = true,
  ...
  Units.SI.AbsolutePressure Psf(start = 2.5e5) "Flue gases pressure at the outlet";
  ...
  Units.SI.SpecificEnthalpy Hsf(start = 3e5) "Flue gases specific enthalpy at the outlet";
  Units.SI.SpecificEnthalpy Hef(start = 6e5) "Flue gases specific enthalpy at the inlet";
  ...
  Units.SI.SpecificEnthalpy Hee(start = 3e5) "Water specific enthalpy at the inlet";
  Units.SI.SpecificEnthalpy Hse(start = 20e5) "Water specific enthalpy at the outlet";
  ...
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph proes annotation(
    Placement(transformation(extent = {{-52, 80}, {-32, 100}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph proem annotation(
    Placement(transformation(extent = {{-76, 80}, {-56, 100}}, rotation = 0)));
  ...
  ThermoSysPro.Properties.WaterSteam.Common.PropThermoSat lsat annotation(
    Placement(transformation(extent = {{58, 80}, {78, 100}}, rotation = 0)));
protected
...
/* Water/steam thermodynamic properties */
  ...
  Hse = vsat.h;
  annotation(
    Diagram(graphics = {Rectangle(extent = {{-100, 80}, {100, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward), Text(extent = {{-30, 76}, {28, 66}}, lineColor = {0, 0, 0}, lineThickness = 0, fillPattern = FillPattern.HorizontalCylinder, fillColor = {175, 175, 175}, textString = "Flue gases"), Polygon(points = {{-94, 12}, {-80, 12}, {-80, 56}, {80, 56}, {80, 12}, {92, 12}, {92, 6}, {74, 6}, {74, 50}, {-74, 50}, {-74, 6}, {-94, 6}, {-94, 12}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-94, -12}, {-80, -12}, {-80, -56}, {80, -56}, {80, -12}, {92, -12}, {92, -6}, {74, -6}, {74, -50}, {-74, -50}, {-74, -6}, {-94, -6}, {-94, -12}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Text(extent = {{-114, 28}, {-48, 18}}, lineColor = {0, 0, 0}, lineThickness = 0, fillPattern = FillPattern.HorizontalCylinder, fillColor = {175, 175, 175}, textString = "Water/Steam"), Polygon(points = {{-94, 3}, {90, 3}, {90, -3}, {-94, -3}, {-94, 3}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid)}),
    Icon(graphics = {Rectangle(extent = {{-100, -75}, {100, -85}}, lineColor = {175, 175, 175}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-100, 86}, {100, 76}}, lineColor = {175, 175, 175}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-100, 80}, {100, -80}}, lineColor = {175, 175, 175}, lineThickness = 0, fillColor = DynamicSelect({255, 255, 0}, fill_color_static), fillPattern = FillPattern.Backward), Polygon(points = {{-94, 12}, {-80, 12}, {-80, 56}, {80, 56}, {80, 12}, {92, 12}, {92, 6}, {74, 6}, {74, 50}, {-74, 50}, {-74, 6}, {-94, 6}, {-94, 12}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-92, 3}, {92, 3}, {92, -3}, {-92, -3}, {-92, 3}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-94, -12}, {-80, -12}, {-80, -56}, {80, -56}, {80, -12}, {92, -12}, {92, -6}, {74, -6}, {74, -50}, {-74, -50}, {-74, -6}, {-94, -6}, {-94, -12}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Text(extent = {{-128, 26}, {-102, 16}}, lineColor = {28, 108, 200}, lineThickness = 0, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward, textString = "Water"), Text(extent = {{104, 22}, {128, 12}}, lineColor = {255, 0, 0}, lineThickness = 0, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward, textString = "Steam"), Text(extent = {{-52, -86}, {-14, -98}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward, textString = "Flue gases"), Text(extent = {{-50, 102}, {-14, 86}}, lineColor = {238, 46, 47}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Backward, textString = "Flue gases")}),
