...
model FixedPowerHeatExchanger "Heat exchanger with fixed delta power"
  ...
  parameter Units.SI.Power DW = 0 "Power exchanged between the hot and the cold fluid";
  ...
  Interfaces.Connectors.FluidOutlet Sf annotation(
    Placement(transformation(extent = {{88, -9}, {108, 11}}, rotation = 0)));
