...
model NTUWaterHeater "NTU water heater"
  ...
  parameter Units.SI.MassFlowRate gamma_diff_e = 1e-4 "Diffusion conductance for the water side (active if diffusion=true in neighbouring volumes)";
  ...
  parameter IF97Region region_eeF = IF97Region.All_regions "IF97 region at the inlet of the water side (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  parameter IF97Region region_seF = IF97Region.All_regions "IF97 region at the outlet of the water side (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  parameter IF97Region region_evC = IF97Region.All_regions "IF97 region at the inlet of the vapor side (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  parameter IF97Region region_mF = IF97Region.All_regions "IF97 region in the drain (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  parameter IF97Region region_epC = IF97Region.All_regions "IF97 region at the inlet of the drain (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  parameter IF97Region region_spC = IF97Region.All_regions "IF97 region at the outlet of the drain (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  parameter IF97Region region_flash = IF97Region.All_regions "IF97 region in the flash zone of the drain (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  ...
  Units.SI.MassFlowRate gamma_ep "Diffusion conductance for the inlet of the drain";
  Units.SI.MassFlowRate gamma_ev "Diffusion conductance for the inlet of the vapor side";
  Units.SI.MassFlowRate gamma_sp "Diffusion conductance for the outlet of the drain";
  ...
  Interfaces.Connectors.FluidInlet Ee "Water inlet" annotation(
    Placement(transformation(extent = {{-90, -10}, {-110, 10}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Se "Water outlet" annotation(
    Placement(transformation(extent = {{110, -10}, {90, 10}}, rotation = 0)));
  Interfaces.Connectors.FluidInlet Ep "Drain inlet" annotation(
    Placement(transformation(extent = {{-50, 24}, {-70, 44}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Sp "Drain outlet" annotation(
    Placement(transformation(extent = {{-50, -43}, {-70, -23}}, rotation = 0)));
  Interfaces.Connectors.FluidInlet Ev "Vapor inlet" annotation(
    Placement(transformation(extent = {{70, 24}, {50, 44}}, rotation = 0), iconTransformation(extent = {{70, 24}, {50, 44}})));
