...
model SimpleDynamicCondenser "Simple dynamic condenser"
  ...
  parameter Units.SI.AbsolutePressure P0 = 0.1e5 "Fluid initial pressure (active if dynamic_energy_balance=true and steady_state=false)" annotation(
    Evaluate = true,
    Dialog(enable = dynamic_energy_balance and not steady_state));
  ...
  parameter IF97Region region = IF97Region.All_regions "IF97 region for the pipes (active for IF97 water/steam only)" annotation(
    Evaluate = true,
  ...
  Units.SI.SpecificHeatCapacity cp(start = 4200) "Fluid specific heat capacity in the pipes";
  Units.SI.ThermalConductivity k(start = 0.05) "Fluid thermal conductivity in the pipes";
  Units.SI.Density rhom(start = 998) "Liquid phase density in the pipes";
  ThermoSysPro.Units.SI.PressureDifference deltaP "Total pressure loss in the pipes";
  ThermoSysPro.Units.SI.PressureDifference dpf "Friction pressure loss in the pipes";
  ThermoSysPro.Units.SI.PressureDifference dpg "Gravity pressure loss in the pipes";
  ...
  Units.SI.MassFlowRate BQl "Right hand side of the mass balance equation of the liquid phase in the cavity";
  Units.SI.MassFlowRate BQv "Right hand side of the mass balance equation of the gas phase in the cavity";
  Units.SI.Power BHl "Right hand side of the energy balance equation of the liquid phase in the cavity";
  Units.SI.Power BHv "Right hand side of the energy balance equation of the gas phase in the cavity";
  Units.SI.MassFlowRate Qcond "Condensation mass flow rate from the vapor phase in the cavity";
  Units.SI.MassFlowRate Qevap "Evaporation mass flow rate from the liquid phase in the cavity";
  Units.SI.Power Wvl "Thermal power exchanged from the gas phase to the liquid phase in the cavity";
  Units.SI.Power Wout "Thermal power exchanged from the steam in the cavity to the pipes";
  Units.SI.Power Jv "Thermal power diffusion from inlet Cv";
  Units.SI.Power Jl "Thermal power diffusion from outlet Cl";
  Units.SI.Power Jt_l "Total thermal power diffusion for the liquid in the cavity";
  Units.SI.Power Jt_v "Total thermal power diffusion for the vapor in the cavity";
  ...
  Units.SI.MassFlowRate gamma_diff(start = 1.e-4) "Diffusion conductance in the pipes";
  ...
  Interfaces.Connectors.FluidInlet Cv annotation(
    Placement(transformation(extent = {{-10, 90}, {10, 110}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Cl annotation(
  ...
  Interfaces.Connectors.FluidInlet Cee annotation(
    Placement(transformation(extent = {{-110, -32}, {-90, -12}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Cse annotation(
