...
model StaticAerocondenser "Static aerocondenser"
  ...
  parameter Units.SI.CoefficientOfHeatTransfer Uref = 50 "Reference heat transfer coefficient between the air and the condenser external wall";
  ...
  parameter IF97Region region_e = IF97Region.All_regions "IF97 region at the inlet (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  parameter IF97Region region_s = IF97Region.All_regions "IF97 region at the outlet (active for IF97 water/steam only)" annotation(
    Evaluate = true,
    Dialog(enable = (ftype == FluidType.WaterSteam), tab = "Fluid", group = "Fluid properties"));
  Units.SI.SpecificEnthalpy he(start = 370000) "Water specific enthalpy at the outlet of the condenser";
  Units.SI.SpecificEnthalpy hae(start = 75000) "Air specific enthalpy at the inlet of the condenser";
  Units.SI.SpecificEnthalpy has(start = 100000) "Air specific enthalpy at the outlet of the condenser";
  Units.SI.MassFlowRate Q(start = 1.5e2) "Fluid mass flow rate in the water/steam pipe";
  Units.SI.MassFlowRate Qa(start = 1.4e3) "Air mass flow rate in the condenser";
  Units.SI.Temperature Tae(start = 290) "Air temperature at the inlet of the condenser";
  Units.SI.Temperature Tas(start = 360) "Air temperature at the outlet of the condenser";
  Units.SI.AbsolutePressure Pae(start = 1.e5) "Air pressure at the inlet of the condenser";
  Units.SI.AbsolutePressure Pas(start = 1.e5) "Air pressure at the outlet of the condenser";
  Units.SI.AbsolutePressure Pfond(start = 30000) "Water pressure at the bottom of the condenser";
  ...
  Units.SI.SpecificHeatCapacity cp_a(start = 1000) "Air specific heat capacity at constant pressure";
  ...
  Units.SI.Density rho_e(start = 998) "Water density at the outlet of the condenser";
  ...
  Interfaces.Connectors.FluidInlet Cws1 annotation(
    Placement(transformation(extent = {{-10, 100}, {10, 120}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Cws2 annotation(
    Placement(transformation(extent = {{-10, -120}, {10, -100}}, rotation = 0)));
  Interfaces.Connectors.FluidInlet Cair1 annotation(
    Placement(transformation(extent = {{100, -119}, {120, -99}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Cair2 annotation(
    Placement(transformation(extent = {{100, 100}, {120, 120}}, rotation = 0)));
  Interfaces.Connectors.FluidInlet Cw annotation(
    Placement(transformation(extent = {{-120, -100}, {-100, -80}}, rotation = 0), iconTransformation(extent = {{-120, -100}, {-100, -80}})));
  Properties.WaterSteam.Common.ThermoProperties_ph proe "Water properties" annotation(
