...
model SimpleStaticCondenser "Simple static condenser"
  ...
  ThermoSysPro.Units.SI.PressureDifference DPfc(start = 1e3) "Friction pressure loss in the hot side";
  ThermoSysPro.Units.SI.PressureDifference DPgc(start = 1e2) "Gravity pressure loss in the hot side";
  ThermoSysPro.Units.SI.PressureDifference DPc(start = 1e3) "Total pressure loss in the hot side";
  ThermoSysPro.Units.SI.PressureDifference DPff(start = 1e3) "Friction pressure loss in the cold side";
  ThermoSysPro.Units.SI.PressureDifference DPgf(start = 1e2) "Gravity pressure loss in the cold side";
  ThermoSysPro.Units.SI.PressureDifference DPf(start = 1e3) "Total pressure loss in the cold side";
  ...
  Interfaces.Connectors.FluidOutlet Sf annotation(
    Placement(transformation(extent = {{90, -11}, {110, 9}}, rotation = 0)));
  ...
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph promc annotation(
    Placement(transformation(extent = {{0, -100}, {20, -80}}, rotation = 0)));
