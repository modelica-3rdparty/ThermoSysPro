...
public
  ...
  Interfaces.Connectors.FluidInlet Ce3(redeclare package Medium = Medium) annotation (Placement(transformation(
          extent={{-110,-90},{-90,-70}}), iconTransformation(extent={{-110,-90},
            {-90,-70}})));
  Interfaces.Connectors.FluidInlet Ce4(redeclare package Medium = Medium) annotation (Placement(transformation(
          extent={{-10,-110},{10,-90}}), iconTransformation(extent={{-10,-110},{
            10,-90}})));
  Interfaces.Connectors.FluidOutlet Cs3(redeclare package Medium = Medium) annotation (Placement(transformation(
          extent={{90,-90},{110,-70}}), iconTransformation(extent={{90,-90},{110,
            -70}})));
  Interfaces.Connectors.FluidOutlet Cs4(redeclare package Medium = Medium) annotation (Placement(transformation(
...
/* Mass balance equation */
  ...
  BH = Ce1.Q*Ce1.h + Ce2.Q*Ce2.h + Ce3.Q*Ce3.h + Ce4.Q*Ce4.h - Cs1.Q*Cs1.h - Cs2.Q*Cs2.h - Cs3.Q*Cs3.h - Cs4.Q*Cs4.h + Cth.W + J;
