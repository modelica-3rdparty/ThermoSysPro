...
model Tank "Open vertical tank"
  ...
  parameter Units.SI.Position z0 = 30 "Initial fluid level (active if steady_state_mech=false)" annotation(
    Evaluate = true,
...
/* Check that incoming fluids are compatible with fluid in volume */
  ...
  fluids[4] = Cs1.ftype;
  fluids[5] = Cs2.ftype;
  assert(ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.isCompatible(fluids), "Tank: fluids mixing in volume are not compatible with each other");
...
/* Fluid thermodynamic properties */
  ...
  annotation(
    ...
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 100}, {100, 20}}, lineColor = {28, 108, 200}), Rectangle(extent = {{-100, 20}, {100, -100}}, lineColor = {0, 0, 0}, fillPattern = FillPattern.Solid, fillColor = {85, 170, 255})}),
