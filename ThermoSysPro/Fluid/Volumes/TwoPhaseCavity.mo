...
model TwoPhaseCavity "TwoPhaseCavity for one shell pass "
  ...
  parameter Units.SI.Volume V = 50 "Cavity volume (= total volume + bleeding volume - pipe volume) ";
  ...
  parameter Units.SI.Length PasL = 0.025 "Longitudinal step or length bottom pipes triangular step";
  ...
  Interfaces.Connectors.FluidInlet Cv "Steam input" annotation(
    Placement(transformation(extent = {{-88, 50}, {-68, 70}}, rotation = 0), iconTransformation(extent = {{-88, 50}, {-68, 70}})));
  Interfaces.Connectors.FluidOutlet Cl "Water output" annotation(
    Placement(transformation(extent = {{-88, -170}, {-68, -150}}, rotation = 0), iconTransformation(extent = {{-88, -170}, {-68, -150}})));
  ThermoSysPro.Thermal.Connectors.ThermalPort Cth3[Ns3] annotation(
    Placement(transformation(extent = {{-85, -53}, {-73, -41}}, rotation = 0), iconTransformation(extent = {{-85, -53}, {-73, -41}})));
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputReal yLevel "Water level" annotation(
    Placement(transformation(extent = {{88, -109}, {108, -89}}, rotation = 0), iconTransformation(extent = {{88, -109}, {108, -89}})));
  ...
  ThermoSysPro.Thermal.Connectors.ThermalPort Cth1[Ns] annotation(
    Placement(transformation(extent = {{-85, -133}, {-73, -120}}, rotation = 0), iconTransformation(extent = {{-85, -133}, {-73, -120}})));
  ThermoSysPro.Thermal.Connectors.ThermalPort Cth2[Ns] annotation(
    Placement(transformation(extent = {{-85, 19}, {-73, 32}}, rotation = 0), iconTransformation(extent = {{-85, 19}, {-73, 32}})));
  ...
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph provIn "Propri鴩s de la vapeur dans le ballon" annotation(
...
/* Check that incoming fluids are compatible with fluid in volume */
  ...
  fluids[3] = Cv.ftype;
  fluids[4] = Cl.ftype;
  assert(ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.isCompatible(fluids), "TwoPhaseCavity: fluids mixing in volume are not compatible with each other");
