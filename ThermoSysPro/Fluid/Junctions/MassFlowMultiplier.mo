...
public
  ...
  ThermoSysPro.Properties.Fluid.Density_Ph rho_calc(P = P, h = h, fluid = fluid, mode = mode, Xco2 = Cs.Xco2, Xh2o = Cs.Xh2o, Xo2 = Cs.Xo2, Xso2 = Cs.Xso2);// To be verified MAZU
equation
...
//     rho = ThermoSysPro.Properties.Fluid.Density_Ph(P,h,fluid,mode, Cs.Xco2, Cs.Xh2o, Cs.Xo2, Cs.Xso2);// Commented automatically, to be verified MAZU
