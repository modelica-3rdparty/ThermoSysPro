...
model SteamExtractionSplitter "Splitter for steam extraction"
  ...
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Ce annotation(
    Placement(transformation(extent = {{-113, -10}, {-93, 10}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidOutlet Cs annotation(
    Placement(transformation(extent = {{93, -10}, {113, 10}}, rotation = 0)));
  ...
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidOutlet Cex "Extraction outlet" annotation(
...
/* Check that incoming fluids are compatible with fluid in volume */
  ...
  fluids[3] = Cs.ftype;
  fluids[4] = Cex.ftype;
  assert(ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.isCompatible(fluids), "SteamExtractionSplitter: fluids mixing in volume are not compatible with each other");
...
/* Vapor mass fraction at the extraction outlet */
  x_ex = alpha*proe.x;
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-100, 30}, {-100, -30}, {-40, -30}, {20, -100}, {20, -100}, {60, -100}, {70, -100}, {0, -30}, {100, -30}, {100, 30}, {-100, 30}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid)}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-100, 28}, {-100, -32}, {-40, -32}, {20, -102}, {20, -102}, {60, -102}, {70, -102}, {0, -32}, {100, -32}, {100, 28}, {-100, 28}}, lineColor = {0, 0, 0}, fillColor = DynamicSelect({255, 255, 0}, if diffusion then fill_color_singular else fill_color_static), fillPattern = FillPattern.Solid)}),
