...
model HeatPumpCompressor "Heat pump compressor "
  ...
  parameter Units.SI.Power W_fric = 0.0 "Power losses due to hydrodynamic friction (percent)";
  ...
  Units.SI.SpecificEnthalpy His "Fluid specific enthalpy after isentropic compression";
...
/* Fluid thermodynamic properties after the identropic compression */
  ...
  His = props.h;
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, fillColor = {128, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{-60, 80}, {60, 20}, {60, -20}, {-60, -80}}, color = {0, 0, 255})}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular), fillPattern = FillPattern.Solid), Line(points = {{-60, 80}, {60, 20}, {60, -20}, {-60, -80}}, color = {0, 0, 255})}),
