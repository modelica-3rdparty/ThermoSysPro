...
model StaticFan "Static fan"
  ...
  parameter ThermoSysPro.Units.nonSI.AngularVelocity_rpm VRot = 1400 "Rotational speed";
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputLogical commandeFan annotation(
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal VRotation annotation(
...
// Temperature
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}), Polygon(points = {{-40, 92}, {40, 92}, {-40, -92}, {40, -92}, {-40, 92}}, lineColor = {0, 0, 255}, fillColor = {128, 255, 0}, fillPattern = FillPattern.Backward), Polygon(points = {{-92, 40}, {-92, -40}, {92, 40}, {92, -40}, {-92, 40}}, lineColor = {0, 0, 255}, fillColor = {128, 255, 0}, fillPattern = FillPattern.Backward)}),
    Window(x = 0.03, y = 0.02, width = 0.95, height = 0.95),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}), Polygon(points = {{-40, 92}, {40, 92}, {-40, -92}, {40, -92}, {-40, 92}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular), fillPattern = FillPattern.Backward), Polygon(points = {{-92, 40}, {-92, -40}, {92, 40}, {92, -40}, {-92, 40}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular), fillPattern = FillPattern.Backward)}),
    Documentation(info = "
