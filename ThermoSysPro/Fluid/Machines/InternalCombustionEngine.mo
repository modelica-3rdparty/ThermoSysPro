...
model InternalCombustionEngine "Internal combustion engine with electrical output"
  ...
  ThermoSysPro.Fluid.Interfaces.Connectors.FuelInlet Cfuel "Fuel inlet" annotation(
    Placement(transformation(extent = {{-80, -100}, {-60, -80}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Cair "Air inlet" annotation(
  ...
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Cws1 "Water inlet" annotation(
    Placement(transformation(extent = {{-100, -10}, {-80, 10}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidOutlet Cws2 "Water/steam outlet" annotation(
