...
/* Coude ࠰arois concentriques (Idel'cik p. 192). Quadratic flow regime is assumed and Re > 2e5 (Re > Relim). */
  ...
  assert((delta > 0) and not (delta > 180), "Bend: parameter delta should be such as 0ࠦlt; delta <= 180°");
...
/* Fluid thermodynamic properties */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 20}, {-20, -20}}, lineColor = {0, 0, 0}, fillPattern = FillPattern.Solid, fillColor = {127, 255, 0}), Rectangle(extent = {{-20, -18}, {20, -100}}, lineColor = {0, 0, 0}, fillPattern = FillPattern.Solid, fillColor = {127, 255, 0}), Polygon(points = {{-20, 20}, {-12, 20}, {-2, 18}, {6, 14}, {12, 10}, {18, 2}, {20, -6}, {20, -18}, {-20, 20}}, lineColor = {28, 108, 200}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-20, 20}, {-20, -20}, {20, -18}, {-20, 20}}, lineColor = {127, 255, 0}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-30, -20}, {-24, -22}, {-22, -24}, {-20, -28}, {-20, -20}, {-30, -20}}, lineColor = {192, 192, 192}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{-30, -20}, {-24, -22}, {-22, -24}, {-20, -28}}, color = {28, 108, 200})}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 20}, {-20, -20}}, lineColor = {0, 0, 255}, fillPattern = FillPattern.Solid, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular)), Rectangle(extent = {{-20, -18}, {20, -100}}, lineColor = {0, 0, 255}, fillPattern = FillPattern.Solid, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular)), Polygon(points = {{-20, 20}, {-12, 20}, {-2, 18}, {6, 14}, {12, 10}, {18, 2}, {20, -6}, {20, -20}, {-20, 20}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular), fillPattern = FillPattern.Solid), Polygon(points = {{-20, 20}, {-20, -20}, {20, -20}, {-20, 20}}, lineColor = {127, 255, 0}, fillPattern = FillPattern.Solid, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular)), Polygon(points = {{-30, -20}, {-24, -22}, {-22, -24}, {-20, -28}, {-20, -20}, {-30, -20}}, lineColor = {0, 255, 0}, fillColor = DynamicSelect({127, 255, 0}, fill_color_singular), lineThickness = 0.5, fillPattern = FillPattern.Solid), Line(points = {{-30, -20}, {-24, -22}, {-22, -24}, {-20, -28}})}),
