...
model DynamicCheckValve "Dynamic check valve"
  ...
  parameter Integer mode_caract = 0 "0:linear characteristics - 1:characteristics is given by caract[]" annotation(
    Evaluate = true);
  ...
  parameter Real Ouv0 = 0 "Initial valve position, between 0 and 1. 0:valve closed - 1: valve open (active if mech_steady_state=false)" annotation(
    Evaluate = true,
