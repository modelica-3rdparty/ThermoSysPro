...
model FuelSourcePQ "Fuel source with fixed pressure and mass flow rate"
  parameter Units.SI.AbsolutePressure P0 = 1e5 "Fuel pressure (active if pressure input port is not connected)";
  parameter Units.SI.MassFlowRate Q0 = 10 "Fuel mass flow rate (active if mass flow input port is not connected)";
  parameter Units.SI.Temperature T0 = 300 "Fuel temperature";
  parameter Units.SI.SpecificEnergy LHV = 48e6 "Lower heating value";
  parameter Units.SI.SpecificHeatCapacity Cp = 1e3 "Fuel specific heat capacity at 273.15K";
  ...
  Interfaces.Connectors.FuelOutlet C annotation(
  ...
  InstrumentationAndControl.Connectors.InputReal IPressure annotation(
...
/* Temperature */
  T = T0;
  annotation(
    Diagram(graphics = {Line(points = {{40, 0}, {90, 0}, {72, 10}}), Line(points = {{90, 0}, {72, -10}}), Rectangle(extent = {{-40, 40}, {40, -40}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.CrossDiag), Text(extent = {{-30, 60}, {-12, 40}}, textString = "Q"), Text(extent = {{-64, 26}, {-40, 6}}, lineColor = {0, 0, 255}, textString = "P")}),
    Icon(graphics = {Text(extent = {{-38, 60}, {-4, 40}}, lineColor = {0, 0, 255}, textString = "Q"), Rectangle(extent = {{-40, 40}, {40, -40}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.CrossDiag), Line(points = {{40, 0}, {90, 0}, {72, 10}}), Line(points = {{90, 0}, {72, -10}}), Text(extent = {{-64, 26}, {-40, 6}}, lineColor = {0, 0, 255}, textString = "P")}),
