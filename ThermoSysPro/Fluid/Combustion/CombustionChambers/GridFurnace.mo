...
model GridFurnace "Combustion furnace"
  ...
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Ca2 annotation(
    Placement(transformation(extent = {{-60, 50}, {-40, 70}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FuelInlet Com annotation(
    Placement(transformation(extent = {{-100, -20}, {-80, 0}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet port_eau_refroid annotation(
    Placement(transformation(extent = {{70, 20}, {90, 40}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_pT pro1 annotation(
    Placement(transformation(extent = {{-100, 80}, {-80, 100}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_pT pro2 annotation(
    Placement(transformation(extent = {{-100, 60}, {-80, 80}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_pT pro3 annotation(
    Placement(transformation(extent = {{-100, 40}, {-80, 60}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_pT pro4 annotation(
    Placement(transformation(extent = {{-100, 20}, {-80, 40}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_pT pro5 annotation(
    Placement(transformation(extent = {{-60, 80}, {-40, 100}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Ca1 annotation(
    Placement(transformation(extent = {{-10, -100}, {10, -80}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidOutlet Cfg "Flue gases outlet" annotation(
...
/* Check that incoming fluids are compatible with fluid in volume */
  ...
  fluids[3] = Ca2.ftype;
  fluids[4] = Cfg.ftype;
  assert(ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.isCompatible(fluids), "GenericCombustion1D: fluids mixing in volume are not compatible with each other");
...
/* Normal voulme fraction of the volatile ashes */
  ...
  annotation(
    Diagram(graphics = {Polygon(points = {{-80, 20}, {-80, -80}, {100, -80}, {100, 20}, {62, 20}, {20, 40}, {20, 80}, {-40, 80}, {-40, 40}, {-80, 20}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-80, 0}, {60, -40}, {80, -80}, {-80, -80}, {-80, 0}}, lineColor = {0, 0, 255}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid)}),
    Icon(graphics = {Polygon(points = {{-80, 20}, {-80, -80}, {100, -80}, {100, 20}, {62, 20}, {20, 40}, {20, 80}, {-40, 80}, {-40, 40}, {-80, 20}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-80, 0}, {60, -40}, {80, -80}, {-80, -80}, {-80, 0}}, lineColor = {0, 0, 255}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Text(extent = {{66, 60}, {92, 32}}, lineColor = {28, 108, 200}, textString = "Water inlet"), Text(extent = {{14, 106}, {62, 70}}, lineColor = {238, 46, 47}, textString = "Flue gases outlet"), Text(extent = {{-98, -14}, {-72, -42}}, lineColor = {28, 108, 200}, textString = "Fuel inlet"), Text(extent = {{12, -70}, {54, -114}}, lineColor = {28, 108, 200}, textString = "Primary air inlet"), Text(extent = {{-100, 100}, {-54, 52}}, lineColor = {28, 108, 200}, textString = "Secondary air inlet")}),
    DymolaStoredErrors,
