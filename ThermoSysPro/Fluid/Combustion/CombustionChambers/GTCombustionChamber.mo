...
/* Fuel specific enthalpy at the inlet */
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(extent = {{-80, 80}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({255, 255, 0}, if diffusion then fill_color_singular else fill_color_static), fillPattern = FillPattern.Solid), Line(points = {{-20, 80}, {-20, -80}}, color = {0, 0, 255}), Polygon(points = {{-20, 62}, {46, 46}, {2, 30}, {58, 18}, {6, 0}, {48, -16}, {2, -32}, {54, -44}, {-20, -60}, {-20, 62}}, lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.CrossDiag), Text(extent = {{-98, 104}, {-72, 76}}, lineColor = {28, 108, 200}, textString = "Water in"), Text(extent = {{62, 34}, {110, -2}}, lineColor = {238, 46, 47}, textString = "Flue gases out"), Text(extent = {{18, -78}, {44, -106}}, lineColor = {28, 108, 200}, textString = "Fuel in"), Text(extent = {{-100, -6}, {-74, -30}}, lineColor = {28, 108, 200}, textString = "Air in")}),
