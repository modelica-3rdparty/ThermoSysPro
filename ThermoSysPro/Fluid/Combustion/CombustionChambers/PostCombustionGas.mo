...
model PostCombustionGas "Post-combustion"
  ...
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Ca "Air inlet" annotation(
    Placement(transformation(extent = {{-60, 80}, {-40, 100}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidOutlet Cfg2 "Flue gases outlet" annotation(
    Placement(transformation(extent = {{80, 0}, {100, 20}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Cfg1 "Flue gases inlet" annotation(
    Placement(transformation(extent = {{-100, 0}, {-80, 20}}, rotation = 0)));
  ThermoSysPro.Fluid.Interfaces.Connectors.FuelInlet Cfuel "Fuel inlet" annotation(
...
/* Check that incoming fluids are compatible with fluid in volume */
  ...
  fluids[3] = Cfg1.ftype;
  fluids[4] = Cfg2.ftype;
  assert(ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.isCompatible(fluids), "PostCombustionGas: fluids mixing in volume are not compatible with each other");
/* Fuel inlet */
  Qec = Cfuel.Q;
  Tec = Cfuel.T;
  LHVfuel = Cfuel.LHV;
...
// Changed from FlueGases_T to FlueGases_h to provide a differentiable function
  ...
  Wrad = P2t*Xrad;
  annotation(
    Diagram(graphics = {Rectangle(extent = {{-80, 80}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = {120, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-20, 62}, {46, 46}, {2, 30}, {58, 18}, {6, 0}, {48, -16}, {2, -32}, {54, -44}, {-20, -60}, {-20, 62}}, lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.CrossDiag), Line(points = {{-20, 80}, {-20, -80}}, color = {0, 0, 255})}),
    Icon(graphics = {Rectangle(extent = {{-80, 80}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({255, 255, 0}, if diffusion then fill_color_singular else fill_color_static), fillPattern = FillPattern.Solid), Polygon(points = {{-20, 62}, {46, 46}, {2, 30}, {58, 18}, {6, 0}, {48, -16}, {2, -32}, {54, -44}, {-20, -60}, {-20, 62}}, lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.CrossDiag), Line(points = {{-20, 80}, {-20, -80}}, color = {0, 0, 255}), Text(extent = {{-92, 100}, {-66, 76}}, lineColor = {28, 108, 200}, textString = "Air inlet"), Text(extent = {{52, 44}, {100, 8}}, lineColor = {238, 46, 47}, textString = "Flue gases outlet"), Text(extent = {{-12, -78}, {20, -108}}, lineColor = {28, 108, 200}, textString = "Fuel inlet"), Text(extent = {{-100, 44}, {-52, 8}}, lineColor = {238, 46, 47}, textString = "Flue gases inlet")}),
