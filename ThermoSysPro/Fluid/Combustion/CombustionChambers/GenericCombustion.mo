...
model GenericCombustion "Generic combustion chamber"
  ...
  ThermoSysPro.Fluid.Interfaces.Connectors.FluidInlet Cws "Water/steam inlet" annotation(
...
/* Energy balance equation */
  0 = ((Qea + Qews + Qfuel*(1 - XCDfuel))*(Hsf - Hrfg) + Wpth + Qcv*(Hcv - Hrcd) + Qbf*(Hbf - Hrcd) + (Qcv*ImbCV + Qbf*ImbBF)*HHVcarbone) - (Qfuel*(Hfuel - Hrfuel + LHVfuel) + Qea*(Hea - Hrair) + Qews*(Hews - Hrws)) + J;
...
/* Pressure losses */
  ...
  annotation(
    Diagram(graphics = {Rectangle(extent = {{-80, 80}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-50, -36}, {-44, 30}, {-34, -2}, {-10, 66}, {10, -4}, {44, 54}, {66, -44}, {38, -80}, {-34, -80}, {-50, -36}}, lineColor = {0, 0, 0}, fillColor = {255, 128, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-32, -36}, {-18, -44}, {-26, -16}, {-16, 6}, {4, -44}, {8, -28}, {36, -72}, {16, -80}, {-16, -80}, {-32, -36}}, lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid)}),
    Icon(graphics = {Rectangle(extent = {{-80, 80}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({255, 255, 0}, if diffusion then fill_color_singular else fill_color_static), fillPattern = FillPattern.Solid), Polygon(points = {{-50, -36}, {-44, 30}, {-34, -2}, {-10, 66}, {10, -4}, {44, 54}, {66, -44}, {38, -80}, {-34, -80}, {-50, -36}}, lineColor = {0, 0, 0}, fillColor = {255, 128, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-32, -36}, {-18, -44}, {-26, -16}, {-16, 6}, {4, -44}, {8, -28}, {36, -72}, {16, -80}, {-16, -80}, {-32, -36}}, lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid), Text(extent = {{82, -76}, {108, -104}}, lineColor = {28, 108, 200}, textString = "Fuel inlet"), Text(extent = {{-66, -78}, {-42, -102}}, lineColor = {28, 108, 200}, textString = "Air inlet"), Text(extent = {{-110, 42}, {-82, 14}}, lineColor = {28, 108, 200}, textString = "Water inlet"), Text(extent = {{-18, 106}, {30, 70}}, lineColor = {238, 46, 47}, textString = "Flue gases outlet")}),
