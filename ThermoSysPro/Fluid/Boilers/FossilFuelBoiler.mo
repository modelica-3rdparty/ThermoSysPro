...
model FossilFuelBoiler "Fossil fuel boiler"
  ...
  Interfaces.Connectors.FuelInlet Cfuel "Fuel inlet" annotation(
    Placement(transformation(extent = {{-10, -90}, {10, -70}}, rotation = 0)));
  Interfaces.Connectors.FluidInlet Cair "Air inlet" annotation(
    Placement(transformation(extent = {{-110, -72}, {-90, -52}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Cfg "Flue gases outlet" annotation(
    Placement(transformation(extent = {{90, -72}, {110, -52}}, rotation = 0)));
  Interfaces.Connectors.FluidInlet Cws1 "Water inlet" annotation(
    Placement(transformation(extent = {{-110, 50}, {-90, 70}}, rotation = 0)));
  Interfaces.Connectors.FluidOutlet Cws2 "Water/steam outlet" annotation(
...
/* Water/steam thermodynamic properties */
  ...
  Tse = pros.T;
  annotation(
    Icon(graphics = {Rectangle(extent = {{-100, 80}, {100, -80}}, lineColor = {0, 0, 255}, fillColor = DynamicSelect({255, 255, 0}, if diffusion then fill_color_singular else fill_color_static), fillPattern = FillPattern.Solid), Polygon(points = {{-2, -42}, {10, -46}, {20, -34}, {24, -20}, {22, -6}, {20, 2}, {16, 12}, {12, 22}, {10, 30}, {8, 36}, {4, 54}, {0, 44}, {-4, 36}, {-8, 24}, {-8, 20}, {-10, 16}, {-12, 24}, {-14, 26}, {-16, 22}, {-20, 14}, {-22, 8}, {-26, 0}, {-28, -10}, {-30, -20}, {-30, -28}, {-24, -36}, {-20, -42}, {-10, -48}, {-2, -42}}, lineColor = {255, 0, 128}, fillColor = {255, 128, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-10, -24}, {-8, -20}, {-4, -18}, {0, -18}, {4, -20}, {6, -22}, {8, -28}, {8, -32}, {6, -30}, {4, -26}, {2, -22}, {-4, -22}, {-6, -24}, {-10, -28}, {-12, -30}, {-12, -30}, {-10, -24}}, lineColor = {127, 0, 0}, fillColor = {127, 0, 0}, fillPattern = FillPattern.Solid), Line(points = {{-92, 60}, {92, 60}, {88, 60}, {80, 60}}, color = {28, 108, 200}), Line(points = {{-92, -62}, {92, -62}, {88, -62}, {80, -62}}, color = {255, 0, 0})}),
...
This component model is documented in Sect. 7.2 of the ThermoSysPro book.   
    "),
    Diagram(graphics = {Rectangle(extent = {{-100, 80}, {100, -80}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-2, -42}, {10, -46}, {20, -34}, {24, -20}, {22, -6}, {20, 2}, {16, 12}, {12, 22}, {10, 30}, {8, 36}, {4, 54}, {0, 44}, {-4, 36}, {-8, 24}, {-8, 20}, {-10, 16}, {-12, 24}, {-14, 26}, {-16, 22}, {-20, 14}, {-22, 8}, {-26, 0}, {-28, -10}, {-30, -20}, {-30, -28}, {-24, -36}, {-20, -42}, {-10, -48}, {-2, -42}}, lineColor = {255, 0, 128}, fillColor = {255, 128, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-10, -24}, {-8, -20}, {-4, -18}, {0, -18}, {4, -20}, {6, -22}, {8, -28}, {8, -32}, {6, -30}, {4, -26}, {2, -22}, {-4, -22}, {-6, -24}, {-10, -28}, {-12, -30}, {-12, -30}, {-10, -24}}, lineColor = {127, 0, 0}, fillColor = {127, 0, 0}, fillPattern = FillPattern.Solid), Text(extent = {{68, -30}, {108, -56}}, lineColor = {238, 46, 47}, textString = "Flue Gases"), Line(points = {{-92, 60}, {92, 60}, {88, 60}, {80, 60}}, color = {28, 108, 200}), Line(points = {{-92, -62}, {92, -62}, {88, -62}, {80, -62}}, color = {255, 0, 0}), Text(extent = {{-112, -36}, {-86, -52}}, lineColor = {28, 108, 200}, textString = "Air")}));
