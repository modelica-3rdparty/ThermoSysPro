...
model Islanding
  ...
  ThermoSysPro.Fluid.HeatExchangers.DynamicWaterHeater WaterHeating(
    ...
    pipe_3(
      ...
      Tp(start={510,510.4,511,511.4,512,512.4,513,513.4,514,514.4,515,515.4,516,
            516.4,517,517.4,518,518.4,519,519.4}))) annotation(
  ...
  ThermoSysPro.Fluid.Examples.Control.Condenser_LevelControl_RE5 regulation_Niveau(add(k1 = +1, k2 = -1), pIsat1(Limiteur1(u(signal(start = 0.8))))) annotation(
...
equation
  ...
  connect(Temperature_eauA.y, sourceP1.ISpecificEnthalpyOrTemperature) annotation(
    Line(points = {{-175, -78}, {-171, -78}, {-171, -49}}, color = {0, 0, 255}));
  annotation(
