...
model TestSteamDryer
  ...
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss
    singularPressureLoss2(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-50,-4},
            {-30,16}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.Sink sinkP(
    redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{70,-4},{90,16}}, rotation=0)));
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss
    singularPressureLoss1(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{30,-4},
            {50,16}}, rotation=0)));
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss
