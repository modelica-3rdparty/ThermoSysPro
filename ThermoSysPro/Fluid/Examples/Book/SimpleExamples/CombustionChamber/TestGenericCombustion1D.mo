...
model TestGenericCombustion1D "TestGenericCombustion1D"
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ sourceAir(Xso2 = 0, Q0 = 609.29, Xh2o = 0.01, Xo2 = 0.230, Xco2 = 0, P0 = 191000, T0 = 524.89, ftype = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.FluidType.FlueGases, option_temperature = true) annotation(
