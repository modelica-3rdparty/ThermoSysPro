...
model ConcentratedSolarPowerPlant_PTSC "Model of a concentrated solar power plant with PTSC"
  ...
  ThermoSysPro.Fluid.HeatExchangers.DynamicOnePhaseFlowPipe TubeEcran_2(option_temperature = false, L = L2, Ns = Ns2, T0 = {659.137, 684.387, 693.983, 697.543, 698.861}, h0 = fill(650e3, Ns2), D = 0.04, hcCorr = 2, ntubes = 3, inertia = false, advection = false, P(start = {100000.0, 8120050.0, 8098500.0, 8074750.0, 8050150.0, 8025170.0, 8000000.0}), h(start = {2756570.0, 3040300.0, 3147840.0, 3187560.0, 3202330.0, 3208020.0, 3208020.0}), mu2(start = {1.94524E-005, 0.0002, 0.0002, 0.0002, 0.0002, 0.0002}), rho2(start = {43.2944, 998.0, 998.0, 998.0, 998.0, 998.0})) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss PerteCharge_Huile_3(K = 1e-6, p_rho = 900, C1(h_vol_2(start = 462620.0)), C2(h_vol_1(start = 462620.0))) annotation(
    Placement(transformation(origin = {-134, 138.5}, extent = {{6, -9.5}, {-6, 9.5}}, rotation = 180)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Tables.Table1DTemps Tatm(Table = [0, 300; 1, 300]) annotation(
    Placement(transformation(extent = {{-322, 186}, {-306, 202}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Tables.Table1DTemps Incidence(Table = [0, 0; 1, 0]) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss PerteCharge_Huile_4(K = 1e-6, p_rho = 650, C2(h_vol_1(start = 870908.0))) annotation(
    Placement(transformation(origin = {-5, 139}, extent = {{6, -10}, {-6, 10}}, rotation = 180)));
  ThermoSysPro.Fluid.HeatExchangers.DynamicOnePhaseFlowPipe TubeEcran_22(P(each start = 2.3e6), option_temperature = false, Ns = Ns2, T0 = {698.976, 700.0, 700.0, 700.0, 700.0}, h0 = fill(800e3, Ns2), L = L2, D = 0.04, advection = false, hcCorr = 2, dpfCorr = 0.4, ntubes = 3, h(start = {871999.6875, 870017.0, 867699.0, 861464.0, 844586.0, 800057.0, 800057.0})) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss PerteChargeCondPompe1(K = 1e-6) annotation(
    Placement(transformation(origin = {171, -35}, extent = {{6, -10}, {-6, 10}}, rotation = 180)));
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss PerteChargeCondPompe2(K = 1e-6, rho(start = 999.099)) annotation(
    Placement(transformation(origin = {101, -36}, extent = {{6, -10}, {-6, 10}}, rotation = 180)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Constante Ouv(k = 0.5) annotation(
  ...
  ThermoSysPro.Fluid.Machines.StaticCentrifugalPump Pompe2(Pm(fixed = false), b2 = 510, b1 = -3500, hn(start = 350), adiabatic_compression = true, C1(P(fixed = false, start = 17e5), h_vol_2(start = 462620.0)), a3(fixed = true) = 500, C2(P(fixed = false, start = 24.5146e5)), p_rho = 900, Q(fixed = true, start = 7.2), a1(fixed = false) = -1e8) annotation(
    Placement(transformation(extent = {{-184, 129}, {-164, 149}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss PerteCharge_Huile_2(K = 1e-6, p_rho = 900) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.InvSingularPressureLoss invSingularPressureLoss annotation(
    Placement(transformation(extent = {{108, -106}, {122, -90}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss Dp_Cond_2(K = 1e-4, rho(start = 10), Q(start = 0.35), Pm(start = 5000.53), h(start = 2100e3)) annotation(
  ...
  ThermoSysPro.Fluid.Junctions.MassFlowMultiplier massFlowMultiplier(alpha = 3, P(start = 2300000)) annotation(
    Placement(transformation(extent = {{21, 128}, {37, 150}})));
  ThermoSysPro.Fluid.Junctions.MassFlowMultiplier massFlowMultiplier2(alpha = 1/3, P(start = 2400000)) annotation(
...
equation
  ...
  connect(Connection_HQ_Secheur_Ballon.C2, Ballon.Ce2) annotation(
    Line(points = {{-73, -25}, {-73, -71}}, color = {0, 0, 255}, thickness = 0.5));
  ...
  connect(TurbineMp.Cs, VolumeCond.Ce2) annotation(
    Line(points = {{131.13, 56}, {135.5, 56}, {135.5, 34}}, color = {255, 0, 0}, thickness = 0.5));
  ...
  connect(Dp_Re_1.C2, Re_1.Ev) annotation(
    Line(points = {{31.5, -19}, {31.5, -36}, {8.4, -36}, {8.4, -72.5}}, color = {255, 0, 0}, thickness = 0.5));
