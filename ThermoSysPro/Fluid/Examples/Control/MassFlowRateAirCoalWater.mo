...
model MassFlowRateAirCoalWater "MassFlowRateAirCoalWater"
  ...
  Units.SI.Power Welec(start = 804.461) "(MW)Electrical power produced by the generator";
  ...
  InstrumentationAndControl.Connectors.InputReal Electrical_power_MW annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = -90, origin = {-10, 96})));
  InstrumentationAndControl.Connectors.OutputReal Q_air annotation(
    Placement(transformation(origin = {110, -9}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ...
  InstrumentationAndControl.Connectors.OutputReal Q_water annotation(
    Placement(transformation(origin = {110, -89}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
equation
