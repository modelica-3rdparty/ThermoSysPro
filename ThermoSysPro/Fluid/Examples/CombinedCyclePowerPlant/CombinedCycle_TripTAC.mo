...
model CombinedCycle_TripTAC "CCPP model to simulate a load variation from 100% to 50%"
  parameter Real CstHP(fixed = false, start = 7921079.316566086) "Stodola's ellipse coefficient HP";
  parameter Real CstMP(fixed = false, start = 251309.80339850043) "Stodola's ellipse coefficient MP";
  parameter Real CstBP(fixed = false, start = 10675.291494903773) "Stodola's ellipse coefficient BP";
  ...
  ThermoSysPro.Fluid.Volumes.DynamicDrum BallonBP(Vertical = false, P0 = 5e5, Vv(fixed = false), L = 8, hl(fixed = false, start = 561432.6820300646), hv(fixed = false, start = 2682927.2097681486), R = 2, P(fixed = false, start = 536006.6647383622), zl(start = 1.75, fixed = true), Kpa = 5, Mp = 5000, Kvl = 1000, Pfond(start = 552000.8087452435), Tp(start = 409.09918124890646)) annotation(
    Placement(transformation(extent = {{585, 10}, {545, 50}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Constante constante_vanne_vapeurBP(k = 0.5) annotation(
    Placement(transformation(extent = {{633, 76}, {621, 86}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve vanne_vapeurBP(p_rho = 3, Cvmax = CvmaxValveVBP, C2(P(start = 509651.8053666252), h_vol_1(start = 2682927.2097681486)), h(start = 2685000), Cv(start = 1), Pm(start = 498000)) annotation(
    Placement(transformation(extent = {{525, 46}, {505, 66}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve vanne_alimentationBP(Cvmax = 285, C1(h_vol_2(start = 517521.1338868904)), h(fixed = false, start = 509000), Cv(start = 142.5), Pm(fixed = false, start = 1001940.4305634197)) annotation(
    Placement(transformation(extent = {{617, 44}, {597, 64}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss GainChargeBP(z2 = 0, z1 = 10.767, Q(start = 50, fixed = false), K = 32766, rho(start = 931.9744461081724), Pm(start = 564000), h(start = 549249.519022482), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(origin = {577, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ThermoSysPro.Fluid.Volumes.VolumeC VolumeEvapBP(h(start = 561432.682030064), V = 5, P(start = 564000), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{559, -100}, {539, -80}}, rotation = 0)));
  ThermoSysPro.Fluid.HeatExchangers.DynamicFlueGasesMultiFluidHeatExchanger EvaporateurBP(Dint = 32.8e-3, ExchangerWall(e = 2.6e-3, lambda = 47, dW1(start = {-1.24e7, -8.5e6, -5.8e6}), Tp(start = {431.3608522222893, 430.24126699702373, 429.39686929842486}), Tp1(start = {430.9104943759602, 429.93425668934924, 429.1871126238492})), L = 20.726, Ntubes = 984, Ns = 3, ExchangerFlueGasesMetal(Dext = 38e-3, step_T = 86.9e-3, Fa = 1, step_L = 138e-3, K(fixed = true, start = 30.62), CSailettes = 11.07985, p_rho = 1.14, Encras = Encras_EvBP, St = 5, deltaT(start = {45, 31, 21}), T2(start = {483.7066345214844, 465.9440370193418, 453.7982409323057, 445.483154296875}), T1(start = {474.8253385845301, 459.8711389758238, 449.6406958379268}), Tp(start = {431.7792768702483, 430.5265083466735, 429.59175290805825})), TwoPhaseFlowPipe(advection = false, rugosrel = 5e-6, z1 = 0, z2 = 10.767, continuous_flow_reversal = true, inertia = true, dW1(start = {1.24e7, 8.5e6, 5.8e6}), h(start = {561432.6875, 799363.0194709267, 961560.8510406071, 1072378.2305328134, 561432.6875}), hb(start = {550075.0, 765243.011613326, 912673.256542569, 1013555.73710231}), Q(start = {49.81331881379377, 49.81331881379377, 49.81331881379377, 49.81331881379377}), P(start = {563167.375, 538556.7569255093, 537410.7752779912, 536682.3739734262, 536006.6875}))) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.ControlValve Vanne_alimentationMPHP(Cvmax = 308.931, C1(h_vol_2(start = 561432.6820300646)), h(start = 550000), Cv(start = 308.931), Pm(start = 454319.5384961263), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SinkP PuitsFumees(P0 = 1.013e5) annotation(
  ...
  ThermoSysPro.Fluid.HeatExchangers.DynamicFlueGasesMultiFluidHeatExchanger EconomiseurBP(Ns = 3, Dint = 32.8e-3, ExchangerWall(e = 2.6e-3, lambda = 47, dW1(start = {-2.45e7, -5.5e6, -1.17e6}), Tp(start = {402.39147626030376, 398.05961040088295, 397.171667377241}), Tp1(start = {402.1199525074059, 397.9993065179613, 397.15885396154556})), Ntubes = 3444, L = 20.726, Cws1(h_vol_2(start = 194669.37425632242)), Cws2(h_vol_1(start = 517521.1338868904)), ExchangerFlueGasesMetal(step_T = 86.9e-3, Fa = 1, Dext = 38e-3, step_L = 92e-3, K(fixed = true, start = 31.53), CSailettes = 11.673758598919, p_rho = 1.15, Encras = Encras_EBP, St = 5, deltaT(start = {23.5, 5.3, 1.1}), T2(start = {445.483154296875, 407.64728846356843, 399.20963445670407, 397.4152526855469}), T1(start = {426.56521960355815, 403.42846146013625, 398.31244500376624}), Tp(start = {402.64374727467464, 398.11563835995787, 397.18357224132967})), TwoPhaseFlowPipe(advection = false, rugosrel = 5e-6, z1 = 0, z2 = 10.767, inertia = true, dW1(start = {2.45e7, 5.5e6, 1.17e6}), h(start = {194669.375, 449026.540992922, 505517.82265620184, 517521.1338868904, 517521.125}), hb(start = {194584.515625, 462556.370989432, 494648.45288738, 501287.069880104}), P(start = {1578579.375, 1542823.2506358635, 1517636.5908885582, 1492724.792065889, 1467874.25}))) annotation(
    Placement(transformation(origin = {647, -50}, extent = {{-20, -20}, {20, 20}}, rotation = 90)));
  ThermoSysPro.Fluid.Machines.StodolaTurbine TurbineHP(W_fric = 1, eta_stato = 1, eta_is(start = 0.88057), Qmax = 140, eta_is_nom = 0.88057, eta_is_min = 0.75, Cst(start = 8182844.56002535) = CstHP, pros(d(start = 10.66670150764929)), Hrs(start = 3046003.380872726), Pe(fixed = true, start = 12431000), Ps(fixed = false, start = 2726700)) annotation(
    Placement(transformation(extent = {{-35, -250}, {5, -210}}, rotation = 0)));
  ThermoSysPro.Fluid.Machines.StodolaTurbine TurbineMP(W_fric = 1, eta_stato = 1, eta_is(start = 0.9625), Qmax = 150, eta_is_nom = 0.9625, eta_is_min = 0.75, Cst(start = 256335.364995961) = CstMP, pros(d(start = 1.883484197675123)), Hrs(start = 3029367.6706168973), Pe(fixed = true, start = 2548500), Ps(fixed = false, start = 476800)) annotation(
    Placement(transformation(extent = {{285, -250}, {325, -210}}, rotation = 0)));
  ThermoSysPro.Fluid.Volumes.VolumeC MelangeurPostTMP1(h(start = 3018320.043117248), P(start = 476799.99999954), Ce1(h(start = 3029780))) annotation(
    Placement(transformation(origin = {385, -230}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.Fluid.Machines.StodolaTurbine TurbineBP(W_fric = 1, eta_stato = 1, eta_is(start = 0.9538), Qmax = 150, eta_is_nom = 0.9538, eta_is_min = 0.75, Cst(start = 11944.9445735985) = CstBP, Cs(h(start = 2401478.8015108025)), Hrs(start = 2401030), Pe(fixed = true, start = 476799.99999954), Ps(start = 10053)) annotation(
    Placement(transformation(extent = {{543, -250}, {583, -210}}, rotation = 0)));
  ThermoSysPro.Fluid.Junctions.MassFlowMultiplier DoubleDebitHP(alpha = 2) annotation(
    Placement(transformation(origin = {-325, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  ThermoSysPro.Fluid.Junctions.MassFlowMultiplier DoubleDebitMP(alpha = 2) annotation(
    Placement(transformation(origin = {-265, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  ThermoSysPro.Fluid.Junctions.MassFlowMultiplier MoitieDebitHP(alpha = 0.5, Ce(h(start = 3046260)), P(start = 2726700)) annotation(
    Placement(transformation(extent = {{81, -180}, {101, -160}}, rotation = 0)));
  ThermoSysPro.Fluid.HeatExchangers.SimpleDynamicCondenser Condenseur(D = 0.018, V = 1000, A = 100, lambda = 0.01, ntubes = 28700, continuous_flow_reversal = true, Vf0 = 0.15, steady_state = false, yNiveau(signal(start = 1.5)), Cse(h(start = 128076)), P(fixed = false, start = 6136), Pfond(start = 10000.0), Cl(h(start = 191812.29519356362)), proe(d(start = 996.0227362797892))) annotation(
    Placement(transformation(extent = {{604, -384}, {684, -304}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ SourceCaloporteur(h0 = 113.38e3, Q0 = 29804.5) annotation(
    Placement(transformation(extent = {{539, -377}, {587, -329}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SinkP PuitsCaloporteur annotation(
    Placement(transformation(extent = {{703, -374}, {747, -330}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss perteChargeK1(K = 1e-4, h(start = 2400000), C1(h_vol_2(start = 2400000), h(start = 2400000)), Pm(start = 10026.138683139128)) annotation(
    Placement(transformation(extent = {{607, -240}, {627, -220}}, rotation = 0)));
  ThermoSysPro.Fluid.Volumes.VolumeC VolumeCond1(Ce3(h(start = 194669.37425631672)), h(start = 194669.37425632242), P(start = 1540500), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(origin = {869, -318}, extent = {{10, -10}, {-10, 10}}, rotation = 270)));
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss perteChargeKCond1(K = 1e-4, rho(start = 990.3699122081223), Pm(start = 1540000)) annotation(
    Placement(transformation(origin = {869, -270}, extent = {{12, -12}, {-12, 12}}, rotation = 270)));
  ThermoSysPro.Fluid.Volumes.VolumeA VolumeAlimMPHP(h(start = 561432.6820300613), P(start = 322430), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss perteChargeK3(K = 1e-4, Pm(start = 372632.41194491077), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(origin = {747, -50}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss perteChargeK8(K = 1e-4, Pm(start = 372632.41224549303), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss perteChargeK(K = 1e-4, C1(h_vol_2(start = 191812.29519356362)), C2(h_vol_1(start = 191812.29519356362)), rho(start = 989.8383588386666), Pm(start = 6200), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{669, -446}, {689, -426}}, rotation = 0)));
  ThermoSysPro.Fluid.Machines.StaticCentrifugalPump PompeAlimBP(Qv(start = 0.19861699733512259), a3 = 400, a1(fixed = true) = -6000, Q(start = 194.502, fixed = false), C2(h_vol_1(start = 194669.37425631672)), Pm(start = 802830.7060548771), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{709, -446}, {729, -426}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss perteChargeK2(K = 1e-4, rho(start = 990.3699122094005), C1(h_vol_2(start = 194669.37425631672), h(start = 194585)), Pm(start = 1546000), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{807, -446}, {827, -426}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve vanne_extraction(Cvmax = 2000, h(start = 194500), Cv(start = 2000), Pm(start = 1587120.4167526974), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{769, -440}, {789, -420}}, rotation = 0)));
  ThermoSysPro.Fluid.Sensors.SensorQ CapteurDebitVapHP(C1(h_vol_2(start = 2674000), h(start = 2674000))) annotation(
    Placement(transformation(origin = {-91, 8}, extent = {{-6, 6}, {6, -6}}, rotation = 270)));
  ThermoSysPro.Fluid.Sensors.SensorQ CapteurDebitEauHP(C2(h_vol_1(start = 1398000), h(start = 1398000))) " " annotation(
    Placement(transformation(origin = {58.5, 32}, extent = {{6, -6.5}, {-6, 6.5}}, rotation = 270)));
  ThermoSysPro.Fluid.Sensors.SensorQ CapteurDebitEauMP(C2(h_vol_1(start = 944000), h(start = 944000))) annotation(
    Placement(transformation(extent = {{391, 49}, {376, 63}}, rotation = 0)));
  ThermoSysPro.Fluid.Sensors.SensorQ CapteurDebitVapMP(C1(h_vol_2(start = 2798000), h(start = 2798000))) annotation(
    Placement(transformation(origin = {203, 56}, extent = {{-8, 8}, {8, -8}}, rotation = 180)));
  ...
  ThermoSysPro.Fluid.Sensors.SensorQ CapteurDebitVapCondenseur(C2(h_vol_1(start = 2401000), h(start = 2401000))) annotation(
    Placement(transformation(origin = {651.5, -264}, extent = {{-10, -6.5}, {10, 6.5}}, rotation = 270)));
  ThermoSysPro.Fluid.PressureLosses.PipePressureLoss lumpedStraightPipeK2(K = Kin_SMP2, Pm(start = 2651000), C1(P(fixed = true, start = 2726700), h_vol_2(start = 3046000), h(start = 3046000))) annotation(
    Placement(transformation(extent = {{81, -120}, {61, -100}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve vanne_entree_TurbineHP(C1(P(fixed = true, start = 12680999.9999969)), Cvmax = Cvmax_THP, h(fixed = false, start = 3433000), Cv(start = 10875), Pm(fixed = false, start = 12550000)) annotation(
    Placement(transformation(extent = {{-157, -234}, {-137, -214}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Constante ConsigneNiveauEauHP(k = 1.05) annotation(
    Placement(transformation(extent = {{-191, 113}, {-157, 131}}, rotation = 0)));
  ThermoSysPro.Examples.Control.Drum_LevelControl regulation_Niveau_HP(pIsat(Ti = 500, Limiteur1(u(signal(start = 0.8)))), add(k1 = -1, k2 = +1), Ti = 500, minval = 0.007) annotation(
    Placement(transformation(extent = {{-73, 106}, {-53, 126}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Constante ConsigneNiveauEauMP(k = 1.05) annotation(
    Placement(transformation(extent = {{140, 113}, {174, 131}}, rotation = 0)));
  ThermoSysPro.Examples.Control.Drum_LevelControl regulation_Niveau_MP(pIsat(Ti = 500, Limiteur1(u(signal(start = 0.8)))), add(k1 = -1, k2 = +1), Ti = 500) annotation(
    Placement(transformation(extent = {{229, 106}, {249, 126}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Constante ConsigneNiveauEauBP(k = 1.75) annotation(
    Placement(transformation(extent = {{437, 126}, {471, 144}}, rotation = 0)));
  ThermoSysPro.Examples.Control.Drum_LevelControl regulation_Niveau_BP(add(k1 = -1, k2 = +1), pIsat(Ti = 500, Limiteur1(u(signal(start = 0.8)))), Ti = 10, minval = 0.006) annotation(
    Placement(transformation(extent = {{535, 108}, {555, 128}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Constante ConsigneNiveauCondenseur1(k = 1.5) annotation(
    Placement(transformation(extent = {{683, -246}, {707, -230}}, rotation = 0)));
  ThermoSysPro.Examples.Control.Condenser_LevelControl regulation_Niveau_Condenseur(pIsat(Ti = 500, Limiteur1(u(signal(start = 0.8)))), add(k1 = +1, k2 = -1), edge(uL(signal(start = true)))) annotation(
    Placement(transformation(extent = {{725, -282}, {745, -262}}, rotation = 0)));
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Rampe arretPomesMp(Initialvalue = 1400, Duration = 1000, Starttime = 4000, Finalvalue = 1000) annotation(
    Placement(transformation(extent = {{911, -42}, {873, -10}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Rampe arretPomesHP(Initialvalue = 1400, Starttime = 4000, Duration = 1000, Finalvalue = 700) annotation(
    Placement(transformation(extent = {{912, -96}, {874, -64}}, rotation = 0)));
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Rampe arretPomesBP(Initialvalue = 1400, Finalvalue = 1000, Duration = 1000, Starttime = 200000) annotation(
    Placement(transformation(extent = {{912, -458}, {874, -426}}, rotation = 0)));
  ThermoSysPro.Fluid.Volumes.VolumeC VolumeECO_HP1_2(V = 1, h0 = 988332, h(start = 860655.3510813401), dynamic_mass_balance = true, P0 = 7010000, P(start = 13149153.870557636), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{423, -98}, {403, -78}}, rotation = 0)));
  ThermoSysPro.Fluid.Volumes.VolumeC VolumeECO_HP2_3(V = 1, h0 = 983786, h(start = 989834.8113335292), dynamic_mass_balance = true, P0 = 7000000, P(start = 13239005.657249678), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{219, -20}, {199, 0}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve Vanne_alimentationMPHP1(Cvmax = 308.931, h(start = 618600), Cv(start = 308.931), Pm(start = 13150193.68579806), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
    Placement(transformation(extent = {{721, -98}, {697, -122}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve Vanne_alimentationMPHP2(Cvmax = 308.931, h(start = 565000), Cv(start = 308.931), Pm(start = 3163391.8442005403), region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_1) annotation(
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Sources.Rampe arretPomesHP1(Initialvalue = 0.8, Duration = 1000, Starttime = 3000, Finalvalue = 0.005) annotation(
    Placement(transformation(extent = {{913, -194}, {875, -162}}, rotation = 0)));
  ThermoSysPro.Fluid.Volumes.VolumeD VolumePreTHP(h0 = 3e6, h(start = 3432930.9918569606), dynamic_mass_balance = true, P0 = 12700000, P(start = 12700000)) annotation(
    Placement(transformation(origin = {-85, -230}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.Fluid.Volumes.VolumeC MelangeurPreTMP(h0 = 3523910, h(start = 3517381.1285518324), dynamic_mass_balance = true, P0 = 2400000, P(start = 2400000)) annotation(
    Placement(transformation(origin = {-83, -314}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve vanne_entree_TurbineMP(C1(P(fixed = true, start = 25.486e5)), Cvmax = Cvmax_TMP, h(fixed = false, start = 3518000), Cv(start = 3.312e6), Pm(fixed = false, start = 2547000)) annotation(
    Placement(transformation(extent = {{-157, -318}, {-137, -298}}, rotation = 0)));
