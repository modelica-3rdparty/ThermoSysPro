...
model TestVolumeATh_vectorPorts
...
equation
  ...
  connect(volumeTh.Cs[1], controlValve2.C1)
    annotation (Line(points={{10,6},{28,6}}, color={0,0,0}));
  connect(lumpedStraightPipe1.C2, volumeTh.Ce[1]) annotation (Line(points={{-27,
          6},{-18,6},{-18,5.75},{-10,5.75}}, color={0,0,0}));
  connect(controlValve1.C2, volumeTh.Ce[2]) annotation (Line(points={{-27,-54},
          {-20,-54},{-20,6.25},{-10,6.25}}, color={0,0,0}));
