...
model TestStodolaTurbine2
  ThermoSysPro.Fluid.Machines.StodolaTurbine stodolaTurbine(Ce(h(start = 3000000.0))) annotation(
    Placement(transformation(extent = {{-60, 60}, {-40, 80}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SinkP puitsP(P0 = 5000) annotation(
    Placement(transformation(extent = {{-20, 60}, {0, 80}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceP(h0 = 3.e6, option_temperature = false, P0 = 300000, region = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.IF97Region.Region_2) annotation(
