...
model TestStaticDrum2
  ...
  ThermoSysPro.Fluid.Sensors.SensorT sensorT annotation(
    Placement(transformation(extent = {{-40, -82}, {-20, -62}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ sourcePQ(P0 = 100e5) annotation(
...
equation
  connect(singularPressureLossVALI2.C2, StaticDrumTh1.Ce_eco) annotation(
    Line(points = {{-60, -40}, {-48, -40}, {-48, 0.6}}, color = {0, 0, 255}));
  ...
  connect(sensorT.C2, singularPressureLossVALI2.C1) annotation(
    Line(points = {{-19.8, -80}, {-10, -80}, {-10, -54}, {-80, -54}, {-80, -40}}, color = {0, 0, 255}));
  connect(sourcePQ.C, sensorT.C1) annotation(
    Line(points = {{-70, -80}, {-40, -80}}, color = {0, 0, 255}));
