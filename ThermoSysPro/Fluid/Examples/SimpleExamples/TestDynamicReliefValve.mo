...
model TestDynamicReliefValve
  ...
  ThermoSysPro.Fluid.PressureLosses.LumpedStraightPipe pipe(Q(start = 0), Pm(start = Pinitial), L = 2, D = 0.2) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.Bend bend(R0 = 0.2, D = pipe.D) annotation(
    Placement(transformation(extent = {{0, -20}, {20, -40}})));
  ThermoSysPro.Fluid.PressureLosses.Diaphragm diaphragm(Ouv = 1, D = 0.5) annotation(
