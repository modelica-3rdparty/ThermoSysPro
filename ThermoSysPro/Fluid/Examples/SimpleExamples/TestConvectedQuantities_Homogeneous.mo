...
model TestConvectedQuantities_Homogeneous
  ...
  import C =  ThermoSysPro.ConvectedQuantities.Substances.HomogeneousSubstance.Concentrations;
...
end TestConvectedQuantities_Homogeneous;
