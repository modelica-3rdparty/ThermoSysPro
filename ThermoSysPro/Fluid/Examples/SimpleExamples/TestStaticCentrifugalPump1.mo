...
model TestStaticCentrifugalPump1
  ThermoSysPro.Fluid.Machines.StaticCentrifugalPump StaticCentrifugalPump1(fixed_rot_or_power = 2, MPower = 0.15e6) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SinkP sinkP(P0 = 600000) annotation(
