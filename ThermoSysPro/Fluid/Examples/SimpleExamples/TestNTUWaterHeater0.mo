...
model TestNTUWaterHeater0
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ Source_condenseur(P0 = 80.0e5, Q0 = 1780, h0 = 872.0e3) annotation(
    Placement(transformation(extent = {{-182, -10}, {-162, 10}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.Sink Puit_condenseur(C(h(start = 980281.0129225359))) annotation(
    Placement(transformation(extent = {{152, -10}, {172, 10}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceP(option_temperature = false, P0 = 27.e5, h0 = 2.6e6, C(h_vol_2(start = 883556.9736276601)), Q(start = 112.29047515166533)) annotation(
    Placement(transformation(extent = {{-182, 90}, {-162, 110}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss singularPressureLoss2(K = 1e-4, C2(P(start = 7999999.633732218))) annotation(
    Placement(transformation(extent = {{-106, -10}, {-86, 10}}, rotation = 0)));
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss singularPressureLoss3(K = 1e-4) annotation(
    Placement(transformation(extent = {{-106, 90}, {-86, 110}}, rotation = 0)));
...
equation
  ...
  connect(sourceP.C, singularPressureLoss3.C1) annotation(
    Line(points = {{-162, 100}, {-106, 100}}, color = {0, 0, 255}));
