...
model TestJunctions1
  ThermoSysPro.Fluid.Junctions.Splitter2 splitter2 annotation(
    Placement(transformation(extent = {{-20, 40}, {0, 60}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceP(Q0 = 200) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.Sink sinkP annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceP1(Q0 = 400) annotation(
...
equation
  ...
  connect(splitter3.Cs3, singularPressureLoss6.C1) annotation(
    Line(points = {{0, -50}, {40, -50}}, color = {0, 0, 0}));
  connect(singularPressureLoss6.C2, sinkP4.C) annotation(
    Line(points = {{60, -50}, {80, -50}}, color = {0, 0, 0}));
  annotation(
