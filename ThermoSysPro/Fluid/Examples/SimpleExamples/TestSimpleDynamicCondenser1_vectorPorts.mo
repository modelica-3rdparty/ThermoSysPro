...
model TestSimpleDynamicCondenser1_vectorPorts
...
equation
  ...
  connect(volumeTh.Ce[1], staticCentrifugalPump.C2)
    annotation (Line(points={{-60,-10},{-60,-60},{-20,-60}}, color={0,0,0}));
  connect(volumeTh.Cs[1], stodolaTurbine.Ce)
    annotation (Line(points={{-60,10},{-60,60},{-20.1,60}}, color={0,0,0}));
  connect(heatSource.C[1], volumeTh.Cth) annotation (Line(points={{-78.2,12},{
          -74,12},{-74,0},{-60,0}}, color={0,0,0}));
...
end TestSimpleDynamicCondenser1_vectorPorts;
