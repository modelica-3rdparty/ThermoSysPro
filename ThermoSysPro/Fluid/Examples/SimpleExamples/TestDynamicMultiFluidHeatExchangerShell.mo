...
equation
  connect(sourceP.C, dynamicMultiFluidHeatExchangerShell.Cws1) annotation(
    Line(points = {{-40, 30}, {-20, 30}}, color = {0, 0, 0}));
  connect(dynamicMultiFluidHeatExchangerShell.Cws2, sinkP.C) annotation(
    Line(points = {{0, 30}, {20, 30}}, color = {0, 0, 0}));
  connect(sourceP1.C, dynamicMultiFluidHeatExchangerShell.Cfg1) annotation(
    Line(points = {{-10, 60}, {-10, 35}}, color = {0, 0, 0}));
  connect(dynamicMultiFluidHeatExchangerShell.Cfg2, sinkP1.C) annotation(
