...
model TestVolume_vectorPorts
  ...
  PressureLosses.ControlValve controlValve1(C2(P(start=200002.52)),Pm(start=201722.05301761828))
  ...
  Volumes.Volume volume(
    ...
    continuous_flow_reversal=true,
    diffusion=true,
    P(start=200002.5108577, displayUnit="bar"),
    nInletPorts=2,
    nOutletPorts=1,
    Cs(each Q(start=-4.6367791499652465E-36)))
...
equation
  ...
  connect(controlValve1.C2, volume.Ce[1]) annotation (Line(points={{-20,0},{-16,
          0},{-16,-0.25},{-10,-0.25}}, color={0,0,0}));
  connect(controlValve2.C2, volume.Ce[2])
    annotation (Line(points={{-20,50},{-10,50},{-10,0.25}}, color={0,0,0}));
  connect(volume.Cs[1], controlValve3.C1)
