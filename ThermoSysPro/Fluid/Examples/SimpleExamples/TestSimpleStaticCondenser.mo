...
model TestSimpleStaticCondenser
  ThermoSysPro.Fluid.HeatExchangers.SimpleStaticCondenser simpleStaticCondenser(Ec(h(start = 532983.7176868258)), Ef(h(start = 71016.12237181116)), Qc(start = 1049.6385508765125), Qf(start = 4469.84281279143), Sf(h(start = 64330.208038325145))) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceP1(T0 = 400) annotation(
