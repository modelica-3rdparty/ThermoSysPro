...
model TestSwitchValve
  ...
  ThermoSysPro.InstrumentationAndControl.Blocks.Logique.Constante constante annotation (Placement(transformation(extent={{-78,32},{-58,52}})));
equation
  ...
  connect(constante.yL, switchValve.Ouv) annotation (Line(points={{-57,42},{0,42},{0,13.2}}, color={0,0,255}));
