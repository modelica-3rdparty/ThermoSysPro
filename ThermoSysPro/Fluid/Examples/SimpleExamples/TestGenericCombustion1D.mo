...
model TestGenericCombustion1D
  ...
  ThermoSysPro.Fluid.Combustion.CombustionChambers.GenericCombustion1D genericCombustionCCS(NCEL = 7, Qm(fixed = false), Qsf(fixed = false), kcham(fixed = true) = 0.1, Acham = 275, Xbf = 0, ImbCV = 0.05, EPSPAR = 0.7, Kec = 8.8, SM = {639.92, 198.58, 466.48, 466.48, 466.48, 358.56, 358.56}, ImbBF = 0.0, Psf(start = 113275)) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ sourceAir(Xso2 = 0, Q0 = 609.29, Xh2o = 0.01, Xo2 = 0.230, Xco2 = 0, P0 = 191000, T0 = 524.89, option_temperature = true, ftype = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.FluidType.FlueGases) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ SourcePQ_Water(Q0 = 0, P0 = 100000) annotation(
    Placement(transformation(extent = {{-107, 23}, {-71, 57}}, rotation = 0)));
  ThermoSysPro.Fluid.HeatExchangers.DynamicTwoPhaseFlowPipe PipeWaterSteam(Ns = 7, z2 = 56, rugosrel = 5e-5, ntubes = 403, L = 58, D = 0.0327, C2(Q(fixed = false, start = 486.69), P(fixed = false, start = 1.96318e+07, displayUnit = "Pa")), dpfCorr = 3.5) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SinkP sinkWaterSteam2(option_temperature = false, Q(start = 486.69, fixed = true), h0 = 2.5e+06, P0(fixed = false) = 19621600) annotation(
    Placement(transformation(origin = {90, 90.5}, extent = {{14.5, -15}, {-14.5, 15}}, rotation = 270)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceEcrans(h0 = 1.292e+06, option_temperature = false, P0 = 20112000) annotation(
