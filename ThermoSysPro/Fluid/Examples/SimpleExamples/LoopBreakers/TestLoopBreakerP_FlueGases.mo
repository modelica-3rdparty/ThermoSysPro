...
model TestLoopBreakerP_FlueGases
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ sourcePQ(
    ...
    SubC0={3}) annotation (Placement(transformation(extent={{-100,0},{-80,20}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.Junctions.Splitter2 splitter2_1(redeclare replaceable package Medium = Medium, h(start=2.83057e6)) annotation (Placement(transformation(extent={{-56,0},{-36,20}}, rotation=0)));
  ThermoSysPro.Fluid.Junctions.Mixer2 mixer2_1(redeclare replaceable package Medium = Medium, h(start=2.83057e6)) annotation (Placement(transformation(extent={{40,0},{60,20}}, rotation=0)));
...
end TestLoopBreakerP_FlueGases;
