...
model TestStaticCondenser
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SinkP Puit_condenseur annotation(
    Placement(transformation(extent = {{160, 0}, {180, 20}}, rotation = 0)));
  ThermoSysPro.Fluid.HeatExchangers.StaticCondenser condenseur(CPCE = 0, KCO = 100, QC0 = 200, z = 5, SCO = 15e3, Qee(start = 4000, fixed = false), Pcond(fixed = false, start = 2154.77)) annotation(
  ...
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss singularPressureLoss2(K = 1e-4) annotation(
