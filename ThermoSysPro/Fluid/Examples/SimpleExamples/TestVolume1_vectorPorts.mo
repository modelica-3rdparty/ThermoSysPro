...
equation
  ...
  connect(singularPressureLoss1.C2, volume.Ce[1]) annotation (Line(points={{-40,-30},
          {-20,-30},{-20,-0.25},{-10,-0.25}},      color={0,0,0}));
  connect(singularPressureLoss.C2, volume.Ce[2]) annotation (Line(points={{-40,30},
          {-20,30},{-20,0.25},{-10,0.25}}, color={0,0,0}));
  connect(volume.Cs[1], singularPressureLoss3.C1) annotation (Line(points={{10,
          -0.25},{20,-0.25},{20,-30},{40,-30}},
                                         color={0,0,0}));
  connect(volume.Cs[2], singularPressureLoss2.C1) annotation (Line(points={{10,0.25},
          {20,0.25},{20,30},{40,30}}, color={0,0,0}));
