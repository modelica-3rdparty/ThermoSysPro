...
model TestMixer3_Traces
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceQ(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-86,-10},{-66,10}}, rotation=0)));
equation
