...
model TestSplitter2
  ...
  ThermoSysPro.Fluid.Junctions.Splitter2 splitter2(redeclare replaceable package Medium = Medium) annotation (Placement(transformation(extent={{-20,-10},{0,10}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceP(redeclare replaceable package Medium = Medium, Q0=200)                                                                                                 annotation (Placement(transformation(extent={{-100,-10},{-80,10}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.Sink sinkP(redeclare replaceable package Medium = Medium) annotation (Placement(transformation(extent={{80,30},{100,50}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.SinkP sinkP1(redeclare replaceable package Medium = Medium) annotation (Placement(transformation(extent={{80,-50},{100,-30}}, rotation=0)));
