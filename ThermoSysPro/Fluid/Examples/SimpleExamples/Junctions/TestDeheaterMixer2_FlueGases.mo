...
model TestDeheaterMixer2_FlueGases
  extends ThermoSysPro.UsersGuide.Icons.Example;

  replaceable package Medium = Properties.Media.FlueGases;
  ThermoSysPro.Fluid.Junctions.DeheaterMixer2 deheaterMixer2_1(redeclare package Medium = Medium,
    Tmax=308,
    h(start=2.83057e6))                                                                                     annotation (Placement(transformation(extent={{-10,-16},{10,4}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.PressureLosses.SingularPressureLoss singularPressureLoss2(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-50,-50},{-30,-30}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceP(redeclare package Medium = Medium,
    P0=4500000,
    T0=573.15)                                                                                     annotation (Placement(transformation(extent={{-90,-10},{-70,10}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.Source source(redeclare package Medium = Medium,
    h0=2.5e6,
    option_temperature=false)                                                                      annotation (Placement(transformation(extent={{-90,-50},{-70,-30}}, rotation=0)));
equation
...
end TestDeheaterMixer2_FlueGases;
