...
model TestSplitter3_FlueGases
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceP1(redeclare package Medium = Medium, Q0=100,
    T0=573.15,
    option_temperature=true)                                                                        annotation (Placement(transformation(extent={{-96,-10},{-76,10}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.Sink sinkP2(redeclare package Medium = Medium, h0=2830566)
                                                                                       annotation (Placement(transformation(extent={{84,30},{104,50}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.Sink sinkP3(redeclare package Medium = Medium, h0=2830566)
                                                                                       annotation (Placement(transformation(extent={{84,-50},{104,-30}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SinkP sinkP4(redeclare package Medium = Medium,
    P0=4500000,
    T0=573.15)                                                                          annotation (Placement(transformation(extent={{84,-10},{104,10}}, rotation=0)));
