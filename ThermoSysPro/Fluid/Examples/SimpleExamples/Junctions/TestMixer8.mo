...
model TestMixer8
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceP(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-104,0},{-84,20}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceP1(
    redeclare package Medium = Medium,
    P0=2e5,
    Q(start=323.48244470861454)) annotation (Placement(transformation(extent={{-104,-60},{-84,-40}}, rotation=0)));
  ThermoSysPro.Fluid.PressureLosses.ControlValve valve1(
    redeclare package Medium = Medium,
    C1(h_vol_2(start=71016.12237181116)),
    C2(h_vol_2(start=70977.89042837733)),
  ...
  ThermoSysPro.Fluid.PressureLosses.ControlValve valve2(
    redeclare package Medium = Medium,
    C1(h_vol_2(start=70921.01678153824)),
  ...
  ThermoSysPro.Fluid.PressureLosses.ControlValve valve3(
    redeclare package Medium = Medium,
    Q(start=804.6933031325926),
    Pm(start=108776.21727782265)) annotation (Placement(transformation(extent={{50,-24},{70,-4}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.PressureLosses.LumpedStraightPipe pipe1(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-80,0},{-60,20}}, rotation=0)));
  ThermoSysPro.Fluid.PressureLosses.LumpedStraightPipe pipe2(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-80,-60},{-60,-40}}, rotation=0)));
