...
equation
  connect(volumeI.Cs3, sink.C) annotation (Line(points={{10,-8},{20,-8},{20,0},{30,0}}, color={0,0,0}));
  connect(sourcePQ.C, volumeI.Ce2) annotation (Line(points={{-32,0},{-10,0}}, color={0,0,0}));
