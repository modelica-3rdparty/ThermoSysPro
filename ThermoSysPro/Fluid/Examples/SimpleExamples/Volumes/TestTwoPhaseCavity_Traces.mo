...
model TestTwoPhaseCavity_Traces
  ...
  ThermoSysPro.Fluid.Volumes.TwoPhaseCavity cavity(
    ...
    Cal_hconv=false,
    SubCl0={0},
    SubCv0={0})  annotation (Placement(transformation(extent={{-20,-20},{40,40}}, rotation=0)));

  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceWater(
    redeclare package Medium = Medium,
    Q0=1,
    h0=1454400,
    SubC0={0}) annotation (Placement(transformation(extent={{-90,20},{-70,40}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceSteam(
    redeclare package Medium = Medium,
    Q0=1,
    h0=2.8e6,
    SubC0={10}) annotation (Placement(transformation(extent={{-60,50},{-40,70}}, rotation=0)));
  ...
  Thermal.BoundaryConditions.HeatSource              heatSource3a(
    T0={293.15,293.15},
    option_temperature=2,
    W0={1e5,1e5})
              annotation (Placement(transformation(extent={{68,56},{88,76}}, rotation=0)));
equation
  ...
  connect(heatSource2.C, cavity.Cth2) annotation (Line(points={{80,0.2},{42,0.2},{42,25.1},{10.1667,25.1}},
                                                                                                         color={255,0,0}));
  connect(cavity.Cth3, heatSource3a.C) annotation (Line(points={{10.1667,10.6},{64,10.6},{64,52},{78,52},{78,56.2}}, color={255,0,0}));
  annotation (
    experiment(StopTime=1000),
    Icon(coordinateSystem(preserveAspectRatio=false)),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,-100},{120,80}})));
end TestTwoPhaseCavity_Traces;
