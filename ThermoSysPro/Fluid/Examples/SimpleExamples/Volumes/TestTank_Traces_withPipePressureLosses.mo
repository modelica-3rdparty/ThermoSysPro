...
model TestTank_Traces_withPipePressureLosses
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP SourceP1(redeclare package Medium = Medium, SubC0={0.3})
...
equation
  ...
  connect(Tank1.Cs2, PerteDP1.C1) annotation (Line(points={{10,-6},{20,-6},{20,-40},{30,-40}}, color={0,0,255}));
  connect(Rampe1.y, VanneReglante1.Ouv) annotation (Line(points={{-69,40},{-40,40},{-40,23}}));
  connect(VanneReglante1.C2, Tank1.Ce1) annotation (Line(points={{-30,6},{-20,6},{-10,6}}, color={0,0,255}));
  connect(Tank1.Cs1, PerteDP2.C1) annotation (Line(points={{10.2,6},{20,6},{30,6}}, color={0,0,255}));
  connect(PerteDP2.C2, PuitsP2.C) annotation (Line(points={{50,6},{50,6},{70,6}}, color={0,0,255}));
  annotation (
...
end TestTank_Traces_withPipePressureLosses;
