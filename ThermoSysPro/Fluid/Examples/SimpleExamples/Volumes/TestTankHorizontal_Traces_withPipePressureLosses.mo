...
model TestTankHorizontal_Traces_withPipePressureLosses
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP SourceP1(redeclare package Medium = Medium, SubC0={0.3}) annotation (Placement(transformation(extent={{-90,-4},{-70,16}}, rotation=0)));
...
end TestTankHorizontal_Traces_withPipePressureLosses;
