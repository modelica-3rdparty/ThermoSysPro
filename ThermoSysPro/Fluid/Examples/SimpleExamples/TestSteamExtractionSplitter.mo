...
model TestSteamExtractionSplitter
  ThermoSysPro.Fluid.Junctions.SteamExtractionSplitter steamExtractionSplitter(alpha = 0.9) annotation(
    Placement(transformation(extent = {{-20, 20}, {0, 40}}, rotation = 0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceQ(h0 = 2600000) annotation(
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SinkQ sink(Q0 = 10) annotation(
