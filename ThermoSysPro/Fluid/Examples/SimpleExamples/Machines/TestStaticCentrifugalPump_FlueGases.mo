...
model TestStaticCentrifugalPump_FlueGases
  ...
  ThermoSysPro.Fluid.Machines.StaticCentrifugalPump staticCentrifugalPump(redeclare replaceable package Medium = Medium) annotation (Placement(transformation(extent={{-6,-10},{14,10}})));
...
equation
  connect(staticCentrifugalPump.C2, sink.C) annotation (Line(points={{14,0},{30,0}}, color={0,0,0}));
  connect(staticCentrifugalPump.C1, sourcePQ.C) annotation (Line(points={{-6,0},{-30,0}}, color={0,0,0}));
