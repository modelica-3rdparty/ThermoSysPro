...
model TestStaticWallFlueGasesExchanger_FlueGases
  ...
  ThermoSysPro.Fluid.HeatExchangers.StaticWallFlueGasesExchanger exchanger(
    ...
    DPc=1e-4,
    Tp0=500,
    C1(P(start=4500000), h(start=2879115.64844), Q(start=10), Xi(start={0.1,0.2,0.3,0.2,0.2})),
    C2(P(start=4450000), h(start=2820000), Q(start=10), Xi(start={0.1,0.2,0.3,0.2,0.2})),
...
end TestStaticWallFlueGasesExchanger_FlueGases;
