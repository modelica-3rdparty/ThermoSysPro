...
model TestDynamicOnePhaseFlowShell_Traces
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourceP(redeclare package Medium = Medium, SubC0={0.1,0.2,0.3}) annotation (Placement(transformation(extent={{-50,-10},{-30,10}}, rotation=0)));
...
end TestDynamicOnePhaseFlowShell_Traces;
