...
model TestNTUWaterHeater_Traces
  ...
  replaceable package Medium_c = Properties.Media.WaterSteam(
      extraPropertiesNames={"Trace4","Trace5","Trace6"},
      C_nominal={0.3,0.4,0.5},
      C_default={0.4,0.5,0.6});
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ Water_inlet1(
    ...
    P0=8270000,
    SubC0={0.4,0.5,0.6})
                annotation (Placement(transformation(extent={{-174,-16},{-154,4}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP Steam_inlet1(
    ...
    h0=2432.50e3,
    SubC0={0.4,0.5,0.6})
                  annotation (Placement(transformation(extent={{-174,84},{-154,104}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ Drain_inlet1(
    ...
    h0=889.89e3,
    SubC0={0.5,0.6,0.7})
                 annotation (Placement(transformation(extent={{-174,35},{-154,55}}, rotation=0)));
equation
