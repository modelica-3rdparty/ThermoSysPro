...
model TestSimpleDynamicCondenser
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP SourceRechauffeurEau(
    ...
    h0=2401e3,
    P0=15050) annotation (Placement(transformation(extent={{-207,148},{-183,170}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourcePCaloporteur(
    redeclare package Medium = Medium,
    Q0=29804.5,
    h0=113e3) annotation (Placement(transformation(extent={{-212,30},{-172,68}}, rotation=0)));
