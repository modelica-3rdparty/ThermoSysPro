...
model TestStaticExchangerKS_Traces
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourcePc(
    ...
    T0=340,
    SubC0={0.1,0.2,0.3}) annotation (Placement(transformation(extent={{-80,44},{-60,64}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.SourceP sourcePf(
    redeclare package Medium = Medium,
    SubC0={0.4,0.5,0.6}) annotation (Placement(transformation(extent={{-60,24},{-40,44}}, rotation=0)));
...
end TestStaticExchangerKS_Traces;
