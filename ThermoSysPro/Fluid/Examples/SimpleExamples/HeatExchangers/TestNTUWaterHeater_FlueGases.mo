...
model TestNTUWaterHeater_FlueGases
  extends ThermoSysPro.UsersGuide.Icons.Example;

  replaceable package Medium_e = Properties.Media.FlueGases;
  replaceable package Medium_c = Properties.Media.WaterSteam;

  parameter Medium_e.MassFraction X0[Medium_e.nX]={0.1,0.2,0.3,0.2,0.2};
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourcePQ Water_inlet1(
    ...
    T0=573.15,
    X0=X0) annotation (Placement(transformation(extent={{-174,-16},{-154,4}}, rotation=0)));
  ThermoSysPro.Fluid.BoundaryConditions.Sink Puit_condenseur2(
    redeclare package Medium = Medium_e,
    option_temperature=true,
    T0=573.15) annotation (Placement(transformation(extent={{137,-16},{157,4}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.HeatExchangers.NTUWaterHeater nTUWaterHeating1(
    ...
    HeiF(start=2879115.64844),
    HDesF(start=2879115.64844),
    Hep(start=500000),
    SCondDes=5752,
    Ee(
      P(start=82e5),
      h_vol_2(start=2879115.64844),
      Q(start=1790),
    ...
    SPurge=1458,
    Se(
      h(fixed=true, start=2879115.64844),
      P(start=80.19e5, fixed=true),
      Xi(start={0.1,0.2,0.3,0.2,0.2}))) annotation (Placement(transformation(extent={{-66,-77},{50,65}}, rotation=0)));
...
end TestNTUWaterHeater_FlueGases;
