...
model TestStaticExchangerDTorWorEff_Traces
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceWaterSteam_FF(
    ...
    Q0=481.07,
    h0=1067.9e3,
    SubC0={0.1,0.2,0.3}) annotation (Placement(transformation(extent={{-60,-20},{-40,0}}, rotation=0)));
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ sourceWaterSteam_FC(
    ...
    Q0=23.377,
    h0=3420.3e3,
    SubC0={0.4,0.5,0.6}) annotation (Placement(transformation(origin={-30,30}, extent={{10,-10},{-10,10}}, rotation=180)));
...
end TestStaticExchangerDTorWorEff_Traces;
