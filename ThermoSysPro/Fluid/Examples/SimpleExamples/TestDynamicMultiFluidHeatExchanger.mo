...
equation
  connect(sourceP.C, dynamicMultiFluidHeatExchanger.Cws1) annotation(
    Line(points = {{-40, 30}, {-20, 30}}, color = {0, 0, 0}));
  connect(dynamicMultiFluidHeatExchanger.Cws2, sinkP.C) annotation(
    Line(points = {{0, 30}, {20, 30}}, color = {0, 0, 0}));
  connect(sourceP1.C, dynamicMultiFluidHeatExchanger.Cfg1) annotation(
    Line(points = {{-10, 60}, {-10, 35}}, color = {0, 0, 0}));
  connect(dynamicMultiFluidHeatExchanger.Cfg2, sinkP1.C) annotation(
    Line(points = {{-10, 25}, {-10, 0}}, color = {0, 0, 0}));
  annotation(
