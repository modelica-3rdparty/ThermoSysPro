...
model TestStaticWallFlueGasesExchanger
  ...
  BoundaryConditions.SourcePQ sourceP(option_temperature = true, Q0 = 1, ftype = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.FluidType.FlueGases) annotation(
    Placement(transformation(extent = {{-60, 20}, {-40, 40}}, rotation = 0)));
  BoundaryConditions.Sink sinkP annotation(
    Placement(transformation(extent = {{20, 20}, {40, 40}}, rotation = 0)));
  ThermoSysPro.Thermal.BoundaryConditions.HeatSource heatSource(T0 = {273 + 400, 273 + 400, 273 + 400, 273 + 400, 273 + 400, 273 + 400, 273 + 400, 273 + 400, 273 + 400, 273 + 400}, option_temperature = 2, W0 = {6e4, 6e4, 6e4, 6e4, 6e4, 6e4, 6e4, 6e4, 6e4, 6e4}) annotation(
    Placement(transformation(extent = {{-20, 60}, {0, 80}}, rotation = 0)));
  ThermoSysPro.Thermal.HeatTransfer.HeatExchangerWall heatExchangerWall(Ns = 10, dynamic_energy_balance = false) annotation(
