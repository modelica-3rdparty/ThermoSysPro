...
model TestCombustionTurbine
  ...
  ThermoSysPro.Fluid.BoundaryConditions.SourceQ SourceQ1(Xso2 = 0, Q0 = 430, Xco2 = 0.06, Xh2o = 0.06, Xo2 = 0.14, ftype = ThermoSysPro.Fluid.Interfaces.PropertyInterfaces.FluidType.FlueGases, T0 = 1500, option_temperature = true) annotation(
...
equation
  ...
  connect(CombustionTurbine.Cs, SinkP1.C) annotation(
    Line(points = {{36, 0}, {84, 0}}, color = {0, 0, 0}, thickness = 1));
