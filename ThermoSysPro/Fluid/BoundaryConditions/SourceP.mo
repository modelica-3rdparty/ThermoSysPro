...
model SourceP "Multi-fluid source with fixed pressure"
  ...
  parameter Boolean option_temperature = true "true: temperature is fixed - false: specific enthalpy is fixed";
