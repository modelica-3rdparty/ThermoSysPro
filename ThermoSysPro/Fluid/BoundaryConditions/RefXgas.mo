...
model RefXgas "Fixed gas composition"
  ...
  InstrumentationAndControl.Connectors.InputReal IXco2 annotation(
    Placement(transformation(origin = {-90, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  InstrumentationAndControl.Connectors.InputReal IXh2o annotation(
    Placement(transformation(origin = {-30, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  InstrumentationAndControl.Connectors.InputReal IXo2 annotation(
    Placement(transformation(origin = {30, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  InstrumentationAndControl.Connectors.InputReal IXso2 annotation(
    Placement(transformation(origin = {90, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
equation
