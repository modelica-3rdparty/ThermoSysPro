...
//rhoc[N + 1] = proc[2].d;
  ...
  Stot = dSi*Ns;
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{-60, 20}, {-60, -20}}), Line(points = {{-20, 20}, {-20, -20}}), Line(points = {{20, 20}, {20, -20}}), Line(points = {{60, 20}, {60, -20}}), Line(points = {{-60, 20}, {-60, -20}}), Line(points = {{-20, 20}, {-20, -20}}), Line(points = {{20, 20}, {20, -20}}), Line(points = {{60, 20}, {60, -20}}), Rectangle(extent = {{-100, 20}, {100, -20}}, lineColor = {28, 108, 200}, fillColor = {0, 0, 127}, fillPattern = FillPattern.Solid), Line(points = {{60, 20}, {60, -20}}, color = {255, 255, 255}), Line(points = {{20, 20}, {20, -20}}, color = {255, 255, 255}), Line(points = {{-20, 20}, {-20, -20}}, color = {255, 255, 255}), Line(points = {{-60, 20}, {-60, -20}}, color = {255, 255, 255})}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 20}, {100, -20}}, lineColor = {0, 0, 255}, fillColor = {0, 0, 127}, fillPattern = FillPattern.Solid), Line(points = {{-60, 20}, {-60, -20}}, color = {255, 255, 255}), Line(points = {{-20, 20}, {-20, -20}}, color = {255, 255, 255}), Line(points = {{20, 20}, {20, -20}}, color = {255, 255, 255}), Line(points = {{60, 20}, {60, -20}}, color = {255, 255, 255})}),
