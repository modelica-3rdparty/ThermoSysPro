...
model DynamicOnePhaseFlowPipe_SaltOil "Dynamic one-phase flow pipe Salt-Oil"
  ...
  parameter Units.SI.Temperature T0[Ns] = fill(290, Ns) "Initial fluid temperature (active if steady_state = false)";
  parameter Units.SI.SpecificEnthalpy h0[Ns] = fill(1e5, Ns) "Initial fluid specific enthalpy (active if steady_state = false)";
  parameter Boolean advection = false "true: momentum balance equation with advection terme - false: without advection terme";
  parameter Boolean steady_state = true "true: start from steady state - false: start from  h0 ";
  ...
  WaterSteam.Connectors.FluidInlet C1 annotation(
    Placement(transformation(extent = {{-110, -10}, {-90, 10}}, rotation = 0)));
  WaterSteam.Connectors.FluidOutlet C2 annotation(
...
//rhoc[N + 1] = proc[2].d;
  ...
  Stot = dSi*Ns;
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{-60, 20}, {-60, -20}}), Line(points = {{-20, 20}, {-20, -20}}), Line(points = {{20, 20}, {20, -20}}), Line(points = {{60, 20}, {60, -20}}), Line(points = {{-60, 20}, {-60, -20}}), Line(points = {{-20, 20}, {-20, -20}}), Line(points = {{20, 20}, {20, -20}}), Line(points = {{60, 20}, {60, -20}}), Rectangle(extent = {{-100, 20}, {100, -20}}, lineColor = {28, 108, 200}, fillColor = {78, 78, 235}, fillPattern = FillPattern.Solid), Line(points = {{60, 20}, {60, -20}}, color = {255, 255, 255}), Line(points = {{20, 20}, {20, -20}}, color = {255, 255, 255}), Line(points = {{-20, 20}, {-20, -20}}, color = {255, 255, 255}), Line(points = {{-60, 20}, {-60, -20}}, color = {255, 255, 255})}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 20}, {100, -20}}, lineColor = {0, 0, 255}, fillColor = {78, 78, 235}, fillPattern = FillPattern.Solid), Line(points = {{-60, 20}, {-60, -20}}, color = {255, 255, 255}), Line(points = {{-20, 20}, {-20, -20}}, color = {255, 255, 255}), Line(points = {{20, 20}, {20, -20}}, color = {255, 255, 255}), Line(points = {{60, 20}, {60, -20}}, color = {255, 255, 255})}),
