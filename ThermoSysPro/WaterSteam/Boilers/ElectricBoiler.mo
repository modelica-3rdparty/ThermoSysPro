...
model ElectricBoiler "Electric boiler"
  ...
  parameter ThermoSysPro.Units.SI.PressureDifference deltaP = 0 "Pressure loss";
...
/* Fluid thermodynamic properties */
  ...
  Ts = pros.T;
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 80}, {100, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{22, 54}, {-30, 2}, {30, 2}, {-24, -52}, {-28, -56}}, color = {255, 0, 0}, thickness = 0.5), Polygon(points = {{-26, -50}, {-22, -54}, {-28, -56}, {-26, -50}}, lineColor = {255, 0, 0}, lineThickness = 0.5, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid)}),
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 80}, {100, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{-26, -48}, {-20, -54}, {-28, -56}, {-26, -48}}, lineColor = {255, 0, 0}, lineThickness = 1, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid), Line(points = {{22, 54}, {-30, 2}, {30, 2}, {-24, -52}, {-28, -56}}, color = {255, 0, 0}, thickness = 1)}),
