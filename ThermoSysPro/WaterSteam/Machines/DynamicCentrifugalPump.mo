...
model DynamicCentrifugalPump "Dynamic centrifugal pump"
  ...
  parameter ThermoSysPro.Units.nonSI.AngularVelocity_rpm VRot0 = 0 "Initial rotational speed (active if steady_state_mech=false)";
  parameter Units.SI.Volume V = 1 "Pump volume (only if dynamic_energy_balance = true)";
  ...
  ThermoSysPro.Units.nonSI.AngularVelocity_rpm VRot(start = VRotn) "Rotational speed";
...
/* Fluid thermodynamic properties */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{-80, 0}, {80, 0}}, color = {0, 0, 0}), Line(points = {{80, 0}, {2, 60}}, color = {0, 0, 0}), Line(points = {{80, 0}, {0, -60}}, color = {0, 0, 0})}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{-80, 0}, {80, 0}}), Line(points = {{80, 0}, {2, 60}}), Line(points = {{80, 0}, {0, -60}}), Text(extent = {{-28, -54}, {32, -106}}, textString = "Q"), Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{80, 0}, {2, 60}}, color = {0, 0, 0}), Line(points = {{-80, 0}, {80, 0}}, color = {0, 0, 0}), Line(points = {{80, 0}, {0, -60}}, color = {0, 0, 0})}),
    Window(x = 0.16, y = 0.01, width = 0.68, height = 0.94),
    Documentation(info = "
