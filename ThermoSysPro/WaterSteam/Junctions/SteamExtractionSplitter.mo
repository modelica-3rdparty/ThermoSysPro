...
model SteamExtractionSplitter "Splitter for steam extraction"
  ...
  Connectors.FluidOutlet Cex "Extraction outlet" annotation(
...
/* Vapor mass fraction at the extraction outlet */
  ...
  annotation(
    ...
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-100, 28}, {-100, -32}, {-40, -32}, {20, -102}, {20, -102}, {60, -102}, {70, -102}, {0, -32}, {100, -32}, {100, 28}, {-100, 28}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid)}),
