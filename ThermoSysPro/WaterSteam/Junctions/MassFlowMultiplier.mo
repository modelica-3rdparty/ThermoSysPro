...
model MassFlowMultiplier "Mass flow multipliier"
  ...
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph pro "Water-steam properties" annotation(
...
/* Fluid thermodynamic properties */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-100, 60}, {-100, -60}, {90, 0}, {-100, 60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Text(extent = {{-60, 24}, {-20, -16}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, textString = "%alpha")}),
