...
model VolumeITh "Mixing volume with 4 inlets and 4 outlets and thermal input"
  ...
  Connectors.FluidInlet Ce3 annotation(
    Placement(transformation(extent = {{-110, -90}, {-90, -70}}, rotation = 0)));
  Connectors.FluidInlet Ce4 annotation(
  ...
  Connectors.FluidOutlet Cs4 annotation(
...
/* Energy balance equation */
  BH = Ce1.Q*Ce1.h + Ce2.Q*Ce2.h + Ce3.Q*Ce3.h + Ce4.Q*Ce4.h - Cs1.Q*Cs1.h - Cs2.Q*Cs2.h - Cs3.Q*Cs3.h - Cs4.Q*Cs4.h + Cth.W;
  if dynamic_mass_balance then
...
/* Fluid thermodynamic properties */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-40, 80}, {40, 0}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Ellipse(extent = {{-40, 0}, {40, -80}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-40, 40}, {40, -40}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{-90, 80}, {-60, 80}, {-40, 46}}), Line(points = {{92, 80}, {60, 80}, {40, 46}}), Line(points = {{-90, -80}, {-60, -80}, {-40, -46}}), Line(points = {{92, -80}, {60, -80}, {40, -46}})}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{-90, 0}, {92, 0}}), Line(points = {{0, 92}, {0, -100}}), Ellipse(extent = {{-40, 80}, {40, 0}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Ellipse(extent = {{-40, 0}, {40, -80}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-40, 40}, {40, -40}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{-90, 80}, {-60, 80}, {-40, 46}}), Line(points = {{92, 80}, {60, 80}, {40, 46}}), Line(points = {{-90, -80}, {-60, -80}, {-40, -46}}), Line(points = {{92, -80}, {60, -80}, {40, -46}})}),
    Window(x = 0.31, y = 0.01, width = 0.74, height = 0.85),
    Documentation(info = "
...
This component is a volume with four inputs, four outputs and a thermal port.  
...
![modelica://ThermoSysPro/UsersGuide/Documentation/ThermoSysPro.WaterSteam.Volumes.VolumeITh.svg](modelica://ThermoSysPro/UsersGuide/Documentation/ThermoSysPro.WaterSteam.Volumes.VolumeITh.svg)  
