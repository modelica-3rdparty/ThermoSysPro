...
model DegasifierVolume "Degasifier volume"
  ...
  parameter Units.SI.Volume Vmax = 10 "Maximum volume of the liquid in the basins";
  parameter Units.SI.SpecificHeatCapacity Cpmetal = 460 "Metal specific heat";
  parameter Units.SI.Mass Mmetal = 10869 "Metal mass";
  parameter Units.SI.AbsolutePressure P0 = 1e5 "Initial fluid pressure (active if steady_state=false)";
  ...
  Connectors.FluidInlet Ce3 annotation(
    Placement(transformation(extent = {{30, 50}, {50, 70}}, rotation = 0)));
  ...
  Connectors.FluidInlet Ce4 annotation(
    Placement(transformation(extent = {{30, -68}, {50, -48}}, rotation = 0)));
initial equation
...
/* Fluid thermodynamic properties */
  ...
  Tl = lsat.T;
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-102, 60}, {100, -60}}, lineColor = {0, 0, 255}, pattern = LinePattern.None, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid)}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-102, 60}, {100, -60}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid)}),
