...
public
  ...
  Connectors.FluidInlet Ce1(   redeclare package Species = Species)       annotation (Placement(transformation(
          extent={{-110,50},{-90,70}}, rotation=0)));
  Connectors.FluidOutlet Cs2(  redeclare package Species = Species)       annotation (Placement(transformation(
