...
/* Fluid thermodynamic properties */
  ...
  annotation(
    ...
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{0, 90}, {0, -100}}), Line(points = {{-90, 0}, {90, 0}}), Ellipse(extent = {{-58, 60}, {62, -60}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid)}),
    Window(x = 0.03, y = 0.23, width = 0.66, height = 0.69),
    Documentation(info = "
...
This component is a volume with one input, three outputs.  
...
![modelica://ThermoSysPro/UsersGuide/Documentation/ThermoSysPro.WaterSteam.Volumes.VolumeD.svg](modelica://ThermoSysPro/UsersGuide/Documentation/ThermoSysPro.WaterSteam.Volumes.VolumeD.svg)  
