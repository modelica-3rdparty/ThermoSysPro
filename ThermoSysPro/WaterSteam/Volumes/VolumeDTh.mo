...
/* Fluid thermodynamic properties */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-60, 60}, {60, -60}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{-90, 0}, {90, 0}}), Line(points = {{0, 90}, {0, -100}})}),
    ...
    Window(x = 0.16, y = 0.23, width = 0.66, height = 0.69),
    Documentation(info = "
...
This component is a volume with one input, three outputs and a thermal port.  
...
![modelica://ThermoSysPro/UsersGuide/Documentation/ThermoSysPro.WaterSteam.Volumes.VolumeDTh.svg](modelica://ThermoSysPro/UsersGuide/Documentation/ThermoSysPro.WaterSteam.Volumes.VolumeDTh.svg)  
