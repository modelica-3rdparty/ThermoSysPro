...
model CoolingTower "Cooling tower"
  parameter Integer fluid = 1 "<html>Fluid number: <br>1 - Water/Steam <br>7 - WaterSteamSimple </html>";
  parameter Units.SI.AbsolutePressure Patm = 101325 "Pressure above the fluid level";
  ...
  parameter Real p_Beta1 = 0 "If > 0, fixed transfert coefficient for the evporating mass (otherwise, this coef. is computed)";
  Real Beta1 "Coefficient de tranfert de masse d'évaporation calculé avec nn et lambda (packing)";
  ...
  parameter Boolean packing_zone_activated = true "true: activation of the packing zone";
  Units.SI.Volume dV "Volume of the packing exchange zone";
  Real xeH2o "Air humidity at the inlet (kg/kg)";
  Units.SI.MassFlowRate QsAir2 "Ambiant air mass flow at the inlet of the packing zone";
  Units.SI.SpecificEnthalpy HmAir2(start = 100000) "Ambiant air specific enthalpy at the inlet of the packing zone";
  Units.SI.AbsolutePressure PeAir2 "Ambiant air pressure at the inlet of the packing zone";
  Units.SI.Temperature Teair1(start = 284.16) "Ambiant air temperature at the inlet of the packing zone";
  Real xeH2o1 "Ambiant air humidity at the inlet of the packing zone (kg/kg)";
  Units.SI.MassFlowRate QsAir1 "Hot air mass flow at the outlet of the packing zone";
  Units.SI.SpecificEnthalpy HmAir1(start = 100000) "Hot air specific enthalpy at the outlet of the packing zone";
  Units.SI.Temperature Tsair1(start = 300) "Hot air temperature at the outlet of the packing zone";
  ...
  Units.SI.AbsolutePressure PeEau1 "Hot water pressure at the inlet of the packing zone";
  Units.SI.MassFlowRate QeEau1 "Hot water mass flow rate at the inlet of the packing zone";
  Units.SI.SpecificEnthalpy HeEau1 "Hot water specific enthalpy at the inlet of the packing zone";
  Units.SI.Temperature Teeau1 "Hot water temperature at the inlet of the packing zone";
  Units.SI.MassFlowRate QsEau1 "Cold water pressure at the outlet of the packing zone";
  Units.SI.Temperature Tseau1(start = 300) "Cold water tempretaure at the outlet of the packing zone";
  Units.SI.SpecificEnthalpy HmEau1(start = 200000) "Cold water specific enthalpy at the outlet of the packing zone";
  Units.SI.Power dw1 "Cooling power given by water convection and evaporation in the packing zone";
  Units.SI.SpecificEnthalpy Hs1 "Air specific enthalpy in the packing zone";
  Units.SI.SpecificEnthalpy Hse1 "Air specific enthalpy saturated at Teau in the packing zone";
  ...
  Units.SI.SpecificHeatCapacity CpEair1 "Air specific heat capacity at the inlet";
  Units.SI.ThermalConductivity lambdaEair1 "Air thermal conductivity at the inlet";
  Units.SI.Density rhoSair1 "Air density at the outlet";
  Units.SI.DynamicViscosity muSair1 "Air viscosity at the outlet";
  Units.SI.SpecificHeatCapacity CpSair1 "Air specific heat capacity at the outlet";
  Units.SI.ThermalConductivity lambdaSair1 "Air thermal conductivity at the outlet";
  ...
  parameter Units.SI.Height z2 = z1 "Height of the exchange zone in the rain zone";
  parameter Units.SI.Diameter Dg = 0.005 "Droplets diameter";
  parameter Real p_Beta2 = 0 "If > 0, the mass transfer coef. is fixed, otherwise it is computed";
  ...
  Units.SI.MassFlowRate QeAir2 "Air mass flow rate at the inlet of the rain zone";
  Units.SI.SpecificEnthalpy HeAir2 "Air specific enthalpy at the inlet of the rain zone";
  ...
  Units.SI.Temperature Teeau2 "Hot water temperature at the inlet of the rain zone";
  Units.SI.Temperature Tseau2 "Cold water temperature at the outlet of the rain zone";
  Units.SI.MassFlowRate QsEau2 "Cold water mass flow rate at the outlet of the rain zone";
  ...
  Units.SI.Power dw2 "Thermal power exchanged between the air and the droplets by convection and evaporation in the rain zone";
  Units.SI.SpecificEnthalpy Hs2 "Air specific enthalpy at temprature Tair in the rain zone";
  Units.SI.SpecificEnthalpy Hse2 "Air specific enthalpy saturated at temperature Teau in the rain zone";
  ...
  Units.SI.SpecificEnthalpy HmEau2(start = 200000) "Average specific enthalpy in the rain zone";
  ...
  Units.SI.SpecificHeatCapacity CpEair2(start = 1000) "Air specific heat capacity at the inlet";
  Units.SI.ThermalConductivity lambdaEair2(start = 0.05) "Air thermal conductivity at the inlet";
  ...
  Units.SI.SpecificHeatCapacity CpSair2(start = 1000) "Air specific heat capacity at the outlet";
  Units.SI.ThermalConductivity lambdaSair2(start = 0.05) "Air thermal conductivity at the outlet";
  ...
  Connectors.FluidInlet Cws1 "Cooling water inlet" annotation(
    Placement(transformation(extent = {{-90, -50}, {-70, -30}}, rotation = 0)));
  Connectors.FluidOutlet Cws2 "Cooling water outlet" annotation(
    Placement(transformation(extent = {{-110, -100}, {-90, -80}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph pro_input1 "Packing zone water/steam properties" annotation(
    Placement(transformation(extent = {{-100, 60}, {-80, 86}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph pro_output1 "Packing zone water/steam properties" annotation(
    Placement(transformation(extent = {{-100, 20}, {-80, 46}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph pro_input2 "Rain zone water/steam properties" annotation(
    Placement(transformation(extent = {{80, 60}, {100, 86}}, rotation = 0)));
  ThermoSysPro.Properties.WaterSteam.Common.ThermoProperties_ph pro_output2 "Rain zone water/steam properties" annotation(
    Placement(transformation(extent = {{80, 20}, {100, 46}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesInlet Cair1 "Air inlet" annotation(
    Placement(transformation(extent = {{-10, -111}, {10, -91}}, rotation = 0)));
  ThermoSysPro.FlueGases.Connectors.FlueGasesOutlet Cair2 "Air outlet" annotation(
...
// Water outlet
  ...
  annotation(
    Icon(graphics = {Rectangle(extent = {{-90, -80}, {90, -100}}, lineColor = {85, 170, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-74, -42}, {76, -48}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{76, -48}, {62, -100}, {40, -48}, {20, -100}, {2, -48}, {-20, -100}, {-40, -48}, {-60, -100}, {-74, -48}}, color = {0, 0, 255}, thickness = 0.5), Polygon(points = {{90, -82}, {90, -100}, {100, -100}, {90, -82}}, lineColor = {85, 170, 255}, lineThickness = 1, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{-100, -100}, {-70, -40}, {-58, 0}, {-56, 20}, {-60, 60}, {-68, 100}, {70, 100}, {60, 60}, {56, 20}, {58, 0}, {74, -42}, {100, -100}, {-100, -100}}, color = {0, 0, 255}, thickness = 0.5), Line(points = {{0, 0}, {0, 40}}, color = {255, 0, 0}, thickness = 1), Polygon(points = {{0, 60}, {-10, 40}, {10, 40}, {0, 60}}, lineColor = {255, 0, 0}, lineThickness = 1, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid)}),
    Diagram(graphics = {Rectangle(extent = {{-90, -80}, {90, -100}}, lineColor = {85, 170, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-74, -42}, {76, -48}}, lineColor = {0, 0, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{76, -48}, {62, -100}, {40, -48}, {20, -100}, {2, -48}, {-20, -100}, {-40, -48}, {-60, -100}, {-74, -48}}, color = {0, 0, 255}, thickness = 0.5), Polygon(points = {{90, -80}, {90, -100}, {100, -100}, {90, -80}}, lineColor = {85, 170, 255}, fillColor = {85, 170, 255}, fillPattern = FillPattern.Solid), Line(points = {{-100, -100}, {-70, -40}, {-58, 0}, {-56, 20}, {-60, 60}, {-68, 100}, {70, 100}, {60, 60}, {56, 20}, {58, 0}, {74, -42}, {100, -100}, {-100, -100}}, color = {0, 0, 255}, thickness = 0.5), Line(points = {{0, 0}, {0, 40}}, color = {255, 0, 0}, thickness = 1), Polygon(points = {{0, 60}, {-10, 40}, {10, 40}, {0, 60}}, lineColor = {255, 0, 0}, lineThickness = 1, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid)}),
    Documentation(info = "
