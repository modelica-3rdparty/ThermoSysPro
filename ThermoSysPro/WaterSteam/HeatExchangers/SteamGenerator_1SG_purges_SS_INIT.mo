...
model SteamGenerator_1SG_purges_SS_INIT "Individual steam generator"
...
public
  ...
  ThermoSysPro.WaterSteam.PressureLosses.LumpedStraightPipe DownComerGV(
    ...
    D=0.216,
    lambda=0.08,
    ntubes=32) "DownComerGV" annotation (Placement(transformation(
        origin={94.5,-41},
  ...
  ThermoSysPro.WaterSteam.HeatExchangers.DynamicTwoPhaseFlowRiser RiserGV(
    ...
    hcCorr=5,
    dpfCorr=1,
    ntubes=ntubes) annotation (Placement(
        transformation(
        origin={-2.5,-41},
  ...
  ThermoSysPro.WaterSteam.Volumes.VolumeC         volumeA1(
      ...
      dynamic_mass_balance=true) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Connectors.FluidOutletI            fluidOutletI2(redeclare package Species =
...
end SteamGenerator_1SG_purges_SS_INIT;
