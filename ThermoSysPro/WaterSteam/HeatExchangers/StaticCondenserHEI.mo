...
model StaticCondenserHEI "HEI Static condenser"
  ...
  Units.SI.Pressure Pcond(start = 6000) "Expected corrected saturation pressure HEI";
  Units.SI.Temperature Tsat(start = 310) "Expected corrected saturation temperature HEI";
  ...
  Units.SI.Temperature Tsat_att(start = 310) "Expected saturation temperature HEI";
  Units.SI.SpecificHeatCapacity Cpmf(start = 950) "Average of specific heat capacity of cold water";
...
/* Flow reversal in the cold side */
  if continuous_flow_reversal then
    0 = noEvent(if (Qf > Qeps) then Cee.h - Cee.h_vol else if (Qf < -Qeps) then Cse.h - Cse.h_vol else Cee.h - 0.5*((Cee.h_vol - Cse.h_vol)*Modelica.Math.sin(pi*Qf/2/Qeps) + Cee.h_vol + Cse.h_vol));
  else
...
/* The standards HEI aren't applicable if the terminal temperature difference is less than 2,78 K */
  ...
  annotation(
    ...
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{100, -86}, {100, 100}, {-100, 100}, {-100, -86}, {100, -86}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{-100, -14}, {80, -14}, {80, -20}, {-90, -20}, {-90, -26}, {80, -26}, {80, -32}, {-90, -32}, {-90, -38}, {100, -38}}, color = {28, 108, 200}, thickness = 0.5), Polygon(points = {{0, -90}, {-11, -70}, {11, -70}, {0, -90}}, lineColor = {0, 0, 0}, lineThickness = 0.5, fillPattern = FillPattern.Sphere, fillColor = {191, 0, 0}), Line(points = {{0, 8}, {0, -70}}, color = {0, 0, 0}, thickness = 1), Line(points = {{-100, 8}, {100, 8}}, color = {0, 0, 255}, thickness = 0.5), Text(extent = {{-80, 84}, {72, 36}}, lineColor = {28, 108, 200}, textString = "HEI")}),
