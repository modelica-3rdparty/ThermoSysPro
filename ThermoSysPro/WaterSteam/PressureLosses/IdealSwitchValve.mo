...
model IdealSwitchValve "Ideal switch valve"
  ...
  ThermoSysPro.Units.SI.PressureDifference deltaP "Pressure difference between the inlet and the outlet";
...
/* Flow reversal */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-100, -100}, {0, -60}, {-100, -20}, {-100, -100}, {-100, -100}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{0, -60}, {100, -20}, {100, -100}, {0, -60}, {0, -60}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{-40, 60}, {40, 60}}, color = {0, 0, 255}, thickness = 1), Line(points = {{0, 60}, {0, -60}}), Text(extent = {{-104, 34}, {88, -22}}, textString = "DP=0")}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-100, -100}, {0, -60}, {-100, -20}, {-100, -100}, {-100, -100}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{0, -60}, {100, -20}, {100, -100}, {0, -60}, {0, -60}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{-40, 60}, {40, 60}}, color = {0, 0, 255}, thickness = 1), Line(points = {{0, 60}, {0, -60}}), Text(extent = {{-104, 34}, {88, -22}}, textString = "DP=0")}),
    Window(x = 0.22, y = 0.12, width = 0.72, height = 0.74),
    Documentation(info = "
