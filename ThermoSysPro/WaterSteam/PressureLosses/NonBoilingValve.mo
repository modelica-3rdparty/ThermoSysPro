...
model NonBoilingValve "Non boiling valve"
  parameter ThermoSysPro.Units.SI.PressureDifference Psecu = 1.e4 "Security margin to avoid boiling";
  parameter Units.SI.SpecificEnthalpy Hmax = 5.e6 "Fluid maximum specific enthalpy";
  parameter Units.SI.SpecificEnthalpy Hmin = 6.e4 "Fluid minimum specific enthalpy";
  parameter Boolean continuous_flow_reversal = false "true: continuous flow reversal - false: discontinuous flow reversal";
  Units.SI.MassFlowRate Q(start = 500) "Mass flow rate";
  Units.SI.AbsolutePressure Pebul(start = 1.e5) "Fluid saturation pressure corresponding to Pec";
  ...
  Units.SI.SpecificEnthalpy Hec(start = 50.e4) "Specific fluid enthalpy at the inlet";
  Connectors.FluidInlet C1 annotation(
    Placement(transformation(extent = {{-110, -12}, {-90, 8}}, rotation = 0)));
...
/* The pressure at the inlet is increased if it is not high enough to avoid boiling */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-100, -60}, {0, 0}, {-100, 60}, {-100, -42}, {-100, -60}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{86, -52}, {0, 0}, {100, 60}, {100, -60}, {86, -52}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid)}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Polygon(points = {{-90, -54}, {0, 0}, {-100, 60}, {-100, -60}, {-90, -54}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{100, -60}, {0, 0}, {100, 60}, {100, -42}, {100, -60}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid)}),
    Window(x = 0.09, y = 0.08, width = 0.81, height = 0.85),
    Documentation(info = "
