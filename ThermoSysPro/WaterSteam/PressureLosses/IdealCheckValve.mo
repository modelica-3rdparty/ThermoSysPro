...
model IdealCheckValve "Ideal check valve"
  parameter ThermoSysPro.Units.SI.PressureDifference dPOuvert = 0.01 "Pressure difference when the valve opens";
  parameter Units.SI.MassFlowRate Qmin = 1.e-6 "Mass flow trhough the valve when the valve is closed";
...
/* Pressure loss */
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-70, 70}, {-50, 50}}, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid), Line(points = {{-90, 0}, {-60, 0}}), Line(points = {{60, 0}, {100, 0}}), Text(extent = {{-96, -56}, {96, -112}}, textString = "DP=0"), Line(points = {{-60, -60}, {-60, 60}, {60, -60}, {60, 60}}, color = {0, 203, 0}, thickness = 0.5)}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-70, 70}, {-50, 50}}, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid), Line(points = {{-100, 0}, {-60, 0}}), Line(points = {{60, 0}, {100, 0}}), Text(extent = {{-96, -56}, {96, -112}}, textString = "DP=0"), Line(points = {{-60, -60}, {-60, 60}, {60, -60}, {60, 60}}, color = {0, 203, 0}, thickness = 0.5)}),
    Window(x = 0.08, y = 0.02, width = 0.84, height = 0.9),
    Documentation(info = "
