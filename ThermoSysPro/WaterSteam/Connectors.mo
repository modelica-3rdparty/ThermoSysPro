...
package Connectors "Connectors"
  connector FluidInlet "Water/steam inlet fluid connector"
    Units.SI.AbsolutePressure P(start = 1.e5) "Fluid pressure in the control volume";
    Units.SI.SpecificEnthalpy h_vol(start = 1.e5) "Fluid specific enthalpy in the control volume";
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid)}),
...
Daniel Bouskela   
  ...
  connector FluidInletI "Internal water/steam inlet fluid connector"
    ...
    output Boolean b "Pseudo-variable for the verification of the connection orientation";
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.CrossDiag)}),
      Window(x = 0.27, y = 0.17, width = 0.6, height = 0.6),
      Documentation(info = "
## Copyright © EDF 2002 - 2026  
...
Daniel Bouskela   
  ...
  connector FluidOutlet "Water/steam outlet fluid connector"
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 255}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid)}),
...
Daniel Bouskela   
  ...
  connector FluidOutletI "Internal water/steam outlet fluid connector"
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {255, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.CrossDiag)}),
