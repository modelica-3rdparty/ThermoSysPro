...
model SourceP_concentration "Water/steam source with fixed pressure"
  parameter ThermoSysPro.Units.SI.AbsolutePressure P0=300000 "Source pressure";
  parameter ThermoSysPro.Units.SI.Temperature T0=290
...
public
  ...
  ThermoSysPro.Units.SI.SpecificEnthalpy h "Fluid enthalpy";
