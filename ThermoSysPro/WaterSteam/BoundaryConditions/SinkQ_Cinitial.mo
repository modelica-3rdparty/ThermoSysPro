...
model SinkQ_Cinitial "Water/steam sink with fixed mass flow rate"
...
public
  InstrumentationAndControl.Connectors.InputReal Cinitial annotation (Placement(
        transformation(
        origin={52,1},
        extent={{-11,12},{11,-12}},
