...
/* Fluid thermodynamic properties */
  ...
  T = pro.T;
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-60, 90}, {60, -30}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{0, -30}, {0, -80}}), Line(points = {{-98, -80}, {102, -80}}), Text(extent = {{-60, 60}, {60, 0}}, lineColor = {0, 0, 255}, fillColor = {127, 255, 0}, fillPattern = FillPattern.Solid, textString = "T")}),
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Ellipse(extent = {{-60, 90}, {60, -30}}, lineColor = {0, 0, 255}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid), Line(points = {{0, -30}, {0, -80}}), Line(points = {{-98, -80}, {102, -80}}), Text(extent = {{-60, 60}, {60, 0}}, textString = "T")}),
