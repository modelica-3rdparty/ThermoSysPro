...
block PhasesSeparation_internal
  ...
  input Real x "Title";
  input Real SubC[HomogeneousSubstance.Concentrations] "Total Species Concentrations";

  output Real Cl[HomogeneousSubstance.Concentrations] "Species Concentration in the Liquid Phase";
  output Real Cg[HomogeneousSubstance.Concentrations] "Species Concentration in the Gas Phase";
